...
exports.CustomResourceDefinitionPatch = exports.CustomResourceDefinitionList = exports.CustomResourceDefinition = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("../../utilities"));
exports.CustomResourceDefinition = null;
utilities.lazyLoad(exports, ["CustomResourceDefinition"], () => require("./customResourceDefinition"));
exports.CustomResourceDefinitionList = null;
utilities.lazyLoad(exports, ["CustomResourceDefinitionList"], () => require("./customResourceDefinitionList"));
exports.CustomResourceDefinitionPatch = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "kubernetes:apiextensions.k8s.io/v1:CustomResourceDefinition":
                return new exports.CustomResourceDefinition(name, undefined, { urn });
            case "kubernetes:apiextensions.k8s.io/v1:CustomResourceDefinitionList":
                return new exports.CustomResourceDefinitionList(name, undefined, { urn });
            case "kubernetes:apiextensions.k8s.io/v1:CustomResourceDefinitionPatch":
                return new exports.CustomResourceDefinitionPatch(name, undefined, { urn });
            default:
