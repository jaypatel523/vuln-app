...
exports.PodSchedulingContextList = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("../../utilities"));
/**
 * PodSchedulingContextList is a collection of Pod scheduling objects.
 */
class PodSchedulingContextList extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new PodSchedulingContextList(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:resource.k8s.io/v1alpha3:PodSchedulingContextList';
    /**
...
//# sourceMappingURL=podSchedulingContextList.js.map