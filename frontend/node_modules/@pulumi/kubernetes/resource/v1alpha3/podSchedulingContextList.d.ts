 ...
 */
export declare class PodSchedulingContextList extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PodSchedulingContextList;
    /**
     * Returns true if the given object is an instance of PodSchedulingContextList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PodSchedulingContextList;
    /**
     ...
     */
    readonly items: pulumi.Output<outputs.resource.v1alpha3.PodSchedulingContext[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    readonly kind: pulumi.Output<"PodSchedulingContextList">;
    /**
...
export interface PodSchedulingContextListArgs {
     ...
     * Items is the list of PodSchedulingContext objects.
     */
    items: pulumi.Input<pulumi.Input<inputs.resource.v1alpha3.PodSchedulingContext>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"PodSchedulingContextList" | undefined>;
    /**
     * Standard list metadata
     */
    metadata?: pulumi.Input<inputs.meta.v1.ListMeta | undefined>;
}
//# sourceMappingURL=podSchedulingContextList.d.ts.map