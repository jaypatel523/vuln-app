...
export declare class ResourceSlicePatch extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.resource.v1alpha3.ResourceSliceSpecPatch>;
    /**
...
export interface ResourceSlicePatchArgs {
     ...
     * Changing the spec automatically increments the metadata.generation number.
     */
    spec?: pulumi.Input<inputs.resource.v1alpha3.ResourceSliceSpecPatch | undefined>;
}
