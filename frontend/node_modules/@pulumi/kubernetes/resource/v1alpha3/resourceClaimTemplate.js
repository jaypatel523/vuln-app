...
class ResourceClaimTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    static __pulumiType = 'kubernetes:resource.k8s.io/v1alpha3:ResourceClaimTemplate';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1:ResourceClaimTemplate" }, { type: "kubernetes:resource.k8s.io/v1alpha1:ResourceClaimTemplate" }, { type: "kubernetes:resource.k8s.io/v1alpha2:ResourceClaimTemplate" }, { type: "kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplate" }, { type: "kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplate" }] };
