...
class ResourceClaimTemplatePatch extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new ResourceClaimTemplatePatch(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:resource.k8s.io/v1alpha3:ResourceClaimTemplatePatch';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1:ResourceClaimTemplatePatch" }, { type: "kubernetes:resource.k8s.io/v1alpha1:ResourceClaimTemplatePatch" }, { type: "kubernetes:resource.k8s.io/v1alpha2:ResourceClaimTemplatePatch" }, { type: "kubernetes:resource.k8s.io/v1beta1:ResourceClaimTemplatePatch" }, { type: "kubernetes:resource.k8s.io/v1beta2:ResourceClaimTemplatePatch" }] };
