...
export declare class ResourceClaimTemplateList extends pulumi.CustomResource {
     ...
     */
    readonly items: pulumi.Output<outputs.resource.v1beta1.ResourceClaimTemplate[]>;
    /**
...
export interface ResourceClaimTemplateListArgs {
     ...
     * Items is the list of resource claim templates.
     */
    items: pulumi.Input<pulumi.Input<inputs.resource.v1beta1.ResourceClaimTemplate>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"ResourceClaimTemplateList" | undefined>;
    /**
     * Standard list metadata
     */
    metadata?: pulumi.Input<inputs.meta.v1.ListMeta | undefined>;
}
//# sourceMappingURL=resourceClaimTemplateList.d.ts.map