...
export declare class ResourceClaimTemplatePatch extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.resource.v1beta1.ResourceClaimTemplateSpecPatch>;
    /**
...
export interface ResourceClaimTemplatePatchArgs {
     ...
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"ResourceClaimTemplate" | undefined>;
    /**
     * Standard object metadata
     */
     ...
     * This field is immutable. A ResourceClaim will get created by the control plane for a Pod when needed and then not get updated anymore.
     */
    spec?: pulumi.Input<inputs.resource.v1beta1.ResourceClaimTemplateSpecPatch | undefined>;
}
//# sourceMappingURL=resourceClaimTemplatePatch.d.ts.map