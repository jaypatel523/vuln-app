...
export declare class ResourceClaimPatch extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.resource.v1alpha1.ResourceClaimSpecPatch>;
    /**
     * Status describes whether the resource is available and with which attributes.
     */
    readonly status: pulumi.Output<outputs.resource.v1alpha1.ResourceClaimStatusPatch>;
    /**
...
export interface ResourceClaimPatchArgs {
     ...
     * Spec describes the desired attributes of a resource that then needs to be allocated. It can only be set once when creating the ResourceClaim.
     */
    spec?: pulumi.Input<inputs.resource.v1alpha1.ResourceClaimSpecPatch | undefined>;
}
