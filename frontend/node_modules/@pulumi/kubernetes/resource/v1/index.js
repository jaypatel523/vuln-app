...
const _module = {
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "kubernetes:resource.k8s.io/v1:DeviceClass":
                return new exports.DeviceClass(name, undefined, { urn });
            case "kubernetes:resource.k8s.io/v1:DeviceClassList":
                return new exports.DeviceClassList(name, undefined, { urn });
            case "kubernetes:resource.k8s.io/v1:DeviceClassPatch":
                return new exports.DeviceClassPatch(name, undefined, { urn });
            case "kubernetes:resource.k8s.io/v1:ResourceClaim":
                return new exports.ResourceClaim(name, undefined, { urn });
            case "kubernetes:resource.k8s.io/v1:ResourceClaimList":
                return new exports.ResourceClaimList(name, undefined, { urn });
            case "kubernetes:resource.k8s.io/v1:ResourceClaimPatch":
                return new exports.ResourceClaimPatch(name, undefined, { urn });
            case "kubernetes:resource.k8s.io/v1:ResourceClaimTemplate":
                return new exports.ResourceClaimTemplate(name, undefined, { urn });
            case "kubernetes:resource.k8s.io/v1:ResourceClaimTemplateList":
                return new exports.ResourceClaimTemplateList(name, undefined, { urn });
            case "kubernetes:resource.k8s.io/v1:ResourceClaimTemplatePatch":
                return new exports.ResourceClaimTemplatePatch(name, undefined, { urn });
            case "kubernetes:resource.k8s.io/v1:ResourceSlice":
                return new exports.ResourceSlice(name, undefined, { urn });
            case "kubernetes:resource.k8s.io/v1:ResourceSliceList":
                return new exports.ResourceSliceList(name, undefined, { urn });
            case "kubernetes:resource.k8s.io/v1:ResourceSlicePatch":
...
pulumi.runtime.registerResourceModule("kubernetes", "resource.k8s.io/v1", _module);
