...
class ResourceSlice extends pulumi.CustomResource {
    ...
    /** @internal */
    static __pulumiType = 'kubernetes:resource.k8s.io/v1:ResourceSlice';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1alpha2:ResourceSlice" }, { type: "kubernetes:resource.k8s.io/v1alpha3:ResourceSlice" }, { type: "kubernetes:resource.k8s.io/v1beta1:ResourceSlice" }, { type: "kubernetes:resource.k8s.io/v1beta2:ResourceSlice" }] };
