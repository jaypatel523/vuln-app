 ...
 */
export declare class ResourceClassParametersPatch extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourceClassParametersPatch;
    /**
     * Returns true if the given object is an instance of ResourceClassParametersPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ResourceClassParametersPatch;
    /**
     ...
     */
    readonly filters: pulumi.Output<outputs.resource.v1alpha2.ResourceFilterPatch[]>;
    /**
     ...
     */
    readonly generatedFrom: pulumi.Output<outputs.resource.v1alpha2.ResourceClassParametersReferencePatch>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    readonly kind: pulumi.Output<"ResourceClassParameters">;
    /**
     ...
     */
    readonly vendorParameters: pulumi.Output<outputs.resource.v1alpha2.VendorParametersPatch[]>;
    /**
     ...
     */
    constructor(name: string, args?: ResourceClassParametersPatchArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * The set of arguments for constructing a ResourceClassParametersPatch resource.
 */
export interface ResourceClassParametersPatchArgs {
    /**
     * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
     */
...
//# sourceMappingURL=resourceClassParametersPatch.d.ts.map