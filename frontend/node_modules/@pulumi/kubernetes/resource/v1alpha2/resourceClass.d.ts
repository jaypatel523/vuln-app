 ...
 */
export declare class ResourceClass extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ResourceClass;
    /**
     * Returns true if the given object is an instance of ResourceClass.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ResourceClass;
    /**
     ...
     */
    readonly parametersRef: pulumi.Output<outputs.resource.v1alpha2.ResourceClassParametersReference>;
    /**
     ...
     */
    readonly structuredParameters: pulumi.Output<boolean>;
    /**
     * Only nodes matching the selector will be considered by the scheduler when trying to find a Node that fits a Pod when that Pod uses a ResourceClaim that has not been allocated yet.
     *
     * Setting this field is optional. If null, all nodes are candidates.
     */
    readonly suitableNodes: pulumi.Output<outputs.core.v1.NodeSelector>;
    /**
...
export interface ResourceClassArgs {
     ...
     * ParametersRef references an arbitrary separate object that may hold parameters that will be used by the driver when allocating a resource that uses this class. A dynamic resource driver can distinguish between parameters stored here and and those stored in ResourceClaimSpec.
     */
    parametersRef?: pulumi.Input<inputs.resource.v1alpha2.ResourceClassParametersReference | undefined>;
    /**
     * If and only if allocation of claims using this class is handled via structured parameters, then StructuredParameters must be set to true.
     */
    structuredParameters?: pulumi.Input<boolean | undefined>;
    /**
     * Only nodes matching the selector will be considered by the scheduler when trying to find a Node that fits a Pod when that Pod uses a ResourceClaim that has not been allocated yet.
     *
     * Setting this field is optional. If null, all nodes are candidates.
...
//# sourceMappingURL=resourceClass.d.ts.map