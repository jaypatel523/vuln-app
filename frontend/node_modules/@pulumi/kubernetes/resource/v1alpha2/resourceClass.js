...
class ResourceClass extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new ResourceClass(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:resource.k8s.io/v1alpha2:ResourceClass';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1alpha1:ResourceClass" }] };
