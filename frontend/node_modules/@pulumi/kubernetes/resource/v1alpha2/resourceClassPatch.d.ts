...
export declare class ResourceClassPatch extends pulumi.CustomResource {
     ...
     */
    readonly parametersRef: pulumi.Output<outputs.resource.v1alpha2.ResourceClassParametersReferencePatch>;
    /**
...
export interface ResourceClassPatchArgs {
     ...
     * ParametersRef references an arbitrary separate object that may hold parameters that will be used by the driver when allocating a resource that uses this class. A dynamic resource driver can distinguish between parameters stored here and and those stored in ResourceClaimSpec.
     */
    parametersRef?: pulumi.Input<inputs.resource.v1alpha2.ResourceClassParametersReferencePatch | undefined>;
    /**
     * If and only if allocation of claims using this class is handled via structured parameters, then StructuredParameters must be set to true.
     */
     ...
     * Setting this field is optional. If null, all nodes are candidates.
     */
    suitableNodes?: pulumi.Input<inputs.core.v1.NodeSelectorPatch | undefined>;
}
//# sourceMappingURL=resourceClassPatch.d.ts.map