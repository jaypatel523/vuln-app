...
export declare class ResourceSlice extends pulumi.CustomResource {
     ...
     */
    readonly namedResources: pulumi.Output<outputs.resource.v1alpha2.NamedResourcesResources>;
    /**
...
export interface ResourceSliceArgs {
     ...
     * NamedResources describes available resources using the named resources model.
     */
    namedResources?: pulumi.Input<inputs.resource.v1alpha2.NamedResourcesResources | undefined>;
    /**
     * NodeName identifies the node which provides the resources if they are local to a node.
     *
     * A field selector can be used to list only ResourceSlice objects with a certain node name.
