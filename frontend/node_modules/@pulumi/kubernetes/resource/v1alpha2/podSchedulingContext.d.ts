...
export declare class PodSchedulingContext extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.resource.v1alpha2.PodSchedulingContextSpec>;
    /**
     * Status describes where resources for the Pod can be allocated.
     */
    readonly status: pulumi.Output<outputs.resource.v1alpha2.PodSchedulingContextStatus>;
    /**
...
export interface PodSchedulingContextArgs {
     ...
     * Spec describes where resources for the Pod are needed.
     */
    spec: pulumi.Input<inputs.resource.v1alpha2.PodSchedulingContextSpec>;
}
//# sourceMappingURL=podSchedulingContext.d.ts.map