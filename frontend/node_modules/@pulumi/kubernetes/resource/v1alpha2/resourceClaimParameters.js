...
exports.ResourceClaimParameters = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("../../utilities"));
/**
 * ResourceClaimParameters defines resource requests for a ResourceClaim in an in-tree format understood by Kubernetes.
 */
class ResourceClaimParameters extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new ResourceClaimParameters(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:resource.k8s.io/v1alpha2:ResourceClaimParameters';
    /**
...
//# sourceMappingURL=resourceClaimParameters.js.map