...
class DeviceClass extends pulumi.CustomResource {
    ...
    /** @internal */
    static __pulumiType = 'kubernetes:resource.k8s.io/v1beta2:DeviceClass';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:resource.k8s.io/v1:DeviceClass" }, { type: "kubernetes:resource.k8s.io/v1alpha3:DeviceClass" }, { type: "kubernetes:resource.k8s.io/v1beta1:DeviceClass" }] };
