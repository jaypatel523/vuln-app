...
export declare class ResourceClaimTemplate extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.resource.v1beta2.ResourceClaimTemplateSpec>;
    /**
...
export interface ResourceClaimTemplateArgs {
     ...
     * This field is immutable. A ResourceClaim will get created by the control plane for a Pod when needed and then not get updated anymore.
     */
    spec: pulumi.Input<inputs.resource.v1beta2.ResourceClaimTemplateSpec>;
}
//# sourceMappingURL=resourceClaimTemplate.d.ts.map