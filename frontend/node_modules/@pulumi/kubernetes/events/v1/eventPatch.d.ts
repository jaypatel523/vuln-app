...
export declare class EventPatch extends pulumi.CustomResource {
     ...
     */
    readonly deprecatedSource: pulumi.Output<outputs.core.v1.EventSourcePatch>;
    /**
     ...
     */
    readonly regarding: pulumi.Output<outputs.core.v1.ObjectReferencePatch>;
    /**
     ...
     */
    readonly series: pulumi.Output<outputs.events.v1.EventSeriesPatch>;
    /**
...
export interface EventPatchArgs {
     ...
     * series is data about the Event series this event represents or nil if it's a singleton Event.
     */
    series?: pulumi.Input<inputs.events.v1.EventSeriesPatch | undefined>;
    /**
     * type is the type of this event (Normal, Warning), new types could be added in the future. It is machine-readable. This field cannot be empty for new Events.
     */
