...
class ValidatingAdmissionPolicyBinding extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new ValidatingAdmissionPolicyBinding(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:admissionregistration.k8s.io/v1alpha1:ValidatingAdmissionPolicyBinding';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyBinding" }, { type: "kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingAdmissionPolicyBinding" }] };
