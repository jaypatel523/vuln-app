...
class ValidatingAdmissionPolicyList extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new ValidatingAdmissionPolicyList(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:admissionregistration.k8s.io/v1alpha1:ValidatingAdmissionPolicyList';
    /**
