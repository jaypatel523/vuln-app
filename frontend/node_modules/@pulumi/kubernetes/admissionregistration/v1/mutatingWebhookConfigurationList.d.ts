...
export declare class MutatingWebhookConfigurationList extends pulumi.CustomResource {
     ...
     */
    readonly items: pulumi.Output<outputs.admissionregistration.v1.MutatingWebhookConfiguration[]>;
    /**
...
export interface MutatingWebhookConfigurationListArgs {
     ...
     * List of MutatingWebhookConfiguration.
     */
    items: pulumi.Input<pulumi.Input<inputs.admissionregistration.v1.MutatingWebhookConfiguration>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
