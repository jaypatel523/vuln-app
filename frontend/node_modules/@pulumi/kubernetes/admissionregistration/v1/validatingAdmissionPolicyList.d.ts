...
export declare class ValidatingAdmissionPolicyList extends pulumi.CustomResource {
     ...
     */
    readonly items: pulumi.Output<outputs.admissionregistration.v1.ValidatingAdmissionPolicy[]>;
    /**
...
export interface ValidatingAdmissionPolicyListArgs {
     ...
     * List of ValidatingAdmissionPolicy.
     */
    items: pulumi.Input<pulumi.Input<inputs.admissionregistration.v1.ValidatingAdmissionPolicy>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
