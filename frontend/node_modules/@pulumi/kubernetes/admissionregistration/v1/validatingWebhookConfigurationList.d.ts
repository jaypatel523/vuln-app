 ...
 */
export declare class ValidatingWebhookConfigurationList extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ValidatingWebhookConfigurationList;
    /**
     ...
     */
    static isInstance(obj: any): obj is ValidatingWebhookConfigurationList;
    /**
     ...
     */
    readonly items: pulumi.Output<outputs.admissionregistration.v1.ValidatingWebhookConfiguration[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    readonly kind: pulumi.Output<"ValidatingWebhookConfigurationList">;
    /**
...
export interface ValidatingWebhookConfigurationListArgs {
     ...
     * List of ValidatingWebhookConfiguration.
     */
    items: pulumi.Input<pulumi.Input<inputs.admissionregistration.v1.ValidatingWebhookConfiguration>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"ValidatingWebhookConfigurationList" | undefined>;
    /**
     * metadata is the standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    metadata?: pulumi.Input<inputs.meta.v1.ListMeta | undefined>;
}
//# sourceMappingURL=validatingWebhookConfigurationList.d.ts.map