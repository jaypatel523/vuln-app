...
exports.MutatingWebhookConfigurationPatch = void 0;
 ...
 */
class MutatingWebhookConfigurationPatch extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new MutatingWebhookConfigurationPatch(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:admissionregistration.k8s.io/v1beta1:MutatingWebhookConfigurationPatch';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:admissionregistration.k8s.io/v1:MutatingWebhookConfigurationPatch" }] };
...
//# sourceMappingURL=mutatingWebhookConfigurationPatch.js.map