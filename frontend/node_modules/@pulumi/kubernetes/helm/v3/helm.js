...
const yaml = __importStar(require("../../yaml/index"));
/**
...
class Chart extends yaml.CollectionComponentResource {
    /** @internal */
    static __pulumiType = 'kubernetes:helm.sh/v3:Chart';
    /**
    ...
    constructor(releaseName, config, opts) {
        ...
        const aliasOpts = { ...opts, aliases: [{ type: "kubernetes:helm.sh/v2:Chart" }, ...(opts?.aliases ?? [])] };
