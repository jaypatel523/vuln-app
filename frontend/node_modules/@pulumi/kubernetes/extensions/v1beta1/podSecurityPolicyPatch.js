...
exports.PodSecurityPolicyPatch = void 0;
 ...
 */
class PodSecurityPolicyPatch extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new PodSecurityPolicyPatch(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:extensions/v1beta1:PodSecurityPolicyPatch';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:policy/v1beta1:PodSecurityPolicyPatch" }] };
...
//# sourceMappingURL=podSecurityPolicyPatch.js.map