...
class ReplicaSetPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    static __pulumiType = 'kubernetes:extensions/v1beta1:ReplicaSetPatch';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:apps/v1:ReplicaSetPatch" }, { type: "kubernetes:apps/v1beta2:ReplicaSetPatch" }] };
