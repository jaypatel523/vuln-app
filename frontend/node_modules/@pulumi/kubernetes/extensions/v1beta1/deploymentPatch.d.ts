...
export declare class DeploymentPatch extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.extensions.v1beta1.DeploymentSpecPatch>;
    /**
     * Most recently observed status of the Deployment.
     */
    readonly status: pulumi.Output<outputs.extensions.v1beta1.DeploymentStatusPatch>;
    /**
...
export interface DeploymentPatchArgs {
     ...
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"Deployment" | undefined>;
    /**
     * Standard object metadata.
     */
     ...
     * Specification of the desired behavior of the Deployment.
     */
    spec?: pulumi.Input<inputs.extensions.v1beta1.DeploymentSpecPatch | undefined>;
}
//# sourceMappingURL=deploymentPatch.d.ts.map