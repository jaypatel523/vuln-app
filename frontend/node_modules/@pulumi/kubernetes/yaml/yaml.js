...
exports.parse = exports.skipAwait = exports.getInvokeOpts = exports.getChildOpts = exports.ConfigFile = exports.ConfigGroup = exports.CollectionComponentResource = void 0;
// *** WARNING: this file was generated by pulumigen. ***
// *** Do not edit by hand unless you're certain you know what you are doing! ***
const pulumi = __importStar(require("@pulumi/pulumi"));
const fs = __importStar(require("fs"));
const glob = __importStar(require("glob"));
const admissionregistration = __importStar(require("../admissionregistration"));
const apiextensions = __importStar(require("../apiextensions"));
const apiregistration = __importStar(require("../apiregistration"));
const apps = __importStar(require("../apps"));
const auditregistration = __importStar(require("../auditregistration"));
const autoscaling = __importStar(require("../autoscaling"));
const batch = __importStar(require("../batch"));
const certificates = __importStar(require("../certificates"));
const coordination = __importStar(require("../coordination"));
const core = __importStar(require("../core"));
const discovery = __importStar(require("../discovery"));
const events = __importStar(require("../events"));
const extensions = __importStar(require("../extensions"));
const flowcontrol = __importStar(require("../flowcontrol"));
...
const scheduling = __importStar(require("../scheduling"));
const settings = __importStar(require("../settings"));
const storage = __importStar(require("../storage"));
const storagemigration = __importStar(require("../storagemigration"));
...
/** @ignore */ function getChildOpts(parent, opts) {
    return {
        parent: parent,
...
exports.getChildOpts = getChildOpts;
/** @ignore */ function getInvokeOpts(opts) {
    return {
        parent: opts?.parent,
        provider: opts?.provider,
        version: opts?.version ?? (0, utilities_1.getVersion)(),
        pluginDownloadURL: opts?.pluginDownloadURL,
        async: true
    };
}
exports.getInvokeOpts = getInvokeOpts;
...
/** @ignore */ function parseYamlObject(obj, transformations, resourcePrefix, opts) {
    ...
    switch (gvk) {
        case "admissionregistration.k8s.io/v1/MutatingAdmissionPolicy":
            return [id.apply(id => ({
                    name: `admissionregistration.k8s.io/v1/MutatingAdmissionPolicy::${id}`,
                    resource: new admissionregistration.v1.MutatingAdmissionPolicy(id, obj, opts),
                }))];
        case "admissionregistration.k8s.io/v1/MutatingAdmissionPolicyBinding":
            return [id.apply(id => ({
                    name: `admissionregistration.k8s.io/v1/MutatingAdmissionPolicyBinding::${id}`,
                    resource: new admissionregistration.v1.MutatingAdmissionPolicyBinding(id, obj, opts),
                }))];
        ...
        case "admissionregistration.k8s.io/v1/ValidatingAdmissionPolicy":
            return [id.apply(id => ({
                    name: `admissionregistration.k8s.io/v1/ValidatingAdmissionPolicy::${id}`,
                    resource: new admissionregistration.v1.ValidatingAdmissionPolicy(id, obj, opts),
                }))];
        case "admissionregistration.k8s.io/v1/ValidatingAdmissionPolicyBinding":
            return [id.apply(id => ({
                    name: `admissionregistration.k8s.io/v1/ValidatingAdmissionPolicyBinding::${id}`,
                    resource: new admissionregistration.v1.ValidatingAdmissionPolicyBinding(id, obj, opts),
                }))];
        ...
        case "admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicy":
            return [id.apply(id => ({
                    name: `admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicy::${id}`,
                    resource: new admissionregistration.v1alpha1.MutatingAdmissionPolicy(id, obj, opts),
                }))];
        case "admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicyBinding":
            return [id.apply(id => ({
                    name: `admissionregistration.k8s.io/v1alpha1/MutatingAdmissionPolicyBinding::${id}`,
                    resource: new admissionregistration.v1alpha1.MutatingAdmissionPolicyBinding(id, obj, opts),
                }))];
        ...
        case "certificates.k8s.io/v1alpha1/ClusterTrustBundle":
            return [id.apply(id => ({
                    name: `certificates.k8s.io/v1alpha1/ClusterTrustBundle::${id}`,
                    resource: new certificates.v1alpha1.ClusterTrustBundle(id, obj, opts),
                }))];
        ...
        case "coordination.k8s.io/v1alpha1/LeaseCandidate":
            return [id.apply(id => ({
                    name: `coordination.k8s.io/v1alpha1/LeaseCandidate::${id}`,
                    resource: new coordination.v1alpha1.LeaseCandidate(id, obj, opts),
                }))];
        case "coordination.k8s.io/v1alpha2/LeaseCandidate":
            return [id.apply(id => ({
                    name: `coordination.k8s.io/v1alpha2/LeaseCandidate::${id}`,
                    resource: new coordination.v1alpha2.LeaseCandidate(id, obj, opts),
                }))];
        ...
        case "coordination.k8s.io/v1beta1/LeaseCandidate":
            return [id.apply(id => ({
                    name: `coordination.k8s.io/v1beta1/LeaseCandidate::${id}`,
                    resource: new coordination.v1beta1.LeaseCandidate(id, obj, opts),
                }))];
        case "v1/Binding":
            return [id.apply(id => ({
                    name: `v1/Binding::${id}`,
        ...
        case "flowcontrol.apiserver.k8s.io/v1/FlowSchema":
            return [id.apply(id => ({
                    name: `flowcontrol.apiserver.k8s.io/v1/FlowSchema::${id}`,
                    resource: new flowcontrol.v1.FlowSchema(id, obj, opts),
                }))];
        case "flowcontrol.apiserver.k8s.io/v1/PriorityLevelConfiguration":
            return [id.apply(id => ({
                    name: `flowcontrol.apiserver.k8s.io/v1/PriorityLevelConfiguration::${id}`,
                    resource: new flowcontrol.v1.PriorityLevelConfiguration(id, obj, opts),
                }))];
        ...
        case "networking.k8s.io/v1/IPAddress":
            return [id.apply(id => ({
                    name: `networking.k8s.io/v1/IPAddress::${id}`,
                    resource: new networking.v1.IPAddress(id, obj, opts),
                }))];
        ...
        case "networking.k8s.io/v1/ServiceCIDR":
            return [id.apply(id => ({
                    name: `networking.k8s.io/v1/ServiceCIDR::${id}`,
                    resource: new networking.v1.ServiceCIDR(id, obj, opts),
                }))];
        ...
        case "networking.k8s.io/v1alpha1/IPAddress":
            return [id.apply(id => ({
                    name: `networking.k8s.io/v1alpha1/IPAddress::${id}`,
                    resource: new networking.v1alpha1.IPAddress(id, obj, opts),
                }))];
        case "networking.k8s.io/v1alpha1/ServiceCIDR":
            return [id.apply(id => ({
                    name: `networking.k8s.io/v1alpha1/ServiceCIDR::${id}`,
                    resource: new networking.v1alpha1.ServiceCIDR(id, obj, opts),
                }))];
        case "networking.k8s.io/v1beta1/IPAddress":
            return [id.apply(id => ({
                    name: `networking.k8s.io/v1beta1/IPAddress::${id}`,
                    resource: new networking.v1beta1.IPAddress(id, obj, opts),
                }))];
        ...
        case "networking.k8s.io/v1beta1/ServiceCIDR":
            return [id.apply(id => ({
                    name: `networking.k8s.io/v1beta1/ServiceCIDR::${id}`,
                    resource: new networking.v1beta1.ServiceCIDR(id, obj, opts),
                }))];
        ...
        case "resource.k8s.io/v1alpha2/PodSchedulingContext":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha2/PodSchedulingContext::${id}`,
                    resource: new resource.v1alpha2.PodSchedulingContext(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha2/ResourceClaim":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha2/ResourceClaim::${id}`,
                    resource: new resource.v1alpha2.ResourceClaim(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha2/ResourceClaimParameters":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha2/ResourceClaimParameters::${id}`,
                    resource: new resource.v1alpha2.ResourceClaimParameters(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha2/ResourceClaimTemplate":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha2/ResourceClaimTemplate::${id}`,
                    resource: new resource.v1alpha2.ResourceClaimTemplate(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha2/ResourceClass":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha2/ResourceClass::${id}`,
                    resource: new resource.v1alpha2.ResourceClass(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha2/ResourceClassParameters":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha2/ResourceClassParameters::${id}`,
                    resource: new resource.v1alpha2.ResourceClassParameters(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha2/ResourceSlice":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha2/ResourceSlice::${id}`,
                    resource: new resource.v1alpha2.ResourceSlice(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha3/DeviceClass":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha3/DeviceClass::${id}`,
                    resource: new resource.v1alpha3.DeviceClass(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha3/DeviceTaintRule":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha3/DeviceTaintRule::${id}`,
                    resource: new resource.v1alpha3.DeviceTaintRule(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha3/PodSchedulingContext":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha3/PodSchedulingContext::${id}`,
                    resource: new resource.v1alpha3.PodSchedulingContext(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha3/ResourceClaim":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha3/ResourceClaim::${id}`,
                    resource: new resource.v1alpha3.ResourceClaim(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha3/ResourceClaimTemplate":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha3/ResourceClaimTemplate::${id}`,
                    resource: new resource.v1alpha3.ResourceClaimTemplate(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha3/ResourcePoolStatusRequest":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha3/ResourcePoolStatusRequest::${id}`,
                    resource: new resource.v1alpha3.ResourcePoolStatusRequest(id, obj, opts),
                }))];
        case "resource.k8s.io/v1alpha3/ResourceSlice":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1alpha3/ResourceSlice::${id}`,
                    resource: new resource.v1alpha3.ResourceSlice(id, obj, opts),
                }))];
        case "resource.k8s.io/v1beta1/DeviceClass":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1beta1/DeviceClass::${id}`,
                    resource: new resource.v1beta1.DeviceClass(id, obj, opts),
                }))];
        case "resource.k8s.io/v1beta1/ResourceClaim":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1beta1/ResourceClaim::${id}`,
                    resource: new resource.v1beta1.ResourceClaim(id, obj, opts),
                }))];
        case "resource.k8s.io/v1beta1/ResourceClaimTemplate":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1beta1/ResourceClaimTemplate::${id}`,
                    resource: new resource.v1beta1.ResourceClaimTemplate(id, obj, opts),
                }))];
        case "resource.k8s.io/v1beta1/ResourceSlice":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1beta1/ResourceSlice::${id}`,
                    resource: new resource.v1beta1.ResourceSlice(id, obj, opts),
                }))];
        case "resource.k8s.io/v1beta2/DeviceClass":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1beta2/DeviceClass::${id}`,
                    resource: new resource.v1beta2.DeviceClass(id, obj, opts),
                }))];
        case "resource.k8s.io/v1beta2/DeviceTaintRule":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1beta2/DeviceTaintRule::${id}`,
                    resource: new resource.v1beta2.DeviceTaintRule(id, obj, opts),
                }))];
        case "resource.k8s.io/v1beta2/ResourceClaim":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1beta2/ResourceClaim::${id}`,
                    resource: new resource.v1beta2.ResourceClaim(id, obj, opts),
                }))];
        case "resource.k8s.io/v1beta2/ResourceClaimTemplate":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1beta2/ResourceClaimTemplate::${id}`,
                    resource: new resource.v1beta2.ResourceClaimTemplate(id, obj, opts),
                }))];
        case "resource.k8s.io/v1beta2/ResourceSlice":
            return [id.apply(id => ({
                    name: `resource.k8s.io/v1beta2/ResourceSlice::${id}`,
                    resource: new resource.v1beta2.ResourceSlice(id, obj, opts),
                }))];
        ...
        case "scheduling.k8s.io/v1alpha2/PodGroup":
            return [id.apply(id => ({
                    name: `scheduling.k8s.io/v1alpha2/PodGroup::${id}`,
                    resource: new scheduling.v1alpha2.PodGroup(id, obj, opts),
                }))];
        case "scheduling.k8s.io/v1alpha2/Workload":
            return [id.apply(id => ({
                    name: `scheduling.k8s.io/v1alpha2/Workload::${id}`,
                    resource: new scheduling.v1alpha2.Workload(id, obj, opts),
                }))];
        ...
        case "storage.k8s.io/v1alpha1/VolumeAttributesClass":
            return [id.apply(id => ({
                    name: `storage.k8s.io/v1alpha1/VolumeAttributesClass::${id}`,
                    resource: new storage.v1alpha1.VolumeAttributesClass(id, obj, opts),
                }))];
        ...
        case "storage.k8s.io/v1beta1/VolumeAttributesClass":
            return [id.apply(id => ({
                    name: `storage.k8s.io/v1beta1/VolumeAttributesClass::${id}`,
                    resource: new storage.v1beta1.VolumeAttributesClass(id, obj, opts),
                }))];
