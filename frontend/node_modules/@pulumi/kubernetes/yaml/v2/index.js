    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "kubernetes:yaml/v2:ConfigFile":
                return new exports.ConfigFile(name, undefined, { urn });
            case "kubernetes:yaml/v2:ConfigGroup":
                return new exports.ConfigGroup(name, undefined, { urn });
            default:
