...
class IPAddress extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new IPAddress(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:networking.k8s.io/v1:IPAddress';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.k8s.io/v1alpha1:IPAddress" }, { type: "kubernetes:networking.k8s.io/v1beta1:IPAddress" }] };
