 ...
 */
class IPAddressPatch extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new IPAddressPatch(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:networking.k8s.io/v1alpha1:IPAddressPatch';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.k8s.io/v1:IPAddressPatch" }, { type: "kubernetes:networking.k8s.io/v1beta1:IPAddressPatch" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(IPAddressPatch.__pulumiType, name, resourceInputs, opts);
    }
}
exports.IPAddressPatch = IPAddressPatch;
//# sourceMappingURL=ipaddressPatch.js.map