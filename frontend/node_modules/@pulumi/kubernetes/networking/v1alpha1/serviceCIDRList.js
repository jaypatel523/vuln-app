...
exports.ServiceCIDRList = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("../../utilities"));
/**
 * ServiceCIDRList contains a list of ServiceCIDR objects.
 */
class ServiceCIDRList extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new ServiceCIDRList(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:networking.k8s.io/v1alpha1:ServiceCIDRList';
    /**
...
//# sourceMappingURL=serviceCIDRList.js.map