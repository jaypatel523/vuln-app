...
export declare class IPAddress extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IPAddress;
    /**
     ...
     */
    readonly spec: pulumi.Output<outputs.networking.v1alpha1.IPAddressSpec>;
    /**
...
export interface IPAddressArgs {
     ...
     * spec is the desired state of the IPAddress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    spec?: pulumi.Input<inputs.networking.v1alpha1.IPAddressSpec | undefined>;
}
