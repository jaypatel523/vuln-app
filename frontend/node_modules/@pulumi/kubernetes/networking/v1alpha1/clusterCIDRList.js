...
exports.ClusterCIDRList = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("../../utilities"));
/**
 * ClusterCIDRList contains a list of ClusterCIDR.
 */
class ClusterCIDRList extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new ClusterCIDRList(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:networking.k8s.io/v1alpha1:ClusterCIDRList';
    /**
    ...
    static isInstance(obj) {
        ...
        return obj['__pulumiType'] === ClusterCIDRList.__pulumiType;
    }
    /**
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "ClusterCIDRList";
        ...
        super(ClusterCIDRList.__pulumiType, name, resourceInputs, opts);
    }
}
exports.ClusterCIDRList = ClusterCIDRList;
//# sourceMappingURL=clusterCIDRList.js.map