...
export declare class IngressClass extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.networking.v1beta1.IngressClassSpec>;
    /**
...
export interface IngressClassArgs {
     ...
     * Spec is the desired state of the IngressClass. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    spec?: pulumi.Input<inputs.networking.v1beta1.IngressClassSpec | undefined>;
}
//# sourceMappingURL=ingressClass.d.ts.map