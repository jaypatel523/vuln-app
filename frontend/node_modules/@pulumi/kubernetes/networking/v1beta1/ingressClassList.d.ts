...
export declare class IngressClassList extends pulumi.CustomResource {
     ...
     */
    readonly items: pulumi.Output<outputs.networking.v1beta1.IngressClass[]>;
    /**
...
export interface IngressClassListArgs {
     ...
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"IngressClassList" | undefined>;
    /**
     * Standard list metadata.
     */
    metadata?: pulumi.Input<inputs.meta.v1.ListMeta | undefined>;
}
//# sourceMappingURL=ingressClassList.d.ts.map