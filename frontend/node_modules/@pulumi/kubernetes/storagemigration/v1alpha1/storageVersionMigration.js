...
class StorageVersionMigration extends pulumi.CustomResource {
    ...
    /** @internal */
    static __pulumiType = 'kubernetes:storagemigration.k8s.io/v1alpha1:StorageVersionMigration';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:storagemigration.k8s.io/v1beta1:StorageVersionMigration" }] };
