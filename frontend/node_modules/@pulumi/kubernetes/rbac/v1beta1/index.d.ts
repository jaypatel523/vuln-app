...
export declare const ClusterRole: typeof import("./clusterRole").ClusterRole;
...
export declare const ClusterRoleBinding: typeof import("./clusterRoleBinding").ClusterRoleBinding;
...
export declare const ClusterRoleBindingList: typeof import("./clusterRoleBindingList").ClusterRoleBindingList;
...
export declare const ClusterRoleBindingPatch: typeof import("./clusterRoleBindingPatch").ClusterRoleBindingPatch;
export { ClusterRoleListArgs } from "./clusterRoleList";
export type ClusterRoleList = import("./clusterRoleList").ClusterRoleList;
export declare const ClusterRoleList: typeof import("./clusterRoleList").ClusterRoleList;
export { ClusterRolePatchArgs } from "./clusterRolePatch";
export type ClusterRolePatch = import("./clusterRolePatch").ClusterRolePatch;
export declare const ClusterRolePatch: typeof import("./clusterRolePatch").ClusterRolePatch;
...
export declare const RoleBindingList: typeof import("./roleBindingList").RoleBindingList;
export { RoleBindingPatchArgs } from "./roleBindingPatch";
export type RoleBindingPatch = import("./roleBindingPatch").RoleBindingPatch;
export declare const RoleBindingPatch: typeof import("./roleBindingPatch").RoleBindingPatch;
export { RoleListArgs } from "./roleList";
export type RoleList = import("./roleList").RoleList;
export declare const RoleList: typeof import("./roleList").RoleList;
export { RolePatchArgs } from "./rolePatch";
export type RolePatch = import("./rolePatch").RolePatch;
export declare const RolePatch: typeof import("./rolePatch").RolePatch;
