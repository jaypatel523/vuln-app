...
export declare class RoleBinding extends pulumi.CustomResource {
     ...
     */
    readonly roleRef: pulumi.Output<outputs.rbac.v1beta1.RoleRef>;
    /**
     * Subjects holds references to the objects the role applies to.
     */
    readonly subjects: pulumi.Output<outputs.rbac.v1beta1.Subject[]>;
    /**
...
export interface RoleBindingArgs {
     ...
     * Subjects holds references to the objects the role applies to.
     */
    subjects?: pulumi.Input<pulumi.Input<inputs.rbac.v1beta1.Subject>[] | undefined>;
}
