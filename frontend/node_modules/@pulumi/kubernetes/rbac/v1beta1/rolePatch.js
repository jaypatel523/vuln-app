...
class RolePatch extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new RolePatch(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:rbac.authorization.k8s.io/v1beta1:RolePatch';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:rbac.authorization.k8s.io/v1:RolePatch" }, { type: "kubernetes:rbac.authorization.k8s.io/v1alpha1:RolePatch" }] };
