...
export declare class ClusterRoleBindingPatch extends pulumi.CustomResource {
     ...
     */
    readonly roleRef: pulumi.Output<outputs.rbac.v1beta1.RoleRefPatch>;
    /**
     * Subjects holds references to the objects the role applies to.
     */
    readonly subjects: pulumi.Output<outputs.rbac.v1beta1.SubjectPatch[]>;
    /**
...
export interface ClusterRoleBindingPatchArgs {
     ...
     * RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
     */
    roleRef?: pulumi.Input<inputs.rbac.v1beta1.RoleRefPatch | undefined>;
    /**
     * Subjects holds references to the objects the role applies to.
     */
    subjects?: pulumi.Input<pulumi.Input<inputs.rbac.v1beta1.SubjectPatch>[] | undefined>;
}
//# sourceMappingURL=clusterRoleBindingPatch.d.ts.map