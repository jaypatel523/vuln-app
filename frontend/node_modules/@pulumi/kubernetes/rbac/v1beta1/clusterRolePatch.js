...
class ClusterRolePatch extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new ClusterRolePatch(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRolePatch';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:rbac.authorization.k8s.io/v1:ClusterRolePatch" }, { type: "kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRolePatch" }] };
