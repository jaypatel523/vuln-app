...
class RolePatch extends pulumi.CustomResource {
    ...
    /** @internal */
    static __pulumiType = 'kubernetes:rbac.authorization.k8s.io/v1alpha1:RolePatch';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:rbac.authorization.k8s.io/v1:RolePatch" }, { type: "kubernetes:rbac.authorization.k8s.io/v1beta1:RolePatch" }] };
