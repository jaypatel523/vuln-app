...
class RoleBindingPatch extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new RoleBindingPatch(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleBindingPatch';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:rbac.authorization.k8s.io/v1:RoleBindingPatch" }, { type: "kubernetes:rbac.authorization.k8s.io/v1beta1:RoleBindingPatch" }] };
