 ...
 */
export declare class AuditSink extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AuditSink;
    /**
     * Returns true if the given object is an instance of AuditSink.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AuditSink;
    /**
     ...
     */
    readonly spec: pulumi.Output<outputs.auditregistration.v1alpha1.AuditSinkSpec>;
    /**
...
export interface AuditSinkArgs {
     ...
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"AuditSink" | undefined>;
    metadata?: pulumi.Input<inputs.meta.v1.ObjectMeta | undefined>;
    /**
     * Spec defines the audit configuration spec
     */
    spec?: pulumi.Input<inputs.auditregistration.v1alpha1.AuditSinkSpec | undefined>;
}
