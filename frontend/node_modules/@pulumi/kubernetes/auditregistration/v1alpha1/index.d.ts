...
export declare const AuditSink: typeof import("./auditSink").AuditSink;
export { AuditSinkListArgs } from "./auditSinkList";
export type AuditSinkList = import("./auditSinkList").AuditSinkList;
export declare const AuditSinkList: typeof import("./auditSinkList").AuditSinkList;
export { AuditSinkPatchArgs } from "./auditSinkPatch";
export type AuditSinkPatch = import("./auditSinkPatch").AuditSinkPatch;
export declare const AuditSinkPatch: typeof import("./auditSinkPatch").AuditSinkPatch;
