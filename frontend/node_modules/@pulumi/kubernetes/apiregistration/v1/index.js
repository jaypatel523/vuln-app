...
exports.APIServicePatch = exports.APIServiceList = exports.APIService = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("../../utilities"));
exports.APIService = null;
utilities.lazyLoad(exports, ["APIService"], () => require("./apiservice"));
exports.APIServiceList = null;
utilities.lazyLoad(exports, ["APIServiceList"], () => require("./apiserviceList"));
exports.APIServicePatch = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "kubernetes:apiregistration.k8s.io/v1:APIService":
                return new exports.APIService(name, undefined, { urn });
            case "kubernetes:apiregistration.k8s.io/v1:APIServiceList":
                return new exports.APIServiceList(name, undefined, { urn });
            case "kubernetes:apiregistration.k8s.io/v1:APIServicePatch":
                return new exports.APIServicePatch(name, undefined, { urn });
            default:
