...
exports.PodPresetPatch = exports.PodPresetList = exports.PodPreset = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("../../utilities"));
exports.PodPreset = null;
utilities.lazyLoad(exports, ["PodPreset"], () => require("./podPreset"));
exports.PodPresetList = null;
utilities.lazyLoad(exports, ["PodPresetList"], () => require("./podPresetList"));
exports.PodPresetPatch = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "kubernetes:settings.k8s.io/v1alpha1:PodPreset":
                return new exports.PodPreset(name, undefined, { urn });
            case "kubernetes:settings.k8s.io/v1alpha1:PodPresetList":
                return new exports.PodPresetList(name, undefined, { urn });
            case "kubernetes:settings.k8s.io/v1alpha1:PodPresetPatch":
                return new exports.PodPresetPatch(name, undefined, { urn });
            default:
