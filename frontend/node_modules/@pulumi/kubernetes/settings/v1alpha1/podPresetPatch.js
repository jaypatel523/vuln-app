 ...
 */
class PodPresetPatch extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new PodPresetPatch(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:settings.k8s.io/v1alpha1:PodPresetPatch';
    /**
...
exports.PodPresetPatch = PodPresetPatch;
//# sourceMappingURL=podPresetPatch.js.map