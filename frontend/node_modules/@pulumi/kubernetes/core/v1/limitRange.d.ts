 ...
 */
export declare class LimitRange extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LimitRange;
    /**
     * Returns true if the given object is an instance of LimitRange.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LimitRange;
    /**
     ...
     */
    readonly spec: pulumi.Output<outputs.core.v1.LimitRangeSpec>;
    /**
...
export interface LimitRangeArgs {
     ...
     * Spec defines the limits enforced. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    spec?: pulumi.Input<inputs.core.v1.LimitRangeSpec | undefined>;
}
//# sourceMappingURL=limitRange.d.ts.map