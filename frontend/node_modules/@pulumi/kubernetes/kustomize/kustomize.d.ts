 ...
 * ```
 */
export declare class Directory extends yaml.CollectionComponentResource {
    /**
     ...
     */
    constructor(name: string, config: DirectoryOpts, opts?: pulumi.ComponentResourceOptions);
}
/**
...
export {};
//# sourceMappingURL=kustomize.d.ts.map