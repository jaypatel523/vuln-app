...
export declare class EndpointSliceList extends pulumi.CustomResource {
     ...
     */
    readonly items: pulumi.Output<outputs.discovery.v1beta1.EndpointSlice[]>;
    /**
...
export interface EndpointSliceListArgs {
     ...
     * List of endpoint slices
     */
    items: pulumi.Input<pulumi.Input<inputs.discovery.v1beta1.EndpointSlice>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"EndpointSliceList" | undefined>;
    /**
     * Standard list metadata.
     */
    metadata?: pulumi.Input<inputs.meta.v1.ListMeta | undefined>;
}
//# sourceMappingURL=endpointSliceList.d.ts.map