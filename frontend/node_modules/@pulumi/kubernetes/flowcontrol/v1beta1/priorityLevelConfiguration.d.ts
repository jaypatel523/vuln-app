...
export declare class PriorityLevelConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.flowcontrol.v1beta1.PriorityLevelConfigurationSpec>;
    /**
     * `status` is the current status of a "request-priority". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    readonly status: pulumi.Output<outputs.flowcontrol.v1beta1.PriorityLevelConfigurationStatus>;
    /**
...
export interface PriorityLevelConfigurationArgs {
     ...
     * `spec` is the specification of the desired behavior of a "request-priority". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    spec?: pulumi.Input<inputs.flowcontrol.v1beta1.PriorityLevelConfigurationSpec | undefined>;
}
