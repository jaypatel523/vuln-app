...
export declare class FlowSchemaList extends pulumi.CustomResource {
     ...
     */
    readonly items: pulumi.Output<outputs.flowcontrol.v1beta1.FlowSchema[]>;
    /**
...
export interface FlowSchemaListArgs {
     ...
     * `items` is a list of FlowSchemas.
     */
    items: pulumi.Input<pulumi.Input<inputs.flowcontrol.v1beta1.FlowSchema>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"FlowSchemaList" | undefined>;
    /**
     * `metadata` is the standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    metadata?: pulumi.Input<inputs.meta.v1.ListMeta | undefined>;
}
//# sourceMappingURL=flowSchemaList.d.ts.map