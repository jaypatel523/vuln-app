...
export declare class PriorityLevelConfigurationList extends pulumi.CustomResource {
     ...
     */
    readonly items: pulumi.Output<outputs.flowcontrol.v1beta3.PriorityLevelConfiguration[]>;
    /**
...
export interface PriorityLevelConfigurationListArgs {
     ...
     * `items` is a list of request-priorities.
     */
    items: pulumi.Input<pulumi.Input<inputs.flowcontrol.v1beta3.PriorityLevelConfiguration>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
