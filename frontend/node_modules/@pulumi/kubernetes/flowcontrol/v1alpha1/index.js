...
const _module = {
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:FlowSchemaPatch":
            ...
            case "kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:PriorityLevelConfigurationPatch":
