 ...
 */
export declare class StatefulSetList extends pulumi.CustomResource {
    /**
...
export interface StatefulSetListArgs {
    ...
    items: pulumi.Input<pulumi.Input<inputs.apps.v1beta1.StatefulSet>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"StatefulSetList" | undefined>;
    metadata?: pulumi.Input<inputs.meta.v1.ListMeta | undefined>;
}
//# sourceMappingURL=statefulSetList.d.ts.map