...
export declare class DeploymentPatch extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.apps.v1beta1.DeploymentSpecPatch>;
    /**
     * Most recently observed status of the Deployment.
     */
    readonly status: pulumi.Output<outputs.apps.v1beta1.DeploymentStatusPatch>;
    /**
...
export interface DeploymentPatchArgs {
     ...
     * Specification of the desired behavior of the Deployment.
     */
    spec?: pulumi.Input<inputs.apps.v1beta1.DeploymentSpecPatch | undefined>;
}
