...
export declare class StatefulSet extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.apps.v1beta1.StatefulSetSpec>;
    /**
     * Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
     */
    readonly status: pulumi.Output<outputs.apps.v1beta1.StatefulSetStatus>;
    /**
...
export interface StatefulSetArgs {
     ...
     * Spec defines the desired identities of pods in this set.
     */
    spec?: pulumi.Input<inputs.apps.v1beta1.StatefulSetSpec | undefined>;
}
//# sourceMappingURL=statefulSet.d.ts.map