...
class DeploymentPatch extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new DeploymentPatch(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:apps/v1beta1:DeploymentPatch';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:apps/v1:DeploymentPatch" }, { type: "kubernetes:apps/v1beta2:DeploymentPatch" }, { type: "kubernetes:extensions/v1beta1:DeploymentPatch" }] };
