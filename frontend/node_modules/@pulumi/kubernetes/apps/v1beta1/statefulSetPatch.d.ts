...
export declare class StatefulSetPatch extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.apps.v1beta1.StatefulSetSpecPatch>;
    /**
     * Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
     */
    readonly status: pulumi.Output<outputs.apps.v1beta1.StatefulSetStatusPatch>;
    /**
...
export interface StatefulSetPatchArgs {
     ...
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"StatefulSet" | undefined>;
    metadata?: pulumi.Input<inputs.meta.v1.ObjectMetaPatch | undefined>;
    /**
     * Spec defines the desired identities of pods in this set.
     */
    spec?: pulumi.Input<inputs.apps.v1beta1.StatefulSetSpecPatch | undefined>;
}
//# sourceMappingURL=statefulSetPatch.d.ts.map