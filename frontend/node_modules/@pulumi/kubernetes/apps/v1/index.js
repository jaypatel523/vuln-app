...
exports.StatefulSetPatch = exports.StatefulSetList = exports.StatefulSet = exports.ReplicaSetPatch = exports.ReplicaSetList = exports.ReplicaSet = exports.DeploymentPatch = exports.DeploymentList = exports.Deployment = exports.DaemonSetPatch = exports.DaemonSetList = exports.DaemonSet = exports.ControllerRevisionPatch = exports.ControllerRevisionList = exports.ControllerRevision = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("../../utilities"));
exports.ControllerRevision = null;
utilities.lazyLoad(exports, ["ControllerRevision"], () => require("./controllerRevision"));
exports.ControllerRevisionList = null;
utilities.lazyLoad(exports, ["ControllerRevisionList"], () => require("./controllerRevisionList"));
exports.ControllerRevisionPatch = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "kubernetes:apps/v1:ControllerRevision":
                return new exports.ControllerRevision(name, undefined, { urn });
            case "kubernetes:apps/v1:ControllerRevisionList":
                return new exports.ControllerRevisionList(name, undefined, { urn });
            case "kubernetes:apps/v1:ControllerRevisionPatch":
                return new exports.ControllerRevisionPatch(name, undefined, { urn });
            ...
            case "kubernetes:apps/v1:StatefulSet":
                return new exports.StatefulSet(name, undefined, { urn });
            case "kubernetes:apps/v1:StatefulSetList":
                return new exports.StatefulSetList(name, undefined, { urn });
            case "kubernetes:apps/v1:StatefulSetPatch":
                return new exports.StatefulSetPatch(name, undefined, { urn });
            default:
