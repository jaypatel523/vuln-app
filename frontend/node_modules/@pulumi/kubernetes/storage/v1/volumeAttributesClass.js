...
class VolumeAttributesClass extends pulumi.CustomResource {
    ...
    /** @internal */
    static __pulumiType = 'kubernetes:storage.k8s.io/v1:VolumeAttributesClass';
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:storage.k8s.io/v1alpha1:VolumeAttributesClass" }, { type: "kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClass" }] };
