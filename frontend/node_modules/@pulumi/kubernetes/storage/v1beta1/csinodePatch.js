 ...
 *
 * @deprecated storage/v1beta1/CSINode is deprecated by storage.k8s.io/v1/CSINode and not supported by Kubernetes v1.22+ clusters.
 */
class CSINodePatch extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new CSINodePatch(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:storage.k8s.io/v1beta1:CSINodePatch';
    /**
