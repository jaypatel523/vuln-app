...
exports.VolumeAttributesClass = void 0;
...
class VolumeAttributesClass extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new VolumeAttributesClass(name, undefined, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'kubernetes:storage.k8s.io/v1beta1:VolumeAttributesClass';
    /**
     * Returns true if the given object is an instance of VolumeAttributesClass.  This is designed to work even
    ...
    static isInstance(obj) {
        ...
        return obj['__pulumiType'] === VolumeAttributesClass.__pulumiType;
    }
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:storage.k8s.io/v1:VolumeAttributesClass" }, { type: "kubernetes:storage.k8s.io/v1alpha1:VolumeAttributesClass" }] };
...
//# sourceMappingURL=volumeAttributesClass.js.map