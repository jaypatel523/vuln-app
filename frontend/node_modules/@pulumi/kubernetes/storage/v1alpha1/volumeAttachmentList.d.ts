...
export declare class VolumeAttachmentList extends pulumi.CustomResource {
     ...
     */
    readonly items: pulumi.Output<outputs.storage.v1alpha1.VolumeAttachment[]>;
    /**
...
export interface VolumeAttachmentListArgs {
     ...
     * Items is the list of VolumeAttachments
     */
    items: pulumi.Input<pulumi.Input<inputs.storage.v1alpha1.VolumeAttachment>[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"VolumeAttachmentList" | undefined>;
    /**
     * Standard list metadata More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    metadata?: pulumi.Input<inputs.meta.v1.ListMeta | undefined>;
}
//# sourceMappingURL=volumeAttachmentList.d.ts.map