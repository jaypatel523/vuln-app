...
export declare class VolumeAttachment extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.storage.v1alpha1.VolumeAttachmentSpec>;
    /**
     * Status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the external-attacher.
     */
    readonly status: pulumi.Output<outputs.storage.v1alpha1.VolumeAttachmentStatus>;
    /**
