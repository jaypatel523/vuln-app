 ...
 * ```
 */
export declare function getTestablePermissionsOutput(args: GetTestablePermissionsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTestablePermissionsResult>;
/**
 * A collection of arguments for invoking getTestablePermissions.
 */
export interface GetTestablePermissionsOutputArgs {
     ...
     * The level of support for custom roles. Can be one of `"NOT_SUPPORTED"`, `"SUPPORTED"`, `"TESTING"`. Default is `"SUPPORTED"`
     */
    customSupportLevel?: pulumi.Input<string | undefined>;
    /**
     * See [full resource name documentation](https://cloud.google.com/apis/design/resource_names#full_resource_name) for more detail.
     */
...
//# sourceMappingURL=getTestablePermissions.d.ts.map