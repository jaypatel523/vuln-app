...
export interface PrivateConnectionState {
     ...
     * Structure is documented below.
     */
    errors?: pulumi.Input<pulumi.Input<inputs.datastream.PrivateConnectionError>[] | undefined>;
    /**
     * Labels.
     * **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
     * Please refer to the field `effectiveLabels` for all of the labels present on the resource.
     ...
     * The private connectivity identifier.
     */
    privateConnectionId?: pulumi.Input<string | undefined>;
    /**
     * The ID of the project in which the resource belongs.
     * If it is not provided, the provider project is used.
     */
     ...
     * Structure is documented below.
     */
    pscInterfaceConfig?: pulumi.Input<inputs.datastream.PrivateConnectionPscInterfaceConfig | undefined>;
    /**
     * The combination of labels configured directly on the resource
     *  and default labels configured on the provider.
     */
     ...
     * Structure is documented below.
     */
    vpcPeeringConfig?: pulumi.Input<inputs.datastream.PrivateConnectionVpcPeeringConfig | undefined>;
}
/**
...
//# sourceMappingURL=privateConnection.d.ts.map