...
export interface V2OrganizationSourceIamBindingState {
    condition?: pulumi.Input<inputs.securitycenter.V2OrganizationSourceIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
...
//# sourceMappingURL=v2organizationSourceIamBinding.d.ts.map