 ...
 * ```
 */
export declare class UllMirroringCollectorRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UllMirroringCollectorRuleState, opts?: pulumi.CustomResourceOptions): UllMirroringCollectorRule;
    /**
     ...
     */
    static isInstance(obj: any): obj is UllMirroringCollectorRule;
    /**
     ...
     */
    readonly match: pulumi.Output<outputs.networksecurity.UllMirroringCollectorRuleMatch>;
    /**
     ...
     * Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
     */
    readonly ullMirroringCollector: pulumi.Output<string>;
    /**
     * ID for the new UllMirroringCollectorRule.
     */
    readonly ullMirroringCollectorRuleId: pulumi.Output<string>;
    /**
...
//# sourceMappingURL=ullMirroringCollectorRule.d.ts.map