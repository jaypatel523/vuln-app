...
exports.UllMirroringEngine = void 0;
...
class UllMirroringEngine extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new UllMirroringEngine(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'gcp:networksecurity/ullMirroringEngine:UllMirroringEngine';
    /**
     * Returns true if the given object is an instance of UllMirroringEngine.  This is designed to work even
    ...
    static isInstance(obj) {
        ...
        return obj['__pulumiType'] === UllMirroringEngine.__pulumiType;
    }
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ullMirroringEngineId"] = state?.ullMirroringEngineId;
            ...
            if (args?.ullMirroringEngineId === undefined && !opts.urn) {
                throw new Error("Missing required property 'ullMirroringEngineId'");
            }
            resourceInputs["deletionPolicy"] = args?.deletionPolicy;
            resourceInputs["labels"] = args?.labels;
            resourceInputs["location"] = args?.location;
            resourceInputs["project"] = args?.project;
            resourceInputs["ullMirroringEngineId"] = args?.ullMirroringEngineId;
        ...
        super(UllMirroringEngine.__pulumiType, name, resourceInputs, opts);
    }
}
exports.UllMirroringEngine = UllMirroringEngine;
//# sourceMappingURL=ullMirroringEngine.js.map