...
class SacRealm extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new SacRealm(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'gcp:networksecurity/sacRealm:SacRealm';
    /**
...
exports.SacRealm = SacRealm;
//# sourceMappingURL=sacRealm.js.map