...
export interface MirroringDeploymentGroupState {
     ...
     * Structure is documented below.
     */
    connectedEndpointGroups?: pulumi.Input<pulumi.Input<inputs.networksecurity.MirroringDeploymentGroupConnectedEndpointGroup>[] | undefined>;
    /**
     * The timestamp when the resource was created.
     * See https://google.aip.dev/148#timestamps.
     */
     ...
     * Structure is documented below.
     */
    locations?: pulumi.Input<pulumi.Input<inputs.networksecurity.MirroringDeploymentGroupLocation>[] | undefined>;
    /**
     * The ID to use for the new deployment group, which will become the final
     * component of the deployment group's resource name.
     */
    mirroringDeploymentGroupId?: pulumi.Input<string | undefined>;
    /**
     * (Output)
     * The connected endpoint group's resource name, for example:
     * `projects/123456789/locations/global/mirroringEndpointGroups/my-eg`.
...
//# sourceMappingURL=mirroringDeploymentGroup.d.ts.map