...
export interface AnalysisRuleState {
     ...
     * upload percentage will be replaced by defining filters on the conversation.
     */
    analysisPercentage?: pulumi.Input<number | undefined>;
    /**
     * Selector of all available annotators and phrase matchers to run.
     * Structure is documented below.
     */
    annotatorSelector?: pulumi.Input<inputs.contactcenterinsights.AnalysisRuleAnnotatorSelector | undefined>;
    /**
     * Filter for the conversations that should apply this analysis
     * rule. An empty filter means this analysis rule applies to all
     * conversations.
...
//# sourceMappingURL=analysisRule.d.ts.map