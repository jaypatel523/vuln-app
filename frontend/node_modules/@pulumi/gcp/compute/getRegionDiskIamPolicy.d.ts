 ...
 * ```
 */
export declare function getRegionDiskIamPolicy(args: GetRegionDiskIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetRegionDiskIamPolicyResult>;
/**
 ...
 */
export interface GetRegionDiskIamPolicyResult {
    /**
 ...
 * ```
 */
export declare function getRegionDiskIamPolicyOutput(args: GetRegionDiskIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRegionDiskIamPolicyResult>;
/**
 * A collection of arguments for invoking getRegionDiskIamPolicy.
 */
export interface GetRegionDiskIamPolicyOutputArgs {
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
...
//# sourceMappingURL=getRegionDiskIamPolicy.d.ts.map