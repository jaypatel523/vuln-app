...
export interface CaExternalAccountKeyState {
     ...
     * @deprecated `b64MacKey` is deprecated and will be removed in a future major release. Use `macKey` instead.
     */
    b64MacKey?: pulumi.Input<string | undefined>;
    /**
     * (Deprecated)
     * Doubly Base64-URL-encoded HS256 key ('base64(base64(binary key))'). It is generated by the PublicCertificateAuthorityService
     * when the ExternalAccountKey is created.'
     ...
     * @deprecated `b64urlMacKey` is deprecated and will be removed in a future major release. Use `macKey` instead.
     */
    b64urlMacKey?: pulumi.Input<string | undefined>;
    /**
     * It is generated by the PublicCertificateAuthorityService when the ExternalAccountKey is created.
     * **Note**: This property is sensitive and will not be displayed in the plan.
     */
     ...
     * **Note**: This property is sensitive and will not be displayed in the plan.
     */
    macKey?: pulumi.Input<string | undefined>;
    /**
     * Resource name. projects/{project}/locations/{location}/externalAccountKeys/{keyId}.
     */
...
//# sourceMappingURL=caExternalAccountKey.d.ts.map