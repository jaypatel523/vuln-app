 ...
 */
export declare class RegionInstantSnapshotIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionInstantSnapshotIamPolicyState, opts?: pulumi.CustomResourceOptions): RegionInstantSnapshotIamPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is RegionInstantSnapshotIamPolicy;
    /**
     ...
     */
    constructor(name: string, args: RegionInstantSnapshotIamPolicyArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering RegionInstantSnapshotIamPolicy resources.
 */
export interface RegionInstantSnapshotIamPolicyState {
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface RegionInstantSnapshotIamPolicyArgs {
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
    name?: pulumi.Input<string | undefined>;
...
//# sourceMappingURL=regionInstantSnapshotIamPolicy.d.ts.map