 ...
 * ```
 */
export declare class RouterNamedSet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RouterNamedSetState, opts?: pulumi.CustomResourceOptions): RouterNamedSet;
    /**
     * Returns true if the given object is an instance of RouterNamedSet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RouterNamedSet;
    /**
     ...
     */
    readonly elements: pulumi.Output<outputs.compute.RouterNamedSetElement[] | undefined>;
    /**
...
//# sourceMappingURL=routerNamedSet.d.ts.map