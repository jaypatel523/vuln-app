 ...
 * ```
 */
export declare function getSnapshotIamPolicy(args: GetSnapshotIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetSnapshotIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getSnapshotIamPolicyOutput(args: GetSnapshotIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSnapshotIamPolicyResult>;
/**
 * A collection of arguments for invoking getSnapshotIamPolicy.
 */
...
//# sourceMappingURL=getSnapshotIamPolicy.d.ts.map