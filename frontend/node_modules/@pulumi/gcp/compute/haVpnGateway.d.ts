...
export interface HaVpnGatewayState {
     ...
     * Possible values are: `IPV4`, `IPV6`.
     */
    gatewayIpVersion?: pulumi.Input<string | undefined>;
    /**
     * A fingerprint for the labels being applied to this VpnGateway, which is essentially a hash
     * of the labels set used for optimistic locking. The fingerprint is initially generated by
     * Compute Engine and changes after every request to modify or update labels.
     ...
     * Structure is documented below.
     */
    params?: pulumi.Input<inputs.compute.HaVpnGatewayParams | undefined>;
    /**
     * The ID of the project in which the resource belongs.
     * If it is not provided, the provider project is used.
     */
     ...
     * Structure is documented below.
     */
    vpnInterfaces?: pulumi.Input<pulumi.Input<inputs.compute.HaVpnGatewayVpnInterface>[] | undefined>;
}
/**
...
//# sourceMappingURL=haVpnGateway.d.ts.map