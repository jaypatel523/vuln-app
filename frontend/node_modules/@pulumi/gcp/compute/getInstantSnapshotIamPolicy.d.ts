 ...
 * ```
 */
export declare function getInstantSnapshotIamPolicy(args: GetInstantSnapshotIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetInstantSnapshotIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getInstantSnapshotIamPolicyOutput(args: GetInstantSnapshotIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstantSnapshotIamPolicyResult>;
/**
 * A collection of arguments for invoking getInstantSnapshotIamPolicy.
 */
...
//# sourceMappingURL=getInstantSnapshotIamPolicy.d.ts.map