...
exports.getBucketObjectContentOutput = exports.getBucketObjectContent = void 0;
 ...
 * ```
 */
function getBucketObjectContent(args, opts) {
...
exports.getBucketObjectContent = getBucketObjectContent;
/**
 * Gets an existing object content inside an existing bucket in Google Cloud Storage service (GCS).
 * See [the official documentation](https://cloud.google.com/storage/docs/key-terms#objects)
 * and
 ...
 * ```
 */
function getBucketObjectContentOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getBucketObjectContentOutput = getBucketObjectContentOutput;
//# sourceMappingURL=getBucketObjectContent.js.map