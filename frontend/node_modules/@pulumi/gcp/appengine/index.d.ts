...
export declare const ApplicationUrlDispatchRules: typeof import("./applicationUrlDispatchRules").ApplicationUrlDispatchRules;
...
export declare const DomainMapping: typeof import("./domainMapping").DomainMapping;
...
export declare const EngineSplitTraffic: typeof import("./engineSplitTraffic").EngineSplitTraffic;
...
export declare const FlexibleAppVersion: typeof import("./flexibleAppVersion").FlexibleAppVersion;
...
export declare const ServiceNetworkSettings: typeof import("./serviceNetworkSettings").ServiceNetworkSettings;
...
export declare const StandardAppVersion: typeof import("./standardAppVersion").StandardAppVersion;
