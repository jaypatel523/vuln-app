 ...
 * ```
 */
export declare class ProjectAutokeyConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectAutokeyConfigState, opts?: pulumi.CustomResourceOptions): ProjectAutokeyConfig;
    /**
     * Returns true if the given object is an instance of ProjectAutokeyConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProjectAutokeyConfig;
    /**
     ...
     */
    readonly keyProjectResolutionMode: pulumi.Output<string | undefined>;
    /**
...
//# sourceMappingURL=projectAutokeyConfig.d.ts.map