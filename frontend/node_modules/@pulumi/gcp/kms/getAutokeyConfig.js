...
exports.getAutokeyConfigOutput = exports.getAutokeyConfig = void 0;
 ...
 * ```
 */
function getAutokeyConfigOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("gcp:kms/getAutokeyConfig:getAutokeyConfig", {
        "folder": args.folder,
    }, opts);
}
exports.getAutokeyConfigOutput = getAutokeyConfigOutput;
//# sourceMappingURL=getAutokeyConfig.js.map