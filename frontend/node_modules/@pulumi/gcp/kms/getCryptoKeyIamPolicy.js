...
exports.getCryptoKeyIamPolicyOutput = exports.getCryptoKeyIamPolicy = void 0;
 ...
 * ```
 */
function getCryptoKeyIamPolicyOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("gcp:kms/getCryptoKeyIamPolicy:getCryptoKeyIamPolicy", {
        "cryptoKeyId": args.cryptoKeyId,
    }, opts);
}
exports.getCryptoKeyIamPolicyOutput = getCryptoKeyIamPolicyOutput;
