...
exports.getGlossaryIamPolicyOutput = exports.getGlossaryIamPolicy = void 0;
 ...
 * ```
 */
function getGlossaryIamPolicy(args, opts) {
...
exports.getGlossaryIamPolicy = getGlossaryIamPolicy;
/**
 * Retrieves the current IAM policy data for glossary
 *
 * ## Example Usage
 ...
 * ```
 */
function getGlossaryIamPolicyOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getGlossaryIamPolicyOutput = getGlossaryIamPolicyOutput;
//# sourceMappingURL=getGlossaryIamPolicy.js.map