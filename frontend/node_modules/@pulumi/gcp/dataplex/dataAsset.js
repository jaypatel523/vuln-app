 ...
 * ```
 */
class DataAsset extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new DataAsset(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'gcp:dataplex/dataAsset:DataAsset';
    /**
