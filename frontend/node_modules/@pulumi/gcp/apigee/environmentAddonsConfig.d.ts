 ...
 * ```
 */
export declare class EnvironmentAddonsConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EnvironmentAddonsConfigState, opts?: pulumi.CustomResourceOptions): EnvironmentAddonsConfig;
    /**
     * Returns true if the given object is an instance of EnvironmentAddonsConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EnvironmentAddonsConfig;
    /**
     * Flag to enable/disable Analytics.
     */
    readonly analyticsEnabled: pulumi.Output<boolean | undefined>;
    /**
...
//# sourceMappingURL=environmentAddonsConfig.d.ts.map