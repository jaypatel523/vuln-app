 ...
 * ```
 */
export declare function getMetastoreDatabaseIamPolicy(args: GetMetastoreDatabaseIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetMetastoreDatabaseIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getMetastoreDatabaseIamPolicyOutput(args: GetMetastoreDatabaseIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMetastoreDatabaseIamPolicyResult>;
/**
 * A collection of arguments for invoking getMetastoreDatabaseIamPolicy.
 */
...
//# sourceMappingURL=getMetastoreDatabaseIamPolicy.d.ts.map