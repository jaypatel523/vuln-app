 ...
 * ```
 */
export declare function getMetastoreFederationIamPolicy(args: GetMetastoreFederationIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetMetastoreFederationIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getMetastoreFederationIamPolicyOutput(args: GetMetastoreFederationIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMetastoreFederationIamPolicyResult>;
/**
 * A collection of arguments for invoking getMetastoreFederationIamPolicy.
 */
...
//# sourceMappingURL=getMetastoreFederationIamPolicy.d.ts.map