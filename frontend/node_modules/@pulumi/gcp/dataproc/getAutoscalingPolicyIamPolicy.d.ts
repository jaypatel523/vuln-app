 ...
 * ```
 */
export declare function getAutoscalingPolicyIamPolicy(args: GetAutoscalingPolicyIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetAutoscalingPolicyIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getAutoscalingPolicyIamPolicyOutput(args: GetAutoscalingPolicyIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutoscalingPolicyIamPolicyResult>;
/**
 * A collection of arguments for invoking getAutoscalingPolicyIamPolicy.
 */
...
//# sourceMappingURL=getAutoscalingPolicyIamPolicy.d.ts.map