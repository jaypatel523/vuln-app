...
export declare const ConsumersIamBinding: typeof import("./consumersIamBinding").ConsumersIamBinding;
...
export declare const ConsumersIamMember: typeof import("./consumersIamMember").ConsumersIamMember;
...
export declare const ConsumersIamPolicy: typeof import("./consumersIamPolicy").ConsumersIamPolicy;
...
export declare const getServiceConsumersIamPolicy: typeof import("./getServiceConsumersIamPolicy").getServiceConsumersIamPolicy;
export declare const getServiceConsumersIamPolicyOutput: typeof import("./getServiceConsumersIamPolicy").getServiceConsumersIamPolicyOutput;
