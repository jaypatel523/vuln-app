 ...
 * ```
 */
export declare function getAttachedInstallManifest(args: GetAttachedInstallManifestArgs, opts?: pulumi.InvokeOptions): Promise<GetAttachedInstallManifestResult>;
/**
 ...
 * ```
 */
export declare function getAttachedInstallManifestOutput(args: GetAttachedInstallManifestOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAttachedInstallManifestResult>;
/**
 * A collection of arguments for invoking getAttachedInstallManifest.
 */
...
//# sourceMappingURL=getAttachedInstallManifest.d.ts.map