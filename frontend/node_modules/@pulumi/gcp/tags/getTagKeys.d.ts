 ...
 * ```
 */
export declare function getTagKeys(args: GetTagKeysArgs, opts?: pulumi.InvokeOptions): Promise<GetTagKeysResult>;
/**
 ...
 * ```
 */
export declare function getTagKeysOutput(args: GetTagKeysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTagKeysResult>;
/**
 * A collection of arguments for invoking getTagKeys.
 */
...
//# sourceMappingURL=getTagKeys.d.ts.map