 ...
 * ```
 */
export declare class StorageDefaultBucket extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StorageDefaultBucketState, opts?: pulumi.CustomResourceOptions): StorageDefaultBucket;
    /**
     * Returns true if the given object is an instance of StorageDefaultBucket.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StorageDefaultBucket;
    /**
     * The resource name of the underlying Google Cloud Storage bucket.
     * Structure is documented below.
     */
    readonly buckets: pulumi.Output<outputs.firebase.StorageDefaultBucketBucket[]>;
    /**
...
//# sourceMappingURL=storageDefaultBucket.d.ts.map