...
exports.PostureDeployment = exports.Posture = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("../utilities"));
exports.Posture = null;
utilities.lazyLoad(exports, ["Posture"], () => require("./posture"));
exports.PostureDeployment = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "gcp:securityposture/posture:Posture":
                return new exports.Posture(name, undefined, { urn });
            case "gcp:securityposture/postureDeployment:PostureDeployment":
                return new exports.PostureDeployment(name, undefined, { urn });
            default:
