 ...
 */
export declare class LocationWebIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocationWebIamPolicyState, opts?: pulumi.CustomResourceOptions): LocationWebIamPolicy;
    /**
     * Returns true if the given object is an instance of LocationWebIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LocationWebIamPolicy;
    /**
     ...
     */
    constructor(name: string, args: LocationWebIamPolicyArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering LocationWebIamPolicy resources.
 */
export interface LocationWebIamPolicyState {
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface LocationWebIamPolicyArgs {
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
...
//# sourceMappingURL=locationWebIamPolicy.d.ts.map