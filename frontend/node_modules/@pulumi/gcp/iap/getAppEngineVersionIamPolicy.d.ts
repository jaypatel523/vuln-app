 ...
 * ```
 */
export declare function getAppEngineVersionIamPolicy(args: GetAppEngineVersionIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetAppEngineVersionIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getAppEngineVersionIamPolicyOutput(args: GetAppEngineVersionIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAppEngineVersionIamPolicyResult>;
/**
 * A collection of arguments for invoking getAppEngineVersionIamPolicy.
 */
...
//# sourceMappingURL=getAppEngineVersionIamPolicy.d.ts.map