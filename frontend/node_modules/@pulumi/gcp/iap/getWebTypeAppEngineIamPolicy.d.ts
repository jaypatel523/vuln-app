 ...
 * ```
 */
export declare function getWebTypeAppEngineIamPolicy(args: GetWebTypeAppEngineIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetWebTypeAppEngineIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getWebTypeAppEngineIamPolicyOutput(args: GetWebTypeAppEngineIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWebTypeAppEngineIamPolicyResult>;
/**
 * A collection of arguments for invoking getWebTypeAppEngineIamPolicy.
 */
...
//# sourceMappingURL=getWebTypeAppEngineIamPolicy.d.ts.map