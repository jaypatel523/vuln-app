...
exports.getDnsAuthorizationOutput = exports.getDnsAuthorization = void 0;
 ...
 * ```
 */
function getDnsAuthorization(args, opts) {
...
exports.getDnsAuthorization = getDnsAuthorization;
/**
 * Use this data source to get information about a Certificate Manager DNS Authorization. For more details, see the [API documentation](https://cloud.google.com/certificate-manager/docs/reference/certificate-manager/rest/v1/projects.locations.dnsAuthorizations).
 *
 * ## Example Usage
 ...
 * ```
 */
function getDnsAuthorizationOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getDnsAuthorizationOutput = getDnsAuthorizationOutput;
//# sourceMappingURL=getDnsAuthorization.js.map