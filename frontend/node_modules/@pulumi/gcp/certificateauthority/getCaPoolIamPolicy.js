...
exports.getCaPoolIamPolicyOutput = exports.getCaPoolIamPolicy = void 0;
 ...
 * ```
 */
function getCaPoolIamPolicy(args, opts) {
...
exports.getCaPoolIamPolicy = getCaPoolIamPolicy;
/**
 * Retrieves the current IAM policy data for capool
 *
 * ## Example Usage
 ...
 * ```
 */
function getCaPoolIamPolicyOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getCaPoolIamPolicyOutput = getCaPoolIamPolicyOutput;
//# sourceMappingURL=getCaPoolIamPolicy.js.map