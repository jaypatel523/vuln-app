 ...
 * ```
 */
export declare function getRegionalParameterVersion(args: GetRegionalParameterVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetRegionalParameterVersionResult>;
/**
 ...
 * ```
 */
export declare function getRegionalParameterVersionOutput(args: GetRegionalParameterVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRegionalParameterVersionResult>;
/**
 * A collection of arguments for invoking getRegionalParameterVersion.
 */
...
//# sourceMappingURL=getRegionalParameterVersion.d.ts.map