...
export declare class TargetIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TargetIamBindingState, opts?: pulumi.CustomResourceOptions): TargetIamBinding;
    /**
     * Returns true if the given object is an instance of TargetIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TargetIamBinding;
    readonly condition: pulumi.Output<outputs.clouddeploy.TargetIamBindingCondition | undefined>;
...
//# sourceMappingURL=targetIamBinding.d.ts.map