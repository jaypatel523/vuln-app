...
export declare const CustomTargetType: typeof import("./customTargetType").CustomTargetType;
...
export declare const CustomTargetTypeIamBinding: typeof import("./customTargetTypeIamBinding").CustomTargetTypeIamBinding;
...
export declare const CustomTargetTypeIamMember: typeof import("./customTargetTypeIamMember").CustomTargetTypeIamMember;
...
export declare const CustomTargetTypeIamPolicy: typeof import("./customTargetTypeIamPolicy").CustomTargetTypeIamPolicy;
...
export declare const DeployPolicy: typeof import("./deployPolicy").DeployPolicy;
...
export declare const getCustomTargetTypeIamPolicy: typeof import("./getCustomTargetTypeIamPolicy").getCustomTargetTypeIamPolicy;
export declare const getCustomTargetTypeIamPolicyOutput: typeof import("./getCustomTargetTypeIamPolicy").getCustomTargetTypeIamPolicyOutput;
...
export declare const getTargetIamPolicy: typeof import("./getTargetIamPolicy").getTargetIamPolicy;
export declare const getTargetIamPolicyOutput: typeof import("./getTargetIamPolicy").getTargetIamPolicyOutput;
...
export declare const TargetIamBinding: typeof import("./targetIamBinding").TargetIamBinding;
...
export declare const TargetIamMember: typeof import("./targetIamMember").TargetIamMember;
...
export declare const TargetIamPolicy: typeof import("./targetIamPolicy").TargetIamPolicy;
