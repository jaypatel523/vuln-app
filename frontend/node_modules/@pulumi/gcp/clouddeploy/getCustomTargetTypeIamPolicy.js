...
exports.getCustomTargetTypeIamPolicyOutput = exports.getCustomTargetTypeIamPolicy = void 0;
 ...
 * ```
 */
function getCustomTargetTypeIamPolicy(args, opts) {
...
exports.getCustomTargetTypeIamPolicy = getCustomTargetTypeIamPolicy;
/**
 * Retrieves the current IAM policy data for customtargettype
 *
 * ## Example Usage
 ...
 * ```
 */
function getCustomTargetTypeIamPolicyOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getCustomTargetTypeIamPolicyOutput = getCustomTargetTypeIamPolicyOutput;
//# sourceMappingURL=getCustomTargetTypeIamPolicy.js.map