...
export declare const getFunctionIamPolicy: typeof import("./getFunctionIamPolicy").getFunctionIamPolicy;
export declare const getFunctionIamPolicyOutput: typeof import("./getFunctionIamPolicy").getFunctionIamPolicyOutput;
export * from "./zMixins";
