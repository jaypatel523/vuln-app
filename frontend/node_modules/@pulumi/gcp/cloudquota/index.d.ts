...
export declare const getSQuotaInfo: typeof import("./getSQuotaInfo").getSQuotaInfo;
export declare const getSQuotaInfoOutput: typeof import("./getSQuotaInfo").getSQuotaInfoOutput;
export { GetSQuotaInfosArgs, GetSQuotaInfosResult, GetSQuotaInfosOutputArgs } from "./getSQuotaInfos";
export declare const getSQuotaInfos: typeof import("./getSQuotaInfos").getSQuotaInfos;
export declare const getSQuotaInfosOutput: typeof import("./getSQuotaInfos").getSQuotaInfosOutput;
...
export declare const SQuotaPreference: typeof import("./squotaPreference").SQuotaPreference;
