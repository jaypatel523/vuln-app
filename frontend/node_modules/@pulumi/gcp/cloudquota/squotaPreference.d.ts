 ...
 * ```
 */
export declare class SQuotaPreference extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SQuotaPreferenceState, opts?: pulumi.CustomResourceOptions): SQuotaPreference;
    /**
     * Returns true if the given object is an instance of SQuotaPreference.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SQuotaPreference;
    /**
     ...
     */
    readonly contactEmail: pulumi.Output<string | undefined>;
    /**
     * Create time stamp.
     ...
     */
    readonly ignoreSafetyChecks: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly quotaConfig: pulumi.Output<outputs.cloudquota.SQuotaPreferenceQuotaConfig>;
    /**
     * The id of the quota to which the quota preference is applied. A quota id is unique in the service.
     * Example: `CPUS-per-project-region`.
     */
    readonly quotaId: pulumi.Output<string>;
    /**
...
export interface SQuotaPreferenceState {
     ...
     * Possible values are: `QUOTA_SAFETY_CHECK_UNSPECIFIED`, `QUOTA_DECREASE_BELOW_USAGE`, `QUOTA_DECREASE_PERCENTAGE_TOO_HIGH`.
     */
    ignoreSafetyChecks?: pulumi.Input<string | undefined>;
    /**
     * The reason / justification for this quota preference.
     */
     ...
     * Structure is documented below.
     */
    quotaConfig?: pulumi.Input<inputs.cloudquota.SQuotaPreferenceQuotaConfig | undefined>;
    /**
     * The id of the quota to which the quota preference is applied. A quota id is unique in the service.
     * Example: `CPUS-per-project-region`.
     */
...
//# sourceMappingURL=squotaPreference.d.ts.map