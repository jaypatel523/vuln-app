 ...
 * ```
 */
export declare function getHl7V2StoreIamPolicy(args: GetHl7V2StoreIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetHl7V2StoreIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getHl7V2StoreIamPolicyOutput(args: GetHl7V2StoreIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHl7V2StoreIamPolicyResult>;
/**
 * A collection of arguments for invoking getHl7V2StoreIamPolicy.
 */
...
//# sourceMappingURL=getHl7V2StoreIamPolicy.d.ts.map