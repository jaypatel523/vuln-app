 ...
 * ```
 */
export declare function getGroupTransitiveMemberships(args: GetGroupTransitiveMembershipsArgs, opts?: pulumi.InvokeOptions): Promise<GetGroupTransitiveMembershipsResult>;
/**
 ...
 * ```
 */
export declare function getGroupTransitiveMembershipsOutput(args: GetGroupTransitiveMembershipsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGroupTransitiveMembershipsResult>;
/**
 * A collection of arguments for invoking getGroupTransitiveMemberships.
 */
...
//# sourceMappingURL=getGroupTransitiveMemberships.d.ts.map