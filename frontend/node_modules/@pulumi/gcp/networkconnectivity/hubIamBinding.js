...
class HubIamBinding extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new HubIamBinding(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'gcp:networkconnectivity/hubIamBinding:HubIamBinding';
    /**
    ...
    static isInstance(obj) {
        ...
        return obj['__pulumiType'] === HubIamBinding.__pulumiType;
    }
    constructor(name, argsOrState, opts) {
        ...
        super(HubIamBinding.__pulumiType, name, resourceInputs, opts);
    }
}
exports.HubIamBinding = HubIamBinding;
//# sourceMappingURL=hubIamBinding.js.map