 ...
 * ```
 */
export declare function getSecurityGatewayApplicationIamPolicy(args: GetSecurityGatewayApplicationIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityGatewayApplicationIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getSecurityGatewayApplicationIamPolicyOutput(args: GetSecurityGatewayApplicationIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityGatewayApplicationIamPolicyResult>;
/**
 * A collection of arguments for invoking getSecurityGatewayApplicationIamPolicy.
 */
...
//# sourceMappingURL=getSecurityGatewayApplicationIamPolicy.d.ts.map