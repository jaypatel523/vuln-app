...
export interface FolderBucketConfigState {
     ...
     * The CMEK settings of the log bucket. If present, new log entries written to this log bucket are encrypted using the CMEK key provided in this configuration. If a log bucket has CMEK settings, the CMEK settings cannot be disabled later by updating the log bucket. Changing the KMS key is allowed.
     */
    cmekSettings?: pulumi.Input<inputs.logging.FolderBucketConfigCmekSettings | undefined>;
    /**
     * Whether Terraform will be prevented from destroying the resource. Defaults to "DELETE".
     * When a 'terraform destroy' or 'pulumi up' would delete the resource,
     * the command will fail if this field is set to "PREVENT" in Terraform state.
     ...
     * A list of indexed fields and related configuration data. Structure is documented below.
     */
    indexConfigs?: pulumi.Input<pulumi.Input<inputs.logging.FolderBucketConfigIndexConfig>[] | undefined>;
    /**
     * The bucket's lifecycle such as active or deleted. See [LifecycleState](https://cloud.google.com/logging/docs/reference/v2/rest/v2/billingAccounts.buckets#LogBucket.LifecycleState).
     */
...
//# sourceMappingURL=folderBucketConfig.d.ts.map