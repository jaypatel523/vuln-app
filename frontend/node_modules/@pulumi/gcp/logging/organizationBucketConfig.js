...
exports.OrganizationBucketConfig = void 0;
...
class OrganizationBucketConfig extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new OrganizationBucketConfig(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'gcp:logging/organizationBucketConfig:OrganizationBucketConfig';
    /**
