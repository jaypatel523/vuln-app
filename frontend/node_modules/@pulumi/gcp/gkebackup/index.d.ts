...
export declare const BackupChannel: typeof import("./backupChannel").BackupChannel;
...
export declare const RestoreChannel: typeof import("./restoreChannel").RestoreChannel;
