 ...
 * ```
 */
export declare function getDockerImages(args: GetDockerImagesArgs, opts?: pulumi.InvokeOptions): Promise<GetDockerImagesResult>;
/**
 ...
 * ```
 */
export declare function getDockerImagesOutput(args: GetDockerImagesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDockerImagesResult>;
/**
 * A collection of arguments for invoking getDockerImages.
 */
...
//# sourceMappingURL=getDockerImages.d.ts.map