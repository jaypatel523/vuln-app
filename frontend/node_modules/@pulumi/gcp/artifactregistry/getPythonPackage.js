...
exports.getPythonPackageOutput = exports.getPythonPackage = void 0;
 ...
 * ```
 */
function getPythonPackage(args, opts) {
...
exports.getPythonPackage = getPythonPackage;
/**
 * This data source fetches information from a provided Artifact Registry repository, based on a the latest version of the package and optional version.
 *
 * ## Example Usage
 ...
 * ```
 */
function getPythonPackageOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getPythonPackageOutput = getPythonPackageOutput;
//# sourceMappingURL=getPythonPackage.js.map