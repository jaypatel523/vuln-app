...
exports.getPackagesOutput = exports.getPackages = void 0;
 ...
 * ```
 */
function getPackages(args, opts) {
 ...
 * ```
 */
function getPackagesOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getPackagesOutput = getPackagesOutput;
