...
export interface OrganizationPolicyState {
     ...
     * A boolean policy is a constraint that is either enforced or not. Structure is documented below.
     */
    booleanPolicy?: pulumi.Input<inputs.projects.OrganizationPolicyBooleanPolicy | undefined>;
    /**
     * The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://docs.cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
     *
     * - - -
     ...
     * A policy that can define specific values that are allowed or denied for the given constraint. It can also be used to allow or deny all values. Structure is documented below.
     */
    listPolicy?: pulumi.Input<inputs.projects.OrganizationPolicyListPolicy | undefined>;
    /**
     * The project id of the project to set the policy for.
     */
     ...
     * effectively be unset. This is represented in the UI as the constraint being 'Inherited'.
     */
    restorePolicy?: pulumi.Input<inputs.projects.OrganizationPolicyRestorePolicy | undefined>;
    /**
     * (Computed) The timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds, representing when the variable was last updated. Example: "2016-10-09T12:33:37.578138407Z".
     */
...
//# sourceMappingURL=organizationPolicy.d.ts.map