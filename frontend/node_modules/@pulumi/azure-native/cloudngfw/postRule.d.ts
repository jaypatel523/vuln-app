 ...
 */
export declare class PostRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PostRule;
    /**
     * Returns true if the given object is an instance of PostRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PostRule;
    /**
     * rule action
     */
...
//# sourceMappingURL=postRule.d.ts.map