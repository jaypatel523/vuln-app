 ...
 */
export declare class PrefixListGlobalRulestack extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrefixListGlobalRulestack;
    /**
     ...
     */
    static isInstance(obj: any): obj is PrefixListGlobalRulestack;
    /**
     ...
     * prefix list
     */
    readonly prefixList: pulumi.Output<string[]>;
    /**
...
//# sourceMappingURL=prefixListGlobalRulestack.d.ts.map