...
export declare class FqdnListGlobalRulestack extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FqdnListGlobalRulestack;
    /**
     * Returns true if the given object is an instance of FqdnListGlobalRulestack.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FqdnListGlobalRulestack;
    /**
     ...
     * fqdn list
     */
    readonly fqdnList: pulumi.Output<string[]>;
    /**
...
//# sourceMappingURL=fqdnListGlobalRulestack.d.ts.map