 ...
 */
export declare function listFeaturesetVersionMaterializationJobs(args: ListFeaturesetVersionMaterializationJobsArgs, opts?: pulumi.InvokeOptions): Promise<ListFeaturesetVersionMaterializationJobsResult>;
...
export interface ListFeaturesetVersionMaterializationJobsResult {
     ...
     */
    readonly value?: outputs.machinelearningservices.FeaturesetJobResponse[];
}
/**
 * A paginated list of FeaturesetJob entities.
 *
 ...
 * Other available API versions: 2023-02-01-preview, 2023-04-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native machinelearningservices [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function listFeaturesetVersionMaterializationJobsOutput(args: ListFeaturesetVersionMaterializationJobsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListFeaturesetVersionMaterializationJobsResult>;
...
//# sourceMappingURL=listFeaturesetVersionMaterializationJobs.d.ts.map