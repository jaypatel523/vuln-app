...
export declare class RegistryModelVersion extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.machinelearningservices.ModelVersionPropertiesResponse>;
    /**
...
export interface RegistryModelVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    properties: pulumi.Input<inputs.machinelearningservices.ModelVersionPropertiesArgs>;
    /**
...
//# sourceMappingURL=registryModelVersion.d.ts.map