 ...
 */
export declare class InferenceEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InferenceEndpoint;
    /**
     * Returns true if the given object is an instance of InferenceEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InferenceEndpoint;
    /**
     ...
     */
    readonly inferenceEndpointProperties: pulumi.Output<outputs.machinelearningservices.InferenceEndpointResponse>;
    /**
...
export interface InferenceEndpointArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    inferenceEndpointProperties: pulumi.Input<inputs.machinelearningservices.InferenceEndpointArgs>;
    /**
     * Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type.
     */
...
//# sourceMappingURL=inferenceEndpoint.d.ts.map