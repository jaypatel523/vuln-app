 ...
 */
export declare function getInferenceGroupDeltaModelsStatusAsync(args: GetInferenceGroupDeltaModelsStatusAsyncArgs, opts?: pulumi.InvokeOptions): Promise<GetInferenceGroupDeltaModelsStatusAsyncResult>;
...
export interface GetInferenceGroupDeltaModelsStatusAsyncResult {
     ...
     */
    readonly deltaModels?: {
        [key: string]: outputs.machinelearningservices.DeltaModelCurrentStateResponse[];
    };
    /**
 ...
 * Other available API versions: 2024-10-01-preview, 2025-04-01-preview, 2025-07-01-preview, 2025-10-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native machinelearningservices [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getInferenceGroupDeltaModelsStatusAsyncOutput(args: GetInferenceGroupDeltaModelsStatusAsyncOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInferenceGroupDeltaModelsStatusAsyncResult>;
...
//# sourceMappingURL=getInferenceGroupDeltaModelsStatusAsync.d.ts.map