 ...
 */
export declare class RegistryComponentContainer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RegistryComponentContainer;
    /**
     ...
     */
    static isInstance(obj: any): obj is RegistryComponentContainer;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.machinelearningservices.ComponentContainerPropertiesResponse>;
    /**
...
//# sourceMappingURL=registryComponentContainer.d.ts.map