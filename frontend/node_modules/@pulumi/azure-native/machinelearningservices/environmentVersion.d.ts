 ...
 */
export declare class EnvironmentVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnvironmentVersion;
    /**
     * Returns true if the given object is an instance of EnvironmentVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EnvironmentVersion;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.machinelearningservices.EnvironmentVersionPropertiesResponse>;
    /**
...
export interface EnvironmentVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    properties: pulumi.Input<inputs.machinelearningservices.EnvironmentVersionPropertiesArgs>;
    /**
...
//# sourceMappingURL=environmentVersion.d.ts.map