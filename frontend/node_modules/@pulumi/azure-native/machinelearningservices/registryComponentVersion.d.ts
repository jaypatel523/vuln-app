 ...
 */
export declare class RegistryComponentVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RegistryComponentVersion;
    /**
     * Returns true if the given object is an instance of RegistryComponentVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegistryComponentVersion;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.machinelearningservices.ComponentVersionPropertiesResponse>;
    /**
...
export interface RegistryComponentVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    properties: pulumi.Input<inputs.machinelearningservices.ComponentVersionPropertiesArgs>;
    /**
...
//# sourceMappingURL=registryComponentVersion.d.ts.map