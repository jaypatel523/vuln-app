 ...
 */
export declare class EndpointDeployment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EndpointDeployment;
    /**
     * Returns true if the given object is an instance of EndpointDeployment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EndpointDeployment;
    /**
...
//# sourceMappingURL=endpointDeployment.d.ts.map