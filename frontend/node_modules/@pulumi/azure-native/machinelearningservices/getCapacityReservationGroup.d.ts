...
export interface GetCapacityReservationGroupResult {
     ...
     */
    readonly capacityReservationGroupProperties: outputs.machinelearningservices.CapacityReservationGroupResponse;
    /**
 ...
 * Other available API versions: 2023-08-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native machinelearningservices [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getCapacityReservationGroupOutput(args: GetCapacityReservationGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCapacityReservationGroupResult>;
...
//# sourceMappingURL=getCapacityReservationGroup.d.ts.map