 ...
 */
export declare class RegistryDataVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RegistryDataVersion;
    /**
     * Returns true if the given object is an instance of RegistryDataVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegistryDataVersion;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.machinelearningservices.MLTableDataResponse | outputs.machinelearningservices.UriFileDataVersionResponse | outputs.machinelearningservices.UriFolderDataVersionResponse>;
    /**
...
export interface RegistryDataVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    properties: pulumi.Input<inputs.machinelearningservices.MLTableDataArgs | inputs.machinelearningservices.UriFileDataVersionArgs | inputs.machinelearningservices.UriFolderDataVersionArgs>;
    /**
...
//# sourceMappingURL=registryDataVersion.d.ts.map