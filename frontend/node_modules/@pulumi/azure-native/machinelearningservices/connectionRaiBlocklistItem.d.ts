 ...
 */
export declare class ConnectionRaiBlocklistItem extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectionRaiBlocklistItem;
    /**
     ...
     */
    static isInstance(obj: any): obj is ConnectionRaiBlocklistItem;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.machinelearningservices.RaiBlocklistItemPropertiesResponse>;
    /**
...
//# sourceMappingURL=connectionRaiBlocklistItem.d.ts.map