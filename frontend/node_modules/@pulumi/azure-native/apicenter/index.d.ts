...
export declare const ApiDefinition: typeof import("./apiDefinition").ApiDefinition;
export { ApiSourceArgs } from "./apiSource";
export type ApiSource = import("./apiSource").ApiSource;
export declare const ApiSource: typeof import("./apiSource").ApiSource;
...
export declare const getApiDefinition: typeof import("./getApiDefinition").getApiDefinition;
export declare const getApiDefinitionOutput: typeof import("./getApiDefinition").getApiDefinitionOutput;
export { GetApiSourceArgs, GetApiSourceResult, GetApiSourceOutputArgs } from "./getApiSource";
export declare const getApiSource: typeof import("./getApiSource").getApiSource;
export declare const getApiSourceOutput: typeof import("./getApiSource").getApiSourceOutput;
export { GetApiVersionArgs, GetApiVersionResult, GetApiVersionOutputArgs } from "./getApiVersion";
export declare const getApiVersion: typeof import("./getApiVersion").getApiVersion;
export declare const getApiVersionOutput: typeof import("./getApiVersion").getApiVersionOutput;
...
export declare const getMetadataSchema: typeof import("./getMetadataSchema").getMetadataSchema;
export declare const getMetadataSchemaOutput: typeof import("./getMetadataSchema").getMetadataSchemaOutput;
...
export declare const MetadataSchema: typeof import("./metadataSchema").MetadataSchema;
