 ...
 */
export declare function getApiDefinition(args: GetApiDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetApiDefinitionResult>;
...
export interface GetApiDefinitionResult {
     ...
     */
    readonly specification: outputs.apicenter.ApiDefinitionPropertiesSpecificationResponse;
    /**
 ...
 * Other available API versions: 2024-03-01, 2024-06-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native apicenter [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getApiDefinitionOutput(args: GetApiDefinitionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApiDefinitionResult>;
...
//# sourceMappingURL=getApiDefinition.d.ts.map