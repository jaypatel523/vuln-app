 ...
 */
export declare class MetadataSchema extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MetadataSchema;
    /**
     * Returns true if the given object is an instance of MetadataSchema.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MetadataSchema;
    /**
     * The assignees
     */
    readonly assignedTo: pulumi.Output<outputs.apicenter.MetadataAssignmentResponse[] | undefined>;
    /**
