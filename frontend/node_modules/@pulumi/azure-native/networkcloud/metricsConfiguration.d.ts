 ...
 */
export declare class MetricsConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MetricsConfiguration;
    /**
     * Returns true if the given object is an instance of MetricsConfiguration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MetricsConfiguration;
    /**
     ...
     */
    readonly collectionInterval: pulumi.Output<number>;
    /**
     ...
     */
    readonly disabledMetrics: pulumi.Output<string[]>;
    /**
     * The list of metric names that have been chosen to be enabled in addition to the core set of enabled metrics.
     */
    readonly enabledMetrics: pulumi.Output<string[] | undefined>;
    /**
     * Resource ETag.
     */
