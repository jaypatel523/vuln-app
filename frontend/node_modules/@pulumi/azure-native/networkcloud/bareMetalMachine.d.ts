 ...
 */
export declare class BareMetalMachine extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BareMetalMachine;
    /**
     * Returns true if the given object is an instance of BareMetalMachine.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BareMetalMachine;
    /**
     * The list of resource IDs for the other Microsoft.NetworkCloud resources that have attached this network.
     */
    readonly associatedResourceIds: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly bmcConnectionString: pulumi.Output<string>;
    /**
     * The credentials of the baseboard management controller on this bare metal machine.
     */
    readonly bmcCredentials: pulumi.Output<outputs.networkcloud.AdministrativeCredentialsResponse>;
    /**
     * The MAC address of the BMC device.
     */
    readonly bmcMacAddress: pulumi.Output<string>;
    /**
     * The MAC address of a NIC connected to the PXE network.
     */
    readonly bootMacAddress: pulumi.Output<string>;
    /**
     ...
     */
    readonly cordonStatus: pulumi.Output<string>;
    /**
     ...
     */
    readonly hardwareInventory: pulumi.Output<outputs.networkcloud.HardwareInventoryResponse>;
    /**
     * The details of the latest hardware validation performed for this bare metal machine.
     */
    readonly hardwareValidationStatus: pulumi.Output<outputs.networkcloud.HardwareValidationStatusResponse>;
    /**
     * Field Deprecated. These fields will be empty/omitted. The list of the resource IDs for the HybridAksClusters that have nodes hosted on this bare metal machine.
     */
    readonly hybridAksClustersAssociatedIds: pulumi.Output<string[]>;
    /**
     * The name of this machine represented by the host object in the Cluster's Kubernetes control plane.
     */
    readonly kubernetesNodeName: pulumi.Output<string>;
    /**
     ...
     */
    readonly machineClusterVersion: pulumi.Output<string | undefined>;
    /**
     * The custom details provided by the customer.
     */
    readonly machineDetails: pulumi.Output<string>;
    /**
     ...
     */
    readonly machineRoles: pulumi.Output<string[]>;
    /**
     * The unique internal identifier of the bare metal machine SKU.
     */
    readonly machineSkuId: pulumi.Output<string>;
    /**
     ...
     */
    readonly readyState: pulumi.Output<string>;
    /**
     * The runtime protection status of the bare metal machine.
     */
    readonly runtimeProtectionStatus: pulumi.Output<outputs.networkcloud.RuntimeProtectionStatusResponse>;
    /**
     ...
     */
    readonly virtualMachinesAssociatedIds: pulumi.Output<string[]>;
    /**
...
//# sourceMappingURL=bareMetalMachine.d.ts.map