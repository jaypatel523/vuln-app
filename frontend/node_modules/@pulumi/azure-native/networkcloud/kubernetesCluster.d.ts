...
export declare class KubernetesCluster extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KubernetesCluster;
    /**
     ...
     */
    readonly aadConfiguration: pulumi.Output<outputs.networkcloud.AadConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly administratorConfiguration: pulumi.Output<outputs.networkcloud.AdministratorConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly attachedNetworkIds: pulumi.Output<string[]>;
    /**
     * The list of versions that this Kubernetes cluster can be upgraded to.
     */
    readonly availableUpgrades: pulumi.Output<outputs.networkcloud.AvailableUpgradeResponse[]>;
    /**
     ...
     */
    readonly connectedClusterId: pulumi.Output<string>;
    /**
     * The current running version of Kubernetes on the control plane.
     */
    readonly controlPlaneKubernetesVersion: pulumi.Output<string>;
    /**
     * The defining characteristics of the control plane for this Kubernetes Cluster.
     */
    readonly controlPlaneNodeConfiguration: pulumi.Output<outputs.networkcloud.ControlPlaneNodeConfigurationResponse>;
    /**
     ...
     */
    readonly featureStatuses: pulumi.Output<outputs.networkcloud.FeatureStatusResponse[]>;
    /**
     * The agent pools that are created with this Kubernetes cluster for running critical system services and workloads. This data in this field is only used during creation, and the field will be empty following the creation of the Kubernetes Cluster. After creation, the management of agent pools is done using the agentPools sub-resource.
     */
    readonly initialAgentPoolConfigurations: pulumi.Output<outputs.networkcloud.InitialAgentPoolConfigurationResponse[]>;
    /**
     ...
     */
    readonly networkConfiguration: pulumi.Output<outputs.networkcloud.NetworkConfigurationResponse>;
    /**
     * The details of the nodes in this cluster.
     */
    readonly nodes: pulumi.Output<outputs.networkcloud.KubernetesClusterNodeResponse[]>;
    /**
