...
export declare class Cluster extends pulumi.CustomResource {
     ...
     */
    readonly aggregatorOrSingleRackDefinition: pulumi.Output<outputs.networkcloud.RackDefinitionResponse>;
    /**
     * The settings for the log analytics workspace used for output of logs from this cluster.
     */
    readonly analyticsOutputSettings: pulumi.Output<outputs.networkcloud.AnalyticsOutputSettingsResponse | undefined>;
    /**
     ...
     */
    readonly availableUpgradeVersions: pulumi.Output<outputs.networkcloud.ClusterAvailableUpgradeVersionResponse[]>;
    /**
     ...
     */
    readonly clusterCapacity: pulumi.Output<outputs.networkcloud.ClusterCapacityResponse>;
    /**
     ...
     */
    readonly clusterExtendedLocation: pulumi.Output<outputs.networkcloud.ExtendedLocationResponse>;
    /**
     ...
     */
    readonly clusterServicePrincipal: pulumi.Output<outputs.networkcloud.ServicePrincipalInformationResponse | undefined>;
    /**
     ...
     */
    readonly commandOutputSettings: pulumi.Output<outputs.networkcloud.CommandOutputSettingsResponse | undefined>;
    /**
     * The validation threshold indicating the allowable failures of compute machines during environment validation and deployment.
     */
    readonly computeDeploymentThreshold: pulumi.Output<outputs.networkcloud.ValidationThresholdResponse | undefined>;
    /**
     * The list of rack definitions for the compute racks in a multi-rack
     * cluster, or an empty list in a single-rack cluster.
     */
    readonly computeRackDefinitions: pulumi.Output<outputs.networkcloud.RackDefinitionResponse[] | undefined>;
    /**
     ...
     */
    readonly hybridAksExtendedLocation: pulumi.Output<outputs.networkcloud.ExtendedLocationResponse>;
    /**
     * The identity for the resource.
     */
    readonly identity: pulumi.Output<outputs.networkcloud.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly managedResourceGroupConfiguration: pulumi.Output<outputs.networkcloud.ManagedResourceGroupConfigurationResponse | undefined>;
    /**
     ...
     */
    readonly runtimeProtectionConfiguration: pulumi.Output<outputs.networkcloud.RuntimeProtectionConfigurationResponse | undefined>;
    /**
     * The configuration for use of a key vault to store secrets for later retrieval by the operator.
     */
    readonly secretArchive: pulumi.Output<outputs.networkcloud.ClusterSecretArchiveResponse | undefined>;
    /**
     * The settings for the secret archive used to hold credentials for the cluster.
     */
    readonly secretArchiveSettings: pulumi.Output<outputs.networkcloud.SecretArchiveSettingsResponse | undefined>;
    /**
     ...
     */
    readonly updateStrategy: pulumi.Output<outputs.networkcloud.ClusterUpdateStrategyResponse | undefined>;
    /**
     * The settings for how security vulnerability scanning is applied to the cluster.
     */
    readonly vulnerabilityScanningSettings: pulumi.Output<outputs.networkcloud.VulnerabilityScanningSettingsResponse | undefined>;
    /**
