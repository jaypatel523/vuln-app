...
export declare class Authority extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Authority;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.verifiedid.SystemDataResponse>;
    /**
     * Resource tags.
     */
