 ...
 */
export declare class PrivateAccess extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrivateAccess;
    /**
     * Returns true if the given object is an instance of PrivateAccess.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PrivateAccess;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.chaos.PrivateEndpointConnectionResponse[]>;
    /**
...
//# sourceMappingURL=privateAccess.d.ts.map