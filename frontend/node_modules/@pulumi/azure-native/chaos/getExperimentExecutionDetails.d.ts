 ...
 */
export declare function getExperimentExecutionDetails(args: GetExperimentExecutionDetailsArgs, opts?: pulumi.InvokeOptions): Promise<GetExperimentExecutionDetailsResult>;
...
export interface GetExperimentExecutionDetailsResult {
     ...
     */
    readonly runInformation: outputs.chaos.ExperimentExecutionDetailsPropertiesResponseRunInformation;
    /**
 ...
 * Other available API versions: 2023-11-01, 2024-01-01, 2024-11-01-preview, 2025-01-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native chaos [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getExperimentExecutionDetailsOutput(args: GetExperimentExecutionDetailsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExperimentExecutionDetailsResult>;
...
//# sourceMappingURL=getExperimentExecutionDetails.d.ts.map