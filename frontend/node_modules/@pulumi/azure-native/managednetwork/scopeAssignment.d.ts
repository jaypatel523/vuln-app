 ...
 */
export declare class ScopeAssignment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ScopeAssignment;
    /**
     * Returns true if the given object is an instance of ScopeAssignment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ScopeAssignment;
    /**
     * The managed network ID with scope will be assigned to.
     */
    readonly assignedManagedNetwork: pulumi.Output<string | undefined>;
    /**
...
//# sourceMappingURL=scopeAssignment.d.ts.map