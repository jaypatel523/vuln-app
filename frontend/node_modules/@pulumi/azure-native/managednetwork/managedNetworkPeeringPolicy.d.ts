 ...
 */
export declare class ManagedNetworkPeeringPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedNetworkPeeringPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedNetworkPeeringPolicy;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.managednetwork.ManagedNetworkPeeringPolicyPropertiesResponse>;
    /**
...
//# sourceMappingURL=managedNetworkPeeringPolicy.d.ts.map