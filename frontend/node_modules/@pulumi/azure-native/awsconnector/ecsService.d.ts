 ...
 */
export declare class EcsService extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EcsService;
    /**
     * Returns true if the given object is an instance of EcsService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EcsService;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.awsconnector.EcsServicePropertiesResponse>;
    /**
