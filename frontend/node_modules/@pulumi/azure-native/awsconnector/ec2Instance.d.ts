 ...
 */
export declare class Ec2Instance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ec2Instance;
    /**
     * Returns true if the given object is an instance of Ec2Instance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Ec2Instance;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.awsconnector.Ec2InstancePropertiesResponse>;
    /**
