...
export declare const getS3ControlMultiRegionAccessPointPolicyDocument: typeof import("./getS3ControlMultiRegionAccessPointPolicyDocument").getS3ControlMultiRegionAccessPointPolicyDocument;
export declare const getS3ControlMultiRegionAccessPointPolicyDocumentOutput: typeof import("./getS3ControlMultiRegionAccessPointPolicyDocument").getS3ControlMultiRegionAccessPointPolicyDocumentOutput;
export { GetSageMakerAppArgs, GetSageMakerAppResult, GetSageMakerAppOutputArgs } from "./getSageMakerApp";
export declare const getSageMakerApp: typeof import("./getSageMakerApp").getSageMakerApp;
export declare const getSageMakerAppOutput: typeof import("./getSageMakerApp").getSageMakerAppOutput;
...
export declare const getSageMakerNotebookInstanceSummary: typeof import("./getSageMakerNotebookInstanceSummary").getSageMakerNotebookInstanceSummary;
export declare const getSageMakerNotebookInstanceSummaryOutput: typeof import("./getSageMakerNotebookInstanceSummary").getSageMakerNotebookInstanceSummaryOutput;
...
export declare const getSecretsManagerResourcePolicy: typeof import("./getSecretsManagerResourcePolicy").getSecretsManagerResourcePolicy;
export declare const getSecretsManagerResourcePolicyOutput: typeof import("./getSecretsManagerResourcePolicy").getSecretsManagerResourcePolicyOutput;
...
export declare const getSecretsManagerSecret: typeof import("./getSecretsManagerSecret").getSecretsManagerSecret;
export declare const getSecretsManagerSecretOutput: typeof import("./getSecretsManagerSecret").getSecretsManagerSecretOutput;
export { GetSnsSubscriptionArgs, GetSnsSubscriptionResult, GetSnsSubscriptionOutputArgs } from "./getSnsSubscription";
export declare const getSnsSubscription: typeof import("./getSnsSubscription").getSnsSubscription;
export declare const getSnsSubscriptionOutput: typeof import("./getSnsSubscription").getSnsSubscriptionOutput;
export { GetSnsTopicArgs, GetSnsTopicResult, GetSnsTopicOutputArgs } from "./getSnsTopic";
export declare const getSnsTopic: typeof import("./getSnsTopic").getSnsTopic;
export declare const getSnsTopicOutput: typeof import("./getSnsTopic").getSnsTopicOutput;
export { GetSqsQueueArgs, GetSqsQueueResult, GetSqsQueueOutputArgs } from "./getSqsQueue";
export declare const getSqsQueue: typeof import("./getSqsQueue").getSqsQueue;
export declare const getSqsQueueOutput: typeof import("./getSqsQueue").getSqsQueueOutput;
...
export declare const getSsmInstanceInformation: typeof import("./getSsmInstanceInformation").getSsmInstanceInformation;
export declare const getSsmInstanceInformationOutput: typeof import("./getSsmInstanceInformation").getSsmInstanceInformationOutput;
export { GetSsmParameterArgs, GetSsmParameterResult, GetSsmParameterOutputArgs } from "./getSsmParameter";
export declare const getSsmParameter: typeof import("./getSsmParameter").getSsmParameter;
export declare const getSsmParameterOutput: typeof import("./getSsmParameter").getSsmParameterOutput;
...
export declare const getSsmResourceComplianceSummaryItem: typeof import("./getSsmResourceComplianceSummaryItem").getSsmResourceComplianceSummaryItem;
export declare const getSsmResourceComplianceSummaryItemOutput: typeof import("./getSsmResourceComplianceSummaryItem").getSsmResourceComplianceSummaryItemOutput;
export { GetWafWebAclSummaryArgs, GetWafWebAclSummaryResult, GetWafWebAclSummaryOutputArgs } from "./getWafWebAclSummary";
export declare const getWafWebAclSummary: typeof import("./getWafWebAclSummary").getWafWebAclSummary;
export declare const getWafWebAclSummaryOutput: typeof import("./getWafWebAclSummary").getWafWebAclSummaryOutput;
...
export declare const getWafv2LoggingConfiguration: typeof import("./getWafv2LoggingConfiguration").getWafv2LoggingConfiguration;
export declare const getWafv2LoggingConfigurationOutput: typeof import("./getWafv2LoggingConfiguration").getWafv2LoggingConfigurationOutput;
...
export declare const GuardDutyDetector: typeof import("./guardDutyDetector").GuardDutyDetector;
...
export declare const IamAccessKeyLastUsed: typeof import("./iamAccessKeyLastUsed").IamAccessKeyLastUsed;
...
export declare const IamAccessKeyMetadataInfo: typeof import("./iamAccessKeyMetadataInfo").IamAccessKeyMetadataInfo;
...
export declare const IamInstanceProfile: typeof import("./iamInstanceProfile").IamInstanceProfile;
export { IamMfaDeviceArgs } from "./iamMfaDevice";
export type IamMfaDevice = import("./iamMfaDevice").IamMfaDevice;
export declare const IamMfaDevice: typeof import("./iamMfaDevice").IamMfaDevice;
...
export declare const IamPasswordPolicy: typeof import("./iamPasswordPolicy").IamPasswordPolicy;
export { IamPolicyVersionArgs } from "./iamPolicyVersion";
export type IamPolicyVersion = import("./iamPolicyVersion").IamPolicyVersion;
export declare const IamPolicyVersion: typeof import("./iamPolicyVersion").IamPolicyVersion;
export { IamRoleArgs } from "./iamRole";
export type IamRole = import("./iamRole").IamRole;
export declare const IamRole: typeof import("./iamRole").IamRole;
...
export declare const IamServerCertificate: typeof import("./iamServerCertificate").IamServerCertificate;
...
export declare const IamVirtualMfaDevice: typeof import("./iamVirtualMfaDevice").IamVirtualMfaDevice;
export { KmsAliasArgs } from "./kmsAlias";
export type KmsAlias = import("./kmsAlias").KmsAlias;
export declare const KmsAlias: typeof import("./kmsAlias").KmsAlias;
export { KmsKeyArgs } from "./kmsKey";
export type KmsKey = import("./kmsKey").KmsKey;
export declare const KmsKey: typeof import("./kmsKey").KmsKey;
export { LambdaFunctionArgs } from "./lambdaFunction";
export type LambdaFunction = import("./lambdaFunction").LambdaFunction;
export declare const LambdaFunction: typeof import("./lambdaFunction").LambdaFunction;
...
export declare const LambdaFunctionCodeLocation: typeof import("./lambdaFunctionCodeLocation").LambdaFunctionCodeLocation;
export { LightsailBucketArgs } from "./lightsailBucket";
export type LightsailBucket = import("./lightsailBucket").LightsailBucket;
export declare const LightsailBucket: typeof import("./lightsailBucket").LightsailBucket;
...
export declare const LightsailInstance: typeof import("./lightsailInstance").LightsailInstance;
export { LogsLogGroupArgs } from "./logsLogGroup";
export type LogsLogGroup = import("./logsLogGroup").LogsLogGroup;
export declare const LogsLogGroup: typeof import("./logsLogGroup").LogsLogGroup;
export { LogsLogStreamArgs } from "./logsLogStream";
export type LogsLogStream = import("./logsLogStream").LogsLogStream;
export declare const LogsLogStream: typeof import("./logsLogStream").LogsLogStream;
export { LogsMetricFilterArgs } from "./logsMetricFilter";
export type LogsMetricFilter = import("./logsMetricFilter").LogsMetricFilter;
export declare const LogsMetricFilter: typeof import("./logsMetricFilter").LogsMetricFilter;
...
export declare const LogsSubscriptionFilter: typeof import("./logsSubscriptionFilter").LogsSubscriptionFilter;
export { Macie2JobSummaryArgs } from "./macie2JobSummary";
export type Macie2JobSummary = import("./macie2JobSummary").Macie2JobSummary;
export declare const Macie2JobSummary: typeof import("./macie2JobSummary").Macie2JobSummary;
export { MacieAllowListArgs } from "./macieAllowList";
export type MacieAllowList = import("./macieAllowList").MacieAllowList;
export declare const MacieAllowList: typeof import("./macieAllowList").MacieAllowList;
...
export declare const NetworkFirewallFirewall: typeof import("./networkFirewallFirewall").NetworkFirewallFirewall;
...
export declare const NetworkFirewallFirewallPolicy: typeof import("./networkFirewallFirewallPolicy").NetworkFirewallFirewallPolicy;
...
export declare const NetworkFirewallRuleGroup: typeof import("./networkFirewallRuleGroup").NetworkFirewallRuleGroup;
...
export declare const OpenSearchDomainStatus: typeof import("./openSearchDomainStatus").OpenSearchDomainStatus;
...
export declare const OrganizationsAccount: typeof import("./organizationsAccount").OrganizationsAccount;
...
export declare const OrganizationsOrganization: typeof import("./organizationsOrganization").OrganizationsOrganization;
export { RdsDbClusterArgs } from "./rdsDbCluster";
export type RdsDbCluster = import("./rdsDbCluster").RdsDbCluster;
export declare const RdsDbCluster: typeof import("./rdsDbCluster").RdsDbCluster;
...
export declare const RdsDbSnapshot: typeof import("./rdsDbSnapshot").RdsDbSnapshot;
...
export declare const RdsDbSnapshotAttributesResult: typeof import("./rdsDbSnapshotAttributesResult").RdsDbSnapshotAttributesResult;
...
export declare const RdsEventSubscription: typeof import("./rdsEventSubscription").RdsEventSubscription;
export { RdsExportTaskArgs } from "./rdsExportTask";
export type RdsExportTask = import("./rdsExportTask").RdsExportTask;
export declare const RdsExportTask: typeof import("./rdsExportTask").RdsExportTask;
export { RedshiftClusterArgs } from "./redshiftCluster";
export type RedshiftCluster = import("./redshiftCluster").RedshiftCluster;
export declare const RedshiftCluster: typeof import("./redshiftCluster").RedshiftCluster;
...
export declare const RedshiftClusterParameterGroup: typeof import("./redshiftClusterParameterGroup").RedshiftClusterParameterGroup;
...
export declare const Route53DomainsDomainSummary: typeof import("./route53DomainsDomainSummary").Route53DomainsDomainSummary;
...
export declare const Route53HostedZone: typeof import("./route53HostedZone").Route53HostedZone;
...
export declare const Route53ResourceRecordSet: typeof import("./route53ResourceRecordSet").Route53ResourceRecordSet;
...
export declare const S3AccessControlPolicy: typeof import("./s3accessControlPolicy").S3AccessControlPolicy;
export { S3AccessPointArgs } from "./s3accessPoint";
export type S3AccessPoint = import("./s3accessPoint").S3AccessPoint;
export declare const S3AccessPoint: typeof import("./s3accessPoint").S3AccessPoint;
export { S3BucketArgs } from "./s3bucket";
export type S3Bucket = import("./s3bucket").S3Bucket;
export declare const S3Bucket: typeof import("./s3bucket").S3Bucket;
export { S3BucketPolicyArgs } from "./s3bucketPolicy";
export type S3BucketPolicy = import("./s3bucketPolicy").S3BucketPolicy;
export declare const S3BucketPolicy: typeof import("./s3bucketPolicy").S3BucketPolicy;
...
export declare const S3ControlMultiRegionAccessPointPolicyDocument: typeof import("./s3controlMultiRegionAccessPointPolicyDocument").S3ControlMultiRegionAccessPointPolicyDocument;
export { SageMakerAppArgs } from "./sageMakerApp";
export type SageMakerApp = import("./sageMakerApp").SageMakerApp;
export declare const SageMakerApp: typeof import("./sageMakerApp").SageMakerApp;
...
export declare const SageMakerNotebookInstanceSummary: typeof import("./sageMakerNotebookInstanceSummary").SageMakerNotebookInstanceSummary;
...
export declare const SecretsManagerResourcePolicy: typeof import("./secretsManagerResourcePolicy").SecretsManagerResourcePolicy;
...
export declare const SecretsManagerSecret: typeof import("./secretsManagerSecret").SecretsManagerSecret;
export { SnsSubscriptionArgs } from "./snsSubscription";
export type SnsSubscription = import("./snsSubscription").SnsSubscription;
export declare const SnsSubscription: typeof import("./snsSubscription").SnsSubscription;
...
export declare const SsmInstanceInformation: typeof import("./ssmInstanceInformation").SsmInstanceInformation;
export { SsmParameterArgs } from "./ssmParameter";
export type SsmParameter = import("./ssmParameter").SsmParameter;
export declare const SsmParameter: typeof import("./ssmParameter").SsmParameter;
...
export declare const SsmResourceComplianceSummaryItem: typeof import("./ssmResourceComplianceSummaryItem").SsmResourceComplianceSummaryItem;
export { WafWebAclSummaryArgs } from "./wafWebAclSummary";
export type WafWebAclSummary = import("./wafWebAclSummary").WafWebAclSummary;
export declare const WafWebAclSummary: typeof import("./wafWebAclSummary").WafWebAclSummary;
...
export declare const Wafv2LoggingConfiguration: typeof import("./wafv2LoggingConfiguration").Wafv2LoggingConfiguration;
