...
export declare class EksCluster extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EksCluster;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.awsconnector.EksClusterPropertiesResponse>;
    /**
