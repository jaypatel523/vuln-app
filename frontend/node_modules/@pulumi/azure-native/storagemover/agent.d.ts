...
export declare class Agent extends pulumi.CustomResource {
    ...
    readonly errorDetails: pulumi.Output<outputs.storagemover.AgentPropertiesErrorDetailsResponse>;
    /**
     ...
     */
    readonly uploadLimitSchedule: pulumi.Output<outputs.storagemover.UploadLimitScheduleResponse | undefined>;
    /**
