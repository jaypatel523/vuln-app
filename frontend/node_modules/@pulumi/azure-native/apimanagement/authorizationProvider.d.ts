 ...
 */
export declare class AuthorizationProvider extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AuthorizationProvider;
    /**
     * Returns true if the given object is an instance of AuthorizationProvider.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AuthorizationProvider;
    /**
     ...
     * OAuth2 settings
     */
    readonly oauth2: pulumi.Output<outputs.apimanagement.AuthorizationProviderOAuth2SettingsResponse | undefined>;
    /**
