 ...
 */
export declare class ProductGroupLink extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProductGroupLink;
    /**
     * Returns true if the given object is an instance of ProductGroupLink.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProductGroupLink;
    /**
...
//# sourceMappingURL=productGroupLink.d.ts.map