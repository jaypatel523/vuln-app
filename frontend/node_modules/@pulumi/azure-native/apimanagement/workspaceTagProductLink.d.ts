 ...
 */
export declare class WorkspaceTagProductLink extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceTagProductLink;
    /**
     * Returns true if the given object is an instance of WorkspaceTagProductLink.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkspaceTagProductLink;
    /**
...
//# sourceMappingURL=workspaceTagProductLink.d.ts.map