 ...
 */
export declare class WorkspaceGroupUser extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceGroupUser;
    /**
     * Returns true if the given object is an instance of WorkspaceGroupUser.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkspaceGroupUser;
    /**
     ...
     */
    readonly groups: pulumi.Output<outputs.apimanagement.GroupContractPropertiesResponse[]>;
    /**
     * Collection of user identities.
     */
    readonly identities: pulumi.Output<outputs.apimanagement.UserIdentityContractResponse[] | undefined>;
    /**
     * Last name.
     */
...
//# sourceMappingURL=workspaceGroupUser.d.ts.map