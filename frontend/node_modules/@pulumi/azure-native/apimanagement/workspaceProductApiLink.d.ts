 ...
 */
export declare class WorkspaceProductApiLink extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceProductApiLink;
    /**
     * Returns true if the given object is an instance of WorkspaceProductApiLink.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkspaceProductApiLink;
    /**
...
//# sourceMappingURL=workspaceProductApiLink.d.ts.map