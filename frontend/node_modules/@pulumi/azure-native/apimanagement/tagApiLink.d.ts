 ...
 */
export declare class TagApiLink extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TagApiLink;
    /**
     * Returns true if the given object is an instance of TagApiLink.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TagApiLink;
    /**
...
//# sourceMappingURL=tagApiLink.d.ts.map