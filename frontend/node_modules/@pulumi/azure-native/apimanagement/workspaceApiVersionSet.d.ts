 ...
 */
export declare class WorkspaceApiVersionSet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceApiVersionSet;
    /**
     * Returns true if the given object is an instance of WorkspaceApiVersionSet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkspaceApiVersionSet;
    /**
...
//# sourceMappingURL=workspaceApiVersionSet.d.ts.map