 ...
 */
export declare class WorkspaceLogger extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceLogger;
    /**
     * Returns true if the given object is an instance of WorkspaceLogger.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkspaceLogger;
    /**
...
//# sourceMappingURL=workspaceLogger.d.ts.map