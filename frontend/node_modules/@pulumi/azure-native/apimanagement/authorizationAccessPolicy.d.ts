 ...
 */
export declare class AuthorizationAccessPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AuthorizationAccessPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is AuthorizationAccessPolicy;
    /**
     * The allowed Azure Active Directory Application IDs
     */
    readonly appIds: pulumi.Output<string[] | undefined>;
    /**
