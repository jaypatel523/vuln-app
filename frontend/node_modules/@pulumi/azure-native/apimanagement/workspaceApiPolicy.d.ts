 ...
 */
export declare class WorkspaceApiPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceApiPolicy;
    /**
     * Returns true if the given object is an instance of WorkspaceApiPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkspaceApiPolicy;
    /**
...
//# sourceMappingURL=workspaceApiPolicy.d.ts.map