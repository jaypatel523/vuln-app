...
export declare class Ledger extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ledger;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.confidentialledger.LedgerPropertiesResponse>;
    /**
