 ...
 */
export declare class CIAMTenant extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CIAMTenant;
    /**
     * Returns true if the given object is an instance of CIAMTenant.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CIAMTenant;
    /**
     ...
     */
    readonly createTenantProperties: pulumi.Output<outputs.azureactivedirectory.CreateCIAMTenantPropertiesResponse>;
    /**
     ...
     */
    readonly effectiveStartDateUtc: pulumi.Output<string>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.azureactivedirectory.CIAMResourceSKUResponse>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: pulumi.Output<outputs.azureactivedirectory.SystemDataResponse>;
    /**
     * Resource Tags
     */
...
//# sourceMappingURL=ciamtenant.d.ts.map