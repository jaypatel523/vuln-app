 ...
 */
export declare class SecurityPoliciesInterface extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityPoliciesInterface;
    /**
     ...
     */
    static isInstance(obj: any): obj is SecurityPoliciesInterface;
    /**
     ...
     */
    readonly wafPolicy: pulumi.Output<outputs.servicenetworking.WafPolicyResponse | undefined>;
    /**
...
//# sourceMappingURL=securityPoliciesInterface.d.ts.map