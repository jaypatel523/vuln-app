 ...
 */
export declare class SyncIdentityProvider extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SyncIdentityProvider;
    /**
     * Returns true if the given object is an instance of SyncIdentityProvider.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SyncIdentityProvider;
    /**
...
//# sourceMappingURL=syncIdentityProvider.d.ts.map