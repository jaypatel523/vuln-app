 ...
 */
export declare class ManagedInstanceAzureADOnlyAuthentication extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ManagedInstanceAzureADOnlyAuthentication;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedInstanceAzureADOnlyAuthentication;
    /**
...
//# sourceMappingURL=managedInstanceAzureADOnlyAuthentication.d.ts.map