...
export declare class FailoverGroup extends pulumi.CustomResource {
     ...
     */
    readonly partnerServers: pulumi.Output<outputs.sql.PartnerInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint: pulumi.Output<outputs.sql.FailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: pulumi.Output<outputs.sql.FailoverGroupReadWriteEndpointResponse>;
    /**
...
export interface FailoverGroupArgs {
     ...
     * List of partner server information for the failover group.
     */
    partnerServers: pulumi.Input<pulumi.Input<inputs.sql.PartnerInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
     ...
     * Read-write endpoint of the failover group instance.
     */
    readWriteEndpoint: pulumi.Input<inputs.sql.FailoverGroupReadWriteEndpointArgs>;
    /**
...
//# sourceMappingURL=failoverGroup.d.ts.map