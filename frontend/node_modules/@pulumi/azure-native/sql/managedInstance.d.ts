...
export declare class ManagedInstance extends pulumi.CustomResource {
     ...
     */
    readonly administrators: pulumi.Output<outputs.sql.ManagedInstanceExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.sql.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.sql.ManagedInstancePecPropertyResponse[]>;
    /**
     ...
     */
    readonly servicePrincipal: pulumi.Output<outputs.sql.ServicePrincipalResponse | undefined>;
    /**
     * Managed instance SKU. Allowed values for sku.name: GP_Gen5, GP_G8IM, GP_G8IH, BC_Gen5, BC_G8IM, BC_G8IH
     */
    readonly sku: pulumi.Output<outputs.sql.SkuResponse | undefined>;
    /**
...
export interface ManagedInstanceArgs {
     ...
     * The license type. Possible values are 'LicenseIncluded' (regular price inclusive of a new SQL license) and 'BasePrice' (discounted AHB price for bringing your own SQL licenses).
     */
    licenseType?: pulumi.Input<string | enums.sql.ManagedInstanceLicenseType>;
    /**
     * Resource location.
     */
     ...
     */
    managedInstanceCreateMode?: pulumi.Input<string | enums.sql.ManagedServerCreateMode>;
    /**
     ...
     * Connection type used for connecting to the instance.
     */
    proxyOverride?: pulumi.Input<string | enums.sql.ManagedInstanceProxyOverride>;
    /**
     * Whether or not the public data endpoint is enabled.
     */
...
//# sourceMappingURL=managedInstance.d.ts.map