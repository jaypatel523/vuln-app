 ...
 */
export declare class SyncAgent extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SyncAgent;
    /**
     * Returns true if the given object is an instance of SyncAgent.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SyncAgent;
    /**
     ...
     */
    readonly isUpToDate: pulumi.Output<boolean>;
    /**
     * Last alive time of the sync agent.
     */
    readonly lastAliveTime: pulumi.Output<string>;
    /**
     * Resource name.
     */
