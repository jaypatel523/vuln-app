...
export declare class PrivateLinkScope extends pulumi.CustomResource {
     ...
     */
    readonly accessModeSettings: pulumi.Output<outputs.monitor.AccessModeSettingsResponse>;
    /**
     ...
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.monitor.PrivateEndpointConnectionResponseV1[]>;
    /**
...
export interface PrivateLinkScopeArgs {
     ...
     * Access mode settings
     */
    accessModeSettings: pulumi.Input<inputs.monitor.AccessModeSettingsArgs>;
    /**
     * The geo-location where the resource lives
     */
...
//# sourceMappingURL=privateLinkScope.d.ts.map