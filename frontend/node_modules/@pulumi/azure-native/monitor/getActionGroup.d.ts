...
export interface GetActionGroupResult {
     ...
     */
    readonly armRoleReceivers?: outputs.monitor.ArmRoleReceiverResponse[];
    /**
     * The list of AutomationRunbook receivers that are part of this action group.
     */
    readonly automationRunbookReceivers?: outputs.monitor.AutomationRunbookReceiverResponse[];
    /**
     ...
     */
    readonly azureFunctionReceivers?: outputs.monitor.AzureFunctionReceiverResponse[];
    /**
     ...
     */
    readonly eventHubReceivers?: outputs.monitor.EventHubReceiverResponse[];
    /**
     ...
     */
    readonly incidentReceivers?: outputs.monitor.IncidentReceiverResponse[];
    /**
 ...
 * Other available API versions: 2018-03-01, 2022-06-01, 2023-09-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native monitor [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getActionGroupOutput(args: GetActionGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetActionGroupResult>;
...
//# sourceMappingURL=getActionGroup.d.ts.map