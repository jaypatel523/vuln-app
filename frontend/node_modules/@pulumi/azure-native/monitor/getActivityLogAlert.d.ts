...
export interface GetActivityLogAlertResult {
     ...
     */
    readonly actions: outputs.monitor.ActionListResponse;
    /**
     ...
     */
    readonly condition: outputs.monitor.AlertRuleAllOfConditionResponse;
    /**
 ...
 * Other available API versions: 2026-01-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native monitor [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getActivityLogAlertOutput(args: GetActivityLogAlertOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetActivityLogAlertResult>;
...
//# sourceMappingURL=getActivityLogAlert.d.ts.map