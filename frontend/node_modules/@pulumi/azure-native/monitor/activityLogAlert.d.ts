...
export declare class ActivityLogAlert extends pulumi.CustomResource {
     ...
     */
    readonly actions: pulumi.Output<outputs.monitor.ActionListResponse>;
    /**
     ...
     */
    readonly condition: pulumi.Output<outputs.monitor.AlertRuleAllOfConditionResponse>;
    /**
...
export interface ActivityLogAlertArgs {
     ...
     * The actions that will activate when the condition is met.
     */
    actions: pulumi.Input<inputs.monitor.ActionListArgs>;
    /**
     ...
     * The condition that will cause this alert to activate.
     */
    condition: pulumi.Input<inputs.monitor.AlertRuleAllOfConditionArgs>;
    /**
     * A description of this Activity Log Alert rule.
     */
...
//# sourceMappingURL=activityLogAlert.d.ts.map