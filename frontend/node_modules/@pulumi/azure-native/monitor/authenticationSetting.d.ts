 ...
 */
export declare class AuthenticationSetting extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AuthenticationSetting;
    /**
     * Returns true if the given object is an instance of AuthenticationSetting.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AuthenticationSetting;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.monitor.ManagedIdentityAuthenticationSettingPropertiesResponse>;
    /**
...
export interface AuthenticationSettingArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.monitor.ManagedIdentityAuthenticationSettingPropertiesArgs>;
    /**
     * The name of the resource group. The name is case insensitive.
     */
    resourceGroupName: pulumi.Input<string>;
}
//# sourceMappingURL=authenticationSetting.d.ts.map