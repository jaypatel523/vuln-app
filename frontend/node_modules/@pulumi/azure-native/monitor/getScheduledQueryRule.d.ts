...
export interface GetScheduledQueryRuleResult {
     ...
     */
    readonly actions?: outputs.monitor.ActionsResponse;
    /**
     ...
     */
    readonly resolveConfiguration?: outputs.monitor.RuleResolveConfigurationResponse;
    /**
 ...
 * Other available API versions: 2023-12-01, 2026-03-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native monitor [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getScheduledQueryRuleOutput(args: GetScheduledQueryRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScheduledQueryRuleResult>;
...
//# sourceMappingURL=getScheduledQueryRule.d.ts.map