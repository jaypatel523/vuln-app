 ...
 */
export declare class BusinessCaseOperation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BusinessCaseOperation;
    /**
     * Returns true if the given object is an instance of BusinessCaseOperation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BusinessCaseOperation;
    /**
     ...
     */
    readonly reportStatusDetails: pulumi.Output<outputs.migrate.ReportDetailsResponse[]>;
    /**
     * Business case settings.
     */
    readonly settings: pulumi.Output<outputs.migrate.SettingsResponse | undefined>;
    /**
     * Business case state.
     */
...
//# sourceMappingURL=businessCaseOperation.d.ts.map