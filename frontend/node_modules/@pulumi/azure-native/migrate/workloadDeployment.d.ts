 ...
 */
export declare class WorkloadDeployment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkloadDeployment;
    /**
     * Returns true if the given object is an instance of WorkloadDeployment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkloadDeployment;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.migrate.WorkloadDeploymentModelPropertiesResponse>;
    readonly systemData: pulumi.Output<outputs.migrate.WorkloadDeploymentModelResponseSystemData>;
    /**
...
export interface WorkloadDeploymentArgs {
     ...
     * Workload deployment model properties.
     */
    properties?: pulumi.Input<inputs.migrate.WorkloadDeploymentModelPropertiesArgs>;
    /**
...
//# sourceMappingURL=workloadDeployment.d.ts.map