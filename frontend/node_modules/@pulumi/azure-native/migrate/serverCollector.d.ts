 ...
 */
export declare class ServerCollector extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerCollector;
    /**
     * Returns true if the given object is an instance of ServerCollector.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ServerCollector;
    /**
    ...
    readonly properties: pulumi.Output<outputs.migrate.CollectorPropertiesResponse>;
...
//# sourceMappingURL=serverCollector.d.ts.map