...
export declare class SqlAssessmentV2Operation extends pulumi.CustomResource {
     ...
     */
    readonly azureSqlDatabaseSettings: pulumi.Output<outputs.migrate.SqlDbSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable SQL managed instance settings.
     */
    readonly azureSqlManagedInstanceSettings: pulumi.Output<outputs.migrate.SqlMiSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable SQL VM settings.
     */
    readonly azureSqlVmSettings: pulumi.Output<outputs.migrate.SqlVmSettingsResponse | undefined>;
    /**
...
//# sourceMappingURL=sqlAssessmentV2Operation.d.ts.map