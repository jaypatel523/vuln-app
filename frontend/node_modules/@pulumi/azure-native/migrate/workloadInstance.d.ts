 ...
 */
export declare class WorkloadInstance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkloadInstance;
    /**
     * Returns true if the given object is an instance of WorkloadInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkloadInstance;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.migrate.WorkloadInstanceModelPropertiesResponse>;
    readonly systemData: pulumi.Output<outputs.migrate.WorkloadInstanceModelResponseSystemData>;
    /**
...
//# sourceMappingURL=workloadInstance.d.ts.map