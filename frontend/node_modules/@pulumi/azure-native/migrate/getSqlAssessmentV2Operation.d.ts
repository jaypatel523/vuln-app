 ...
 */
export declare function getSqlAssessmentV2Operation(args: GetSqlAssessmentV2OperationArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlAssessmentV2OperationResult>;
...
export interface GetSqlAssessmentV2OperationResult {
     ...
     */
    readonly azureSqlDatabaseSettings?: outputs.migrate.SqlDbSettingsResponse;
    /**
     * Gets or sets user configurable SQL managed instance settings.
     */
    readonly azureSqlManagedInstanceSettings?: outputs.migrate.SqlMiSettingsResponse;
    /**
     * Gets or sets user configurable SQL VM settings.
     */
    readonly azureSqlVmSettings?: outputs.migrate.SqlVmSettingsResponse;
    /**
 ...
 * Other available API versions: 2023-03-15, 2023-04-01-preview, 2023-05-01-preview, 2023-09-09-preview, 2024-01-15. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native migrate [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getSqlAssessmentV2OperationOutput(args: GetSqlAssessmentV2OperationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSqlAssessmentV2OperationResult>;
...
//# sourceMappingURL=getSqlAssessmentV2Operation.d.ts.map