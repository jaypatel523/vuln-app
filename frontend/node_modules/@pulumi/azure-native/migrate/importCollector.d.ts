 ...
 */
export declare class ImportCollector extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ImportCollector;
    /**
     * Returns true if the given object is an instance of ImportCollector.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ImportCollector;
    /**
    ...
    readonly properties: pulumi.Output<outputs.migrate.ImportCollectorPropertiesResponse>;
...
//# sourceMappingURL=importCollector.d.ts.map