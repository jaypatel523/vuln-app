...
export declare const EventHubEventSource: typeof import("./eventHubEventSource").EventHubEventSource;
...
export declare const Gen2Environment: typeof import("./gen2Environment").Gen2Environment;
...
export declare const getEventHubEventSource: typeof import("./getEventHubEventSource").getEventHubEventSource;
export declare const getEventHubEventSourceOutput: typeof import("./getEventHubEventSource").getEventHubEventSourceOutput;
export { GetGen1EnvironmentArgs, GetGen1EnvironmentResult, GetGen1EnvironmentOutputArgs } from "./getGen1Environment";
export declare const getGen1Environment: typeof import("./getGen1Environment").getGen1Environment;
...
export declare const getGen2Environment: typeof import("./getGen2Environment").getGen2Environment;
export declare const getGen2EnvironmentOutput: typeof import("./getGen2Environment").getGen2EnvironmentOutput;
export { GetIoTHubEventSourceArgs, GetIoTHubEventSourceResult, GetIoTHubEventSourceOutputArgs } from "./getIoTHubEventSource";
export declare const getIoTHubEventSource: typeof import("./getIoTHubEventSource").getIoTHubEventSource;
export declare const getIoTHubEventSourceOutput: typeof import("./getIoTHubEventSource").getIoTHubEventSourceOutput;
export { GetReferenceDataSetArgs, GetReferenceDataSetResult, GetReferenceDataSetOutputArgs } from "./getReferenceDataSet";
export declare const getReferenceDataSet: typeof import("./getReferenceDataSet").getReferenceDataSet;
export declare const getReferenceDataSetOutput: typeof import("./getReferenceDataSet").getReferenceDataSetOutput;
...
export declare const IoTHubEventSource: typeof import("./ioTHubEventSource").IoTHubEventSource;
export { ReferenceDataSetArgs } from "./referenceDataSet";
export type ReferenceDataSet = import("./referenceDataSet").ReferenceDataSet;
export declare const ReferenceDataSet: typeof import("./referenceDataSet").ReferenceDataSet;
