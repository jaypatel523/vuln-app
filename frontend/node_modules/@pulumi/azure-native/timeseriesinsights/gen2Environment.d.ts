...
export declare class Gen2Environment extends pulumi.CustomResource {
     ...
     */
    readonly storageConfiguration: pulumi.Output<outputs.timeseriesinsights.Gen2StorageConfigurationOutputResponse>;
    /**
     * Resource tags
     */
     ...
     */
    readonly timeSeriesIdProperties: pulumi.Output<outputs.timeseriesinsights.TimeSeriesIdPropertyResponse[]>;
    /**
     * Resource type
     */
     ...
     */
    readonly warmStoreConfiguration: pulumi.Output<outputs.timeseriesinsights.WarmStoreConfigurationPropertiesResponse | undefined>;
    /**
...
export interface Gen2EnvironmentArgs {
     ...
     * The storage configuration provides the connection details that allows the Time Series Insights service to connect to the customer storage account that is used to store the environment's data.
     */
    storageConfiguration: pulumi.Input<inputs.timeseriesinsights.Gen2StorageConfigurationInputArgs>;
    /**
     ...
     * The list of event properties which will be used to define the environment's time series id.
     */
    timeSeriesIdProperties: pulumi.Input<pulumi.Input<inputs.timeseriesinsights.TimeSeriesIdPropertyArgs>[]>;
    /**
     * The warm store configuration provides the details to create a warm store cache that will retain a copy of the environment's data available for faster query.
     */
    warmStoreConfiguration?: pulumi.Input<inputs.timeseriesinsights.WarmStoreConfigurationPropertiesArgs>;
}
//# sourceMappingURL=gen2Environment.d.ts.map