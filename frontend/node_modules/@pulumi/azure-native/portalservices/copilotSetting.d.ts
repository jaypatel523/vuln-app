 ...
 */
export declare class CopilotSetting extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CopilotSetting;
    /**
     * Returns true if the given object is an instance of CopilotSetting.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CopilotSetting;
    /**
     * Boolean indicating if role-based access control is enabled for copilot in this tenant.
     */
    readonly accessControlEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.portalservices.SystemDataResponse>;
    /**
...
//# sourceMappingURL=copilotSetting.d.ts.map