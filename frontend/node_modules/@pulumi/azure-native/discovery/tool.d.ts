...
export declare class Tool extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Tool;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.discovery.ToolPropertiesResponse>;
    /**
