 ...
 */
export declare class StorageContainer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageContainer;
    /**
     * Returns true if the given object is an instance of StorageContainer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StorageContainer;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.discovery.StorageContainerPropertiesResponse>;
    /**
...
export interface StorageContainerArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<inputs.discovery.StorageContainerPropertiesArgs>;
    /**
