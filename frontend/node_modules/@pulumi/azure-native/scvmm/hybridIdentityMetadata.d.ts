 ...
 */
export declare class HybridIdentityMetadata extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HybridIdentityMetadata;
    /**
     * Returns true if the given object is an instance of HybridIdentityMetadata.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is HybridIdentityMetadata;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.scvmm.IdentityResponse>;
    /**
...
//# sourceMappingURL=hybridIdentityMetadata.d.ts.map