 ...
 */
export declare class CapacityPoolSnapshot extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CapacityPoolSnapshot;
    /**
     * Returns true if the given object is an instance of CapacityPoolSnapshot.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CapacityPoolSnapshot;
    /**
...
//# sourceMappingURL=capacityPoolSnapshot.d.ts.map