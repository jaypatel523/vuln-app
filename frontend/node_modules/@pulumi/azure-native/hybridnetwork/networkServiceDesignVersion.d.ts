 ...
 */
export declare class NetworkServiceDesignVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkServiceDesignVersion;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkServiceDesignVersion;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.hybridnetwork.NetworkServiceDesignVersionPropertiesFormatResponse>;
    /**
...
//# sourceMappingURL=networkServiceDesignVersion.d.ts.map