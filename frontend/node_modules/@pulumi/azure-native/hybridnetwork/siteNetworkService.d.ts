 ...
 */
export declare class SiteNetworkService extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SiteNetworkService;
    /**
     * Returns true if the given object is an instance of SiteNetworkService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SiteNetworkService;
    /**
     ...
     */
    readonly identity: pulumi.Output<outputs.hybridnetwork.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.hybridnetwork.SiteNetworkServicePropertiesFormatResponse>;
    /**
     * Sku of the site network service.
     */
    readonly sku: pulumi.Output<outputs.hybridnetwork.SkuResponse | undefined>;
    /**
...
//# sourceMappingURL=siteNetworkService.d.ts.map