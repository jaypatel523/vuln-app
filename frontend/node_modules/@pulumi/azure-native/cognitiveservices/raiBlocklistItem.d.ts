 ...
 */
export declare class RaiBlocklistItem extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RaiBlocklistItem;
    /**
     * Returns true if the given object is an instance of RaiBlocklistItem.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RaiBlocklistItem;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.cognitiveservices.RaiBlocklistItemPropertiesResponse>;
    /**
...
export interface RaiBlocklistItemArgs {
     ...
     * Properties of Cognitive Services RaiBlocklist Item.
     */
    properties?: pulumi.Input<inputs.cognitiveservices.RaiBlocklistItemPropertiesArgs>;
    /**
...
//# sourceMappingURL=raiBlocklistItem.d.ts.map