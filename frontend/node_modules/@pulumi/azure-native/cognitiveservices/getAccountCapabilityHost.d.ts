 ...
 */
export declare function getAccountCapabilityHost(args: GetAccountCapabilityHostArgs, opts?: pulumi.InvokeOptions): Promise<GetAccountCapabilityHostResult>;
 ...
 * Other available API versions: 2025-04-01-preview, 2025-07-01-preview, 2025-09-01, 2025-10-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native cognitiveservices [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getAccountCapabilityHostOutput(args: GetAccountCapabilityHostOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAccountCapabilityHostResult>;
...
//# sourceMappingURL=getAccountCapabilityHost.d.ts.map