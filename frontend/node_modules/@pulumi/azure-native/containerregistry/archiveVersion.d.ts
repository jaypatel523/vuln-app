 ...
 */
export declare class ArchiveVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ArchiveVersion;
    /**
     * Returns true if the given object is an instance of ArchiveVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ArchiveVersion;
    /**
     * The detailed error message for the archive version in the case of failure.
     */
    readonly archiveVersionErrorMessage: pulumi.Output<string | undefined>;
    /**
...
//# sourceMappingURL=archiveVersion.d.ts.map