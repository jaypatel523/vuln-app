 ...
 */
export declare class IntegrationFabric extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationFabric;
    /**
     * Returns true if the given object is an instance of IntegrationFabric.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IntegrationFabric;
    /**
    ...
    readonly properties: pulumi.Output<outputs.dashboard.IntegrationFabricPropertiesResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.dashboard.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
//# sourceMappingURL=integrationFabric.d.ts.map