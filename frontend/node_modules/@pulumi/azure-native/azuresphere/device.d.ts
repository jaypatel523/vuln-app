...
export declare class Device extends pulumi.CustomResource {
     ...
     * SKU of the chip
     */
    readonly chipSku: pulumi.Output<string>;
    /**
     * Device ID
     */
     ...
     */
    readonly lastAvailableOsVersion: pulumi.Output<string>;
    /**
     * OS version running on device when update requested
     */
    readonly lastInstalledOsVersion: pulumi.Output<string>;
    /**
     * Time when update requested and new OS version available
     */
    readonly lastOsUpdateUtc: pulumi.Output<string>;
    /**
     * Time when update was last requested
     */
    readonly lastUpdateRequestUtc: pulumi.Output<string>;
    /**
