 ...
 */
export declare class CommunityTraining extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CommunityTraining;
    /**
     * Returns true if the given object is an instance of CommunityTraining.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CommunityTraining;
    /**
     ...
     */
    readonly disasterRecoveryEnabled: pulumi.Output<boolean>;
    /**
     * The identity configuration of the Community Training resource
     */
    readonly identityConfiguration: pulumi.Output<outputs.community.IdentityConfigurationPropertiesResponse>;
    /**
     ...
     */
    readonly portalAdminEmailAddress: pulumi.Output<string>;
    /**
     * The portal name (website name) of the Community Training instance
     */
    readonly portalName: pulumi.Output<string>;
    /**
     * The email address of the portal owner. Will be used as the primary contact
     */
    readonly portalOwnerEmailAddress: pulumi.Output<string>;
    /**
     * The organization name of the portal owner
     */
    readonly portalOwnerOrganizationName: pulumi.Output<string>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.community.SkuResponse | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.community.SystemDataResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    readonly zoneRedundancyEnabled: pulumi.Output<boolean>;
    /**
...
//# sourceMappingURL=communityTraining.d.ts.map