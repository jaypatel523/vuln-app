 ...
 */
export declare class VariableValueAtManagementGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VariableValueAtManagementGroup;
    /**
     ...
     */
    static isInstance(obj: any): obj is VariableValueAtManagementGroup;
    /**
     ...
     */
    readonly values: pulumi.Output<outputs.authorization.PolicyVariableValueColumnValueResponse[]>;
    /**
...
//# sourceMappingURL=variableValueAtManagementGroup.d.ts.map