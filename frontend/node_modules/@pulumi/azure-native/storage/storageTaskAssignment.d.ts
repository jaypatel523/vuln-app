 ...
 */
export declare class StorageTaskAssignment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StorageTaskAssignment;
    /**
     * Returns true if the given object is an instance of StorageTaskAssignment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StorageTaskAssignment;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.storage.StorageTaskAssignmentPropertiesResponse>;
    /**
...
export interface StorageTaskAssignmentArgs {
     ...
     * Properties of the storage task assignment.
     */
    properties: pulumi.Input<inputs.storage.StorageTaskAssignmentPropertiesArgs>;
    /**
...
//# sourceMappingURL=storageTaskAssignment.d.ts.map