 ...
 */
export declare class MonitoredSubscription extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MonitoredSubscription;
    /**
     * Returns true if the given object is an instance of MonitoredSubscription.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MonitoredSubscription;
    /**
     ...
     * The request to update subscriptions needed to be monitored by the Datadog monitor resource.
     */
    readonly properties: pulumi.Output<outputs.datadog.SubscriptionListResponse>;
    /**
...
//# sourceMappingURL=monitoredSubscription.d.ts.map