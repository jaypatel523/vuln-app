 ...
 */
export declare class RoutePolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RoutePolicy;
    /**
     * Returns true if the given object is an instance of RoutePolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RoutePolicy;
    /**
     * AddressFamilyType. This parameter decides whether the given ipv4 or ipv6 route policy.
     */
    readonly addressFamilyType: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly statements: pulumi.Output<outputs.managednetworkfabric.RoutePolicyStatementPropertiesResponse[]>;
    /**
