 ...
 */
export declare class IpExtendedCommunity extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IpExtendedCommunity;
    /**
     * Returns true if the given object is an instance of IpExtendedCommunity.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IpExtendedCommunity;
    /**
     ...
     */
    readonly ipExtendedCommunityRules: pulumi.Output<outputs.managednetworkfabric.IpExtendedCommunityRuleResponse[]>;
    /**
...
//# sourceMappingURL=ipExtendedCommunity.d.ts.map