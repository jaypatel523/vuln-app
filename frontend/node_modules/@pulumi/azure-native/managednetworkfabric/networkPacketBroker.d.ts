 ...
 */
export declare class NetworkPacketBroker extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkPacketBroker;
    /**
     * Returns true if the given object is an instance of NetworkPacketBroker.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NetworkPacketBroker;
    /**
     ...
     */
    readonly neighborGroupIds: pulumi.Output<string[]>;
    /**
     * List of ARM resource IDs of Network Devices [NPB].
     */
    readonly networkDeviceIds: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly networkTapIds: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly sourceInterfaceIds: pulumi.Output<string[]>;
    /**
...
//# sourceMappingURL=networkPacketBroker.d.ts.map