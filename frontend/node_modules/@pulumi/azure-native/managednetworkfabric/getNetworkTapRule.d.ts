 ...
 */
export declare function getNetworkTapRule(args: GetNetworkTapRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkTapRuleResult>;
...
export interface GetNetworkTapRuleResult {
     ...
     */
    readonly matchConfigurations?: outputs.managednetworkfabric.NetworkTapRuleMatchConfigurationResponse[];
    /**
 ...
 * Other available API versions: 2024-02-15-preview, 2024-06-15-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native managednetworkfabric [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getNetworkTapRuleOutput(args: GetNetworkTapRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkTapRuleResult>;
...
//# sourceMappingURL=getNetworkTapRule.d.ts.map