 ...
 */
export declare class InternalNetwork extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InternalNetwork;
    /**
     * Returns true if the given object is an instance of InternalNetwork.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InternalNetwork;
    /**
     ...
     */
    readonly bgpConfiguration: pulumi.Output<outputs.managednetworkfabric.InternalNetworkPropertiesResponseBgpConfiguration | undefined>;
    /**
     ...
     */
    readonly connectedIPv4Subnets: pulumi.Output<outputs.managednetworkfabric.ConnectedSubnetResponse[] | undefined>;
    /**
     * List of connected IPv6 Subnets.
     */
    readonly connectedIPv6Subnets: pulumi.Output<outputs.managednetworkfabric.ConnectedSubnetResponse[] | undefined>;
    /**
     * Egress Acl. ARM resource ID of Access Control Lists.
     */
    readonly egressAclId: pulumi.Output<string | undefined>;
    /**
     * Export Route Policy either IPv4 or IPv6.
     */
    readonly exportRoutePolicy: pulumi.Output<outputs.managednetworkfabric.ExportRoutePolicyResponse | undefined>;
    /**
     * ARM Resource ID of the RoutePolicy. This is used for the backward compatibility.
     */
    readonly exportRoutePolicyId: pulumi.Output<string | undefined>;
    /**
     * Extension. Example: NoExtension | NPB.
     */
    readonly extension: pulumi.Output<string | undefined>;
    /**
     * Import Route Policy either IPv4 or IPv6.
     */
    readonly importRoutePolicy: pulumi.Output<outputs.managednetworkfabric.ImportRoutePolicyResponse | undefined>;
    /**
     * ARM Resource ID of the RoutePolicy. This is used for the backward compatibility.
     */
    readonly importRoutePolicyId: pulumi.Output<string | undefined>;
    /**
     * Ingress Acl. ARM resource ID of Access Control Lists.
     */
    readonly ingressAclId: pulumi.Output<string | undefined>;
    /**
     * To check whether monitoring of internal network is enabled or not.
     */
    readonly isMonitoringEnabled: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly staticRouteConfiguration: pulumi.Output<outputs.managednetworkfabric.InternalNetworkPropertiesResponseStaticRouteConfiguration | undefined>;
    /**
