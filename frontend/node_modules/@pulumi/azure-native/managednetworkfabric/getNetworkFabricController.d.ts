 ...
 */
export declare function getNetworkFabricController(args: GetNetworkFabricControllerArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkFabricControllerResult>;
...
export interface GetNetworkFabricControllerResult {
     ...
     */
    readonly infrastructureExpressRouteConnections?: outputs.managednetworkfabric.ExpressRouteConnectionInformationResponse[];
    /**
     ...
     */
    readonly managedResourceGroupConfiguration?: outputs.managednetworkfabric.ManagedResourceGroupConfigurationResponse;
    /**
 ...
 * Other available API versions: 2023-02-01-preview, 2024-02-15-preview, 2024-06-15-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native managednetworkfabric [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getNetworkFabricControllerOutput(args: GetNetworkFabricControllerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkFabricControllerResult>;
...
//# sourceMappingURL=getNetworkFabricController.d.ts.map