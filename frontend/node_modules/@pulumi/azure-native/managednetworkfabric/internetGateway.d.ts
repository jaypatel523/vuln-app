...
export declare class InternetGateway extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InternetGateway;
    /**
     ...
     */
    readonly internetGatewayRuleId: pulumi.Output<string | undefined>;
    /**
