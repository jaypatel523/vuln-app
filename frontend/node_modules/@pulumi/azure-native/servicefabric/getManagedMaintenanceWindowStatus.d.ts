 ...
 */
export declare function getManagedMaintenanceWindowStatus(args: GetManagedMaintenanceWindowStatusArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedMaintenanceWindowStatusResult>;
 ...
 * Other available API versions: 2023-07-01-preview, 2023-09-01-preview, 2023-11-01-preview, 2023-12-01-preview, 2024-02-01-preview, 2024-06-01-preview, 2024-09-01-preview, 2024-11-01-preview, 2025-03-01-preview, 2025-06-01-preview, 2025-10-01-preview, 2026-02-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native servicefabric [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getManagedMaintenanceWindowStatusOutput(args: GetManagedMaintenanceWindowStatusOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetManagedMaintenanceWindowStatusResult>;
...
//# sourceMappingURL=getManagedMaintenanceWindowStatus.d.ts.map