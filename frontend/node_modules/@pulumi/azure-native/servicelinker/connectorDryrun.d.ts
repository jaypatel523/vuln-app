 ...
 */
export declare class ConnectorDryrun extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectorDryrun;
    /**
     * Returns true if the given object is an instance of ConnectorDryrun.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ConnectorDryrun;
    /**
     ...
     */
    readonly operationPreviews: pulumi.Output<outputs.servicelinker.DryrunOperationPreviewResponse[]>;
    /**
     * The parameters of the dryrun
     */
    readonly parameters: pulumi.Output<outputs.servicelinker.CreateOrUpdateDryrunParametersResponse | undefined>;
    /**
     * the result of the dryrun
     */
    readonly prerequisiteResults: pulumi.Output<(outputs.servicelinker.BasicErrorDryrunPrerequisiteResultResponse | outputs.servicelinker.PermissionsMissingDryrunPrerequisiteResultResponse)[]>;
    /**
...
//# sourceMappingURL=connectorDryrun.d.ts.map