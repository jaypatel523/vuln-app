...
export declare class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.security.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.security.PrivateLinkServiceConnectionStateResponse>;
    /**
...
export interface PrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: pulumi.Input<inputs.security.PrivateLinkServiceConnectionStateArgs>;
    /**
