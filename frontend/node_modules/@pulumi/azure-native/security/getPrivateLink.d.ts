 ...
 */
export declare function getPrivateLink(args: GetPrivateLinkArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateLinkResult>;
 ...
 * Other available API versions: 2026-01-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native security [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getPrivateLinkOutput(args: GetPrivateLinkOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPrivateLinkResult>;
...
//# sourceMappingURL=getPrivateLink.d.ts.map