 ...
 */
export declare class Pricing extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Pricing;
    /**
     * Returns true if the given object is an instance of Pricing.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Pricing;
    /**
     ...
     */
    readonly enablementTime: pulumi.Output<string>;
    /**
     * If set to "False", it allows the descendants of this scope to override the pricing configuration set on this scope (allows setting inherited="False"). If set to "True", it prevents overrides and forces this pricing configuration on all the descendants of this scope. This field is only available for subscription-level pricing.
     */
    readonly enforce: pulumi.Output<string | undefined>;
    /**
     * Optional. List of extensions offered under a plan.
     */
    readonly extensions: pulumi.Output<outputs.security.ExtensionResponse[] | undefined>;
    /**
     * The duration left for the subscriptions free trial period - in ISO 8601 format (e.g. P3Y6M4DT12H30M5S).
     */
    readonly freeTrialRemainingTime: pulumi.Output<string>;
    /**
     ...
     */
    readonly inherited: pulumi.Output<string>;
    /**
     ...
     */
    readonly subPlan: pulumi.Output<string | undefined>;
    /**
     * Resource type
     */
