...
export interface GetSpringbootsiteResult {
     ...
     */
    readonly extendedLocation?: outputs.offazurespringboot.SpringbootsitesModelResponseExtendedLocation;
    /**
     ...
     */
    readonly properties: outputs.offazurespringboot.SpringbootsitesPropertiesResponse;
    /**
 ...
 * Other available API versions: 2023-01-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native offazurespringboot [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getSpringbootsiteOutput(args: GetSpringbootsiteOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSpringbootsiteResult>;
...
//# sourceMappingURL=getSpringbootsite.d.ts.map