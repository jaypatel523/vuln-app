 ...
 */
export declare class OperatorApiConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OperatorApiConnection;
    /**
     * Returns true if the given object is an instance of OperatorApiConnection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OperatorApiConnection;
    /**
     ...
     */
    readonly camaraApiName: pulumi.Output<string>;
    /**
     * Details about the Application that would use the Operator's Network APIs.
     */
    readonly configuredApplication: pulumi.Output<outputs.programmableconnectivity.ApplicationPropertiesResponse | undefined>;
    /**
     ...
     */
    readonly operatorApiPlanId: pulumi.Output<string>;
    /**
     * Name of the Operator in the linked Operator API Plan belongs to.
     */
    readonly operatorName: pulumi.Output<string>;
    /**
     ...
     */
    readonly saasProperties: pulumi.Output<outputs.programmableconnectivity.SaasPropertiesResponse | undefined>;
    /**
     * The status of the OperatorApiConnection resource.
     */
    readonly status: pulumi.Output<outputs.programmableconnectivity.StatusResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.programmableconnectivity.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
//# sourceMappingURL=operatorApiConnection.d.ts.map