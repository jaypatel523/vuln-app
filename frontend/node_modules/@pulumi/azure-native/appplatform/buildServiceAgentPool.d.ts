 ...
 */
export declare class BuildServiceAgentPool extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BuildServiceAgentPool;
    /**
     * Returns true if the given object is an instance of BuildServiceAgentPool.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BuildServiceAgentPool;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.appplatform.BuildServiceAgentPoolPropertiesResponse>;
    /**
