 ...
 */
export declare class Apm extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Apm;
    /**
     * Returns true if the given object is an instance of Apm.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Apm;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.appplatform.ApmPropertiesResponse>;
    /**
