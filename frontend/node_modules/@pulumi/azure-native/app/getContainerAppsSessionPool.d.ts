...
export interface GetContainerAppsSessionPoolResult {
     ...
     */
    readonly customContainerTemplate?: outputs.app.CustomContainerTemplateResponse;
    /**
     * The pool configuration if the poolManagementType is dynamic.
     */
    readonly dynamicPoolConfiguration?: outputs.app.DynamicPoolConfigurationResponse;
    /**
     ...
     */
    readonly managedIdentitySettings?: outputs.app.ManagedIdentitySettingResponse[];
    /**
     ...
     */
    readonly scaleConfiguration?: outputs.app.ScaleConfigurationResponse;
    /**
     * The secrets of the session pool.
     */
    readonly secrets?: outputs.app.SessionPoolSecretResponse[];
    /**
     * The network configuration of the sessions in the session pool.
     */
    readonly sessionNetworkConfiguration?: outputs.app.SessionNetworkConfigurationResponse;
    /**
 ...
 * Other available API versions: 2024-02-02-preview, 2024-08-02-preview, 2024-10-02-preview, 2025-01-01, 2025-07-01, 2025-10-02-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native app [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getContainerAppsSessionPoolOutput(args: GetContainerAppsSessionPoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContainerAppsSessionPoolResult>;
...
//# sourceMappingURL=getContainerAppsSessionPool.d.ts.map