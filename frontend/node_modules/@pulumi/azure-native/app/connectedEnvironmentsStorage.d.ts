...
export declare class ConnectedEnvironmentsStorage extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectedEnvironmentsStorage;
    /**
     ...
     */
    static isInstance(obj: any): obj is ConnectedEnvironmentsStorage;
    /**
     ...
     * Storage properties
     */
    readonly properties: pulumi.Output<outputs.app.ConnectedEnvironmentStorageResponseProperties>;
    /**
...
//# sourceMappingURL=connectedEnvironmentsStorage.d.ts.map