 ...
 */
export declare class Builder extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Builder;
    /**
     * Returns true if the given object is an instance of Builder.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Builder;
    /**
     ...
     */
    readonly containerRegistries: pulumi.Output<outputs.app.ContainerRegistryResponse[] | undefined>;
    /**
