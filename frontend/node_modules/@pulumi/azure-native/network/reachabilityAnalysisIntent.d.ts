 ...
 */
export declare class ReachabilityAnalysisIntent extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReachabilityAnalysisIntent;
    /**
     ...
     */
    static isInstance(obj: any): obj is ReachabilityAnalysisIntent;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.network.ReachabilityAnalysisIntentPropertiesResponse>;
    /**
...
//# sourceMappingURL=reachabilityAnalysisIntent.d.ts.map