 ...
 */
export declare class StaticCidr extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StaticCidr;
    /**
     * Returns true if the given object is an instance of StaticCidr.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StaticCidr;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.network.StaticCidrPropertiesResponse>;
    /**
...
//# sourceMappingURL=staticCidr.d.ts.map