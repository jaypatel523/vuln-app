 ...
 */
export declare class SecurityUserRuleCollection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityUserRuleCollection;
    /**
     ...
     */
    static isInstance(obj: any): obj is SecurityUserRuleCollection;
    /**
     * Groups for configuration
     */
    readonly appliesToGroups: pulumi.Output<outputs.network.SecurityUserGroupItemResponse[]>;
    /**
...
export interface SecurityUserRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<inputs.network.SecurityUserGroupItemArgs>[]>;
    /**
...
//# sourceMappingURL=securityUserRuleCollection.d.ts.map