 ...
 */
export declare class VerifierWorkspace extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VerifierWorkspace;
    /**
     * Returns true if the given object is an instance of VerifierWorkspace.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VerifierWorkspace;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.network.VerifierWorkspacePropertiesResponse>;
    /**
...
//# sourceMappingURL=verifierWorkspace.d.ts.map