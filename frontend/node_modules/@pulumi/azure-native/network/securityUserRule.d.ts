 ...
 */
export declare class SecurityUserRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecurityUserRule;
    /**
     * Returns true if the given object is an instance of SecurityUserRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SecurityUserRule;
    /**
...
//# sourceMappingURL=securityUserRule.d.ts.map