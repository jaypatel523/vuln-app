 ...
 */
export declare function getNetworkSecurityPerimeterAccessRule(args: GetNetworkSecurityPerimeterAccessRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityPerimeterAccessRuleResult>;
 ...
 * Other available API versions: 2024-07-01, 2024-10-01, 2025-01-01, 2025-03-01, 2025-05-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native network [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getNetworkSecurityPerimeterAccessRuleOutput(args: GetNetworkSecurityPerimeterAccessRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkSecurityPerimeterAccessRuleResult>;
...
//# sourceMappingURL=getNetworkSecurityPerimeterAccessRule.d.ts.map