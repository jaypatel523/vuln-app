...
export interface ListNetworkManagerEffectiveSecurityAdminRulesResult {
     ...
     */
    readonly value?: (outputs.network.EffectiveDefaultSecurityAdminRuleResponseV1 | outputs.network.EffectiveSecurityAdminRuleResponseV1)[];
}
/**
 * List all effective security admin rules applied on a virtual network.
 *
 ...
 * Other available API versions: 2022-01-01, 2022-02-01-preview, 2022-04-01-preview, 2022-05-01, 2022-07-01, 2022-09-01, 2022-11-01, 2023-02-01, 2023-04-01, 2023-05-01, 2023-06-01, 2023-09-01, 2023-11-01, 2024-01-01, 2024-03-01, 2024-07-01, 2024-10-01, 2025-01-01, 2025-03-01, 2025-05-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native network [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function listNetworkManagerEffectiveSecurityAdminRulesOutput(args: ListNetworkManagerEffectiveSecurityAdminRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<ListNetworkManagerEffectiveSecurityAdminRulesResult>;
...
//# sourceMappingURL=listNetworkManagerEffectiveSecurityAdminRules.d.ts.map