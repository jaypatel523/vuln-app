...
export declare class WebApplicationFirewallPolicy extends pulumi.CustomResource {
     ...
     */
    readonly applicationGatewayForContainers: pulumi.Output<outputs.network.ApplicationGatewayForContainersReferenceDefinitionResponse[]>;
    /**
     * A collection of references to application gateways.
     */
    readonly applicationGateways: pulumi.Output<outputs.network.ApplicationGatewayResponse[]>;
    /**
     ...
     */
    readonly customRules: pulumi.Output<outputs.network.WebApplicationFirewallCustomRuleResponse[] | undefined>;
    /**
     ...
     */
    readonly httpListeners: pulumi.Output<outputs.network.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    readonly managedRules: pulumi.Output<outputs.network.ManagedRulesDefinitionResponse>;
    /**
     * Resource name.
     */
     ...
     */
    readonly pathBasedRules: pulumi.Output<outputs.network.SubResourceResponse[]>;
    /**
     * The PolicySettings for policy.
     */
    readonly policySettings: pulumi.Output<outputs.network.PolicySettingsResponse | undefined>;
    /**
...
//# sourceMappingURL=webApplicationFirewallPolicy.d.ts.map