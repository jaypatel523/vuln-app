 ...
 */
export declare class ReachabilityAnalysisRun extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReachabilityAnalysisRun;
    /**
     * Returns true if the given object is an instance of ReachabilityAnalysisRun.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ReachabilityAnalysisRun;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.network.ReachabilityAnalysisRunPropertiesResponse>;
    /**
...
export interface ReachabilityAnalysisRunArgs {
     ...
     * Represents the Reachability Analysis Run properties.
     */
    properties: pulumi.Input<inputs.network.ReachabilityAnalysisRunPropertiesArgs>;
    /**
...
//# sourceMappingURL=reachabilityAnalysisRun.d.ts.map