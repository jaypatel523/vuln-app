...
export declare class LoadBalancer extends pulumi.CustomResource {
     ...
     * Advertise Mode
     */
    readonly advertiseMode: pulumi.Output<string>;
    /**
     ...
     */
    readonly bgpPeers: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    readonly serviceSelector: pulumi.Output<{
        [key: string]: string;
    } | undefined>;
    /**
