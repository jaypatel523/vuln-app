 ...
 */
export declare class AzureBareMetalStorageInstance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AzureBareMetalStorageInstance;
    /**
     ...
     */
    static isInstance(obj: any): obj is AzureBareMetalStorageInstance;
    /**
     ...
     */
    readonly azureBareMetalStorageInstanceUniqueIdentifier: pulumi.Output<string | undefined>;
    /**
     * The identity of Azure Bare Metal Storage Instance, if configured.
     */
    readonly identity: pulumi.Output<outputs.baremetalinfrastructure.AzureBareMetalStorageInstanceIdentityResponse | undefined>;
    /**
     ...
     */
    readonly storageProperties: pulumi.Output<outputs.baremetalinfrastructure.StoragePropertiesResponse | undefined>;
    /**
...
//# sourceMappingURL=azureBareMetalStorageInstance.d.ts.map