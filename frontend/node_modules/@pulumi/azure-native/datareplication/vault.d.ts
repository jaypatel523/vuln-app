...
export declare class Vault extends pulumi.CustomResource {
     ...
     * Vault properties.
     */
    readonly properties: pulumi.Output<outputs.datareplication.VaultModelPropertiesResponse>;
    readonly systemData: pulumi.Output<outputs.datareplication.VaultModelResponseSystemData>;
    /**
