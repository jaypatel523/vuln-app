 ...
 */
export declare class FabricAgent extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): FabricAgent;
    /**
     * Returns true if the given object is an instance of FabricAgent.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FabricAgent;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.datareplication.FabricAgentModelPropertiesResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.datareplication.SystemDataResponse>;
    /**
...
//# sourceMappingURL=fabricAgent.d.ts.map