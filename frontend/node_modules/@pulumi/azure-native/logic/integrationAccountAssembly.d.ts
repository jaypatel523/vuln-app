...
export declare class IntegrationAccountAssembly extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IntegrationAccountAssembly;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.logic.AssemblyPropertiesResponse>;
    /**
     * The resource tags.
     */
...
export interface IntegrationAccountAssemblyArgs {
     ...
     * The assembly properties.
     */
    properties: pulumi.Input<inputs.logic.AssemblyPropertiesArgs>;
    /**
...
//# sourceMappingURL=integrationAccountAssembly.d.ts.map