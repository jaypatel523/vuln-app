 ...
 */
export declare function getSqlServerDatabase(args: GetSqlServerDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlServerDatabaseResult>;
...
export interface GetSqlServerDatabaseResult {
     ...
     */
    readonly properties: outputs.azurearcdata.SqlServerDatabaseResourcePropertiesResponse;
    /**
 ...
 * Other available API versions: 2023-01-15-preview, 2024-01-01, 2024-05-01-preview, 2026-01-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native azurearcdata [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getSqlServerDatabaseOutput(args: GetSqlServerDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSqlServerDatabaseResult>;
...
//# sourceMappingURL=getSqlServerDatabase.d.ts.map