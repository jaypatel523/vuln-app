...
export declare class SqlServerAvailabilityGroup extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlServerAvailabilityGroup;
    /**
     ...
     */
    static isInstance(obj: any): obj is SqlServerAvailabilityGroup;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.azurearcdata.SqlServerAvailabilityGroupResourcePropertiesResponse>;
    /**
...
//# sourceMappingURL=sqlServerAvailabilityGroup.d.ts.map