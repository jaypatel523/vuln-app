 ...
 */
export declare class DocumentProcessor extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DocumentProcessor;
    /**
     * Returns true if the given object is an instance of DocumentProcessor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DocumentProcessor;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.syntex.DocumentProcessorPropertiesResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.syntex.SystemDataResponse>;
    /**
     * Resource tags.
     */
