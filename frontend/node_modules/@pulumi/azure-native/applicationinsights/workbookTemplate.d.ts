...
export declare class WorkbookTemplate extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkbookTemplate;
    /**
     ...
     */
    readonly galleries: pulumi.Output<outputs.applicationinsights.WorkbookTemplateGalleryResponse[]>;
    /**
     * Key value pair of localized gallery. Each key is the locale code of languages supported by the Azure portal.
     */
    readonly localized: pulumi.Output<{
        [key: string]: outputs.applicationinsights.WorkbookTemplateLocalizedGalleryResponse[];
    } | undefined>;
    /**
     * Resource location
     */
     ...
     */
    readonly templateData: pulumi.Output<any>;
    /**
     * Azure resource type
     */
...
export interface WorkbookTemplateArgs {
     ...
     * Workbook galleries supported by the template.
     */
    galleries: pulumi.Input<pulumi.Input<inputs.applicationinsights.WorkbookTemplateGalleryArgs>[]>;
    /**
     * Key value pair of localized gallery. Each key is the locale code of languages supported by the Azure portal.
     */
    localized?: pulumi.Input<{
        [key: string]: pulumi.Input<pulumi.Input<inputs.applicationinsights.WorkbookTemplateLocalizedGalleryArgs>[]>;
    }>;
    /**
     * Resource location
     */
