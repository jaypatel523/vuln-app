...
export declare class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.maps.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.maps.PrivateLinkServiceConnectionStateResponse>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.maps.SystemDataResponse>;
    /**
...
export interface PrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: pulumi.Input<inputs.maps.PrivateLinkServiceConnectionStateArgs>;
    /**
