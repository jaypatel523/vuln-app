 ...
 */
export declare class SolutionConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SolutionConfiguration;
    /**
     * Returns true if the given object is an instance of SolutionConfiguration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SolutionConfiguration;
    /**
     ...
     * Solution settings
     */
    readonly solutionSettings: pulumi.Output<{
        [key: string]: string;
    } | undefined>;
    /**
...
//# sourceMappingURL=solutionConfiguration.d.ts.map