 ...
 */
export declare class WebAppScmAllowedSlot extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WebAppScmAllowedSlot;
    /**
     * Returns true if the given object is an instance of WebAppScmAllowedSlot.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WebAppScmAllowedSlot;
    /**
     * <code>true</code> to allow access to a publishing method; otherwise, <code>false</code>.
     */
    readonly allow: pulumi.Output<boolean>;
    /**
...
//# sourceMappingURL=webAppScmAllowedSlot.d.ts.map