 ...
 */
export declare class StaticSiteBuildDatabaseConnection extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StaticSiteBuildDatabaseConnection;
    /**
     ...
     */
    static isInstance(obj: any): obj is StaticSiteBuildDatabaseConnection;
    /**
     ...
     */
    readonly configurationFiles: pulumi.Output<outputs.web.StaticSiteDatabaseConnectionConfigurationFileOverviewResponse[]>;
    /**
     * If present, the identity is used in conjunction with connection string to connect to the database. Use of the system-assigned managed identity is indicated with the string 'SystemAssigned', while use of a user-assigned managed identity is indicated with the resource id of the managed identity resource.
     */
    readonly connectionIdentity: pulumi.Output<string | undefined>;
    /**
...
//# sourceMappingURL=staticSiteBuildDatabaseConnection.d.ts.map