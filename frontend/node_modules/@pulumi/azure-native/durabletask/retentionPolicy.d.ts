...
export declare class RetentionPolicy extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RetentionPolicy;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.durabletask.RetentionPolicyPropertiesResponse>;
    /**
