 ...
 */
export declare function getRetentionPolicy(args: GetRetentionPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetRetentionPolicyResult>;
 ...
 * Other available API versions: 2025-11-01, 2026-02-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native durabletask [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getRetentionPolicyOutput(args: GetRetentionPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRetentionPolicyResult>;
...
//# sourceMappingURL=getRetentionPolicy.d.ts.map