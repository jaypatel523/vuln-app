 ...
 */
export declare class WorkspaceManagerMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceManagerMember;
    /**
     * Returns true if the given object is an instance of WorkspaceManagerMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkspaceManagerMember;
    /**
     ...
     */
    readonly targetWorkspaceResourceId: pulumi.Output<string>;
    /**
     * Tenant id of the target Sentinel workspace joining the given Sentinel workspace manager
     */
    readonly targetWorkspaceTenantId: pulumi.Output<string>;
    /**
...
//# sourceMappingURL=workspaceManagerMember.d.ts.map