 ...
 */
export declare class WorkspaceManagerConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceManagerConfiguration;
    /**
     ...
     */
    static isInstance(obj: any): obj is WorkspaceManagerConfiguration;
    /**
...
export interface WorkspaceManagerConfigurationArgs {
     ...
     * The current mode of the workspace manager configuration
     */
    mode: pulumi.Input<string | enums.securityinsights.Mode>;
    /**
...
//# sourceMappingURL=workspaceManagerConfiguration.d.ts.map