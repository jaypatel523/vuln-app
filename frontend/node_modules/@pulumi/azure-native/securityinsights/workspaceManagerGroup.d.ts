 ...
 */
export declare class WorkspaceManagerGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceManagerGroup;
    /**
     * Returns true if the given object is an instance of WorkspaceManagerGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkspaceManagerGroup;
    /**
     ...
     */
    readonly memberResourceNames: pulumi.Output<string[]>;
    /**
...
//# sourceMappingURL=workspaceManagerGroup.d.ts.map