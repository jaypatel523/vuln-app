 ...
 */
export declare class WorkspaceManagerAssignment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkspaceManagerAssignment;
    /**
     ...
     */
    static isInstance(obj: any): obj is WorkspaceManagerAssignment;
    /**
     ...
     */
    readonly items: pulumi.Output<outputs.securityinsights.AssignmentItemResponse[]>;
    /**
     * The time the last job associated to this assignment ended at
     */
    readonly lastJobEndTime: pulumi.Output<string>;
    /**
     * State of the last job associated to this assignment
     */
    readonly lastJobProvisioningState: pulumi.Output<string>;
    /**
     ...
     */
    readonly targetResourceName: pulumi.Output<string>;
    /**
...
//# sourceMappingURL=workspaceManagerAssignment.d.ts.map