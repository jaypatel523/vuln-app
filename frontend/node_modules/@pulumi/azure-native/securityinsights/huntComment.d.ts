 ...
 */
export declare class HuntComment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HuntComment;
    /**
     * Returns true if the given object is an instance of HuntComment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is HuntComment;
    /**
...
//# sourceMappingURL=huntComment.d.ts.map