 ...
 */
export declare class ScopingConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ScopingConfiguration;
    /**
     * Returns true if the given object is an instance of ScopingConfiguration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ScopingConfiguration;
    /**
     * List of scoping question answers.
     */
    readonly answers: pulumi.Output<outputs.appcomplianceautomation.ScopingAnswerResponse[] | undefined>;
    /**
