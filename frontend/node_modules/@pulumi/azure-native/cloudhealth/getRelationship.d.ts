...
export interface GetRelationshipResult {
     ...
     */
    readonly properties: outputs.cloudhealth.RelationshipPropertiesResponse;
    /**
 ...
 * Other available API versions: 2026-01-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native cloudhealth [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getRelationshipOutput(args: GetRelationshipOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRelationshipResult>;
...
//# sourceMappingURL=getRelationship.d.ts.map