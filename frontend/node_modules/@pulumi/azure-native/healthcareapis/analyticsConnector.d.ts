 ...
 */
export declare class AnalyticsConnector extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AnalyticsConnector;
    /**
     * Returns true if the given object is an instance of AnalyticsConnector.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AnalyticsConnector;
    /**
     ...
     */
    readonly dataDestinationConfiguration: pulumi.Output<outputs.healthcareapis.AnalyticsConnectorDataLakeDataDestinationResponse>;
    /**
     * Data mapping configuration for Analytics Connector.
     */
    readonly dataMappingConfiguration: pulumi.Output<outputs.healthcareapis.AnalyticsConnectorFhirToParquetMappingResponse>;
    /**
     * Data source for Analytics Connector.
     */
    readonly dataSourceConfiguration: pulumi.Output<outputs.healthcareapis.AnalyticsConnectorFhirServiceDataSourceResponse>;
    /**
