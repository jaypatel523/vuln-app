...
export declare class Insight extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Insight;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.impact.InsightPropertiesResponse>;
    /**
