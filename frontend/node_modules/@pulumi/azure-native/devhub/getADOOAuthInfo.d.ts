 ...
 */
export declare function getADOOAuthInfo(args: GetADOOAuthInfoArgs, opts?: pulumi.InvokeOptions): Promise<GetADOOAuthInfoResult>;
 ...
 * Other available API versions: 2024-08-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native devhub [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getADOOAuthInfoOutput(args: GetADOOAuthInfoOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetADOOAuthInfoResult>;
...
//# sourceMappingURL=getADOOAuthInfo.d.ts.map