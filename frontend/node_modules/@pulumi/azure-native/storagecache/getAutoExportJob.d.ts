 ...
 */
export declare function getAutoExportJob(args: GetAutoExportJobArgs, opts?: pulumi.InvokeOptions): Promise<GetAutoExportJobResult>;
 ...
 * Other available API versions: 2025-07-01, 2026-01-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native storagecache [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getAutoExportJobOutput(args: GetAutoExportJobOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutoExportJobResult>;
...
//# sourceMappingURL=getAutoExportJob.d.ts.map