 ...
 */
export declare function getFlowProfile(args: GetFlowProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetFlowProfileResult>;
 ...
 * Other available API versions: 2025-10-10-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native azuredatatransfer [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getFlowProfileOutput(args: GetFlowProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFlowProfileResult>;
...
//# sourceMappingURL=getFlowProfile.d.ts.map