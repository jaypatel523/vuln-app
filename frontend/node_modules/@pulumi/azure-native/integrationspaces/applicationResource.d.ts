 ...
 */
export declare class ApplicationResource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationResource;
    /**
     * Returns true if the given object is an instance of ApplicationResource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ApplicationResource;
    /**
     ...
     */
    readonly resourceKind: pulumi.Output<string | undefined>;
    /**
