 ...
 */
export declare function getDatabaseMigrationsSqlVm(args: GetDatabaseMigrationsSqlVmArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseMigrationsSqlVmResult>;
 ...
 * Other available API versions: 2025-09-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native datamigration [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getDatabaseMigrationsSqlVmOutput(args: GetDatabaseMigrationsSqlVmOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseMigrationsSqlVmResult>;
...
//# sourceMappingURL=getDatabaseMigrationsSqlVm.d.ts.map