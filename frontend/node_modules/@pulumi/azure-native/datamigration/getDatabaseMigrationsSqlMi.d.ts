 ...
 */
export declare function getDatabaseMigrationsSqlMi(args: GetDatabaseMigrationsSqlMiArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseMigrationsSqlMiResult>;
 ...
 * Other available API versions: 2025-09-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native datamigration [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getDatabaseMigrationsSqlMiOutput(args: GetDatabaseMigrationsSqlMiOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseMigrationsSqlMiResult>;
...
//# sourceMappingURL=getDatabaseMigrationsSqlMi.d.ts.map