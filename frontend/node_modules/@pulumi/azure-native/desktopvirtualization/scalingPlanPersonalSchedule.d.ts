 ...
 */
export declare class ScalingPlanPersonalSchedule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ScalingPlanPersonalSchedule;
    /**
     ...
     */
    static isInstance(obj: any): obj is ScalingPlanPersonalSchedule;
    /**
     ...
     */
    readonly offPeakActionOnDisconnect: pulumi.Output<string | undefined>;
    /**
     * Action to be taken after a logoff during the off-peak period.
     */
    readonly offPeakActionOnLogoff: pulumi.Output<string | undefined>;
    /**
     * The time in minutes to wait before performing the desired session handling action when a user disconnects during the off-peak period.
     */
    readonly offPeakMinutesToWaitOnDisconnect: pulumi.Output<number | undefined>;
    /**
     * The time in minutes to wait before performing the desired session handling action when a user logs off during the off-peak period.
     */
    readonly offPeakMinutesToWaitOnLogoff: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly offPeakStartVMOnConnect: pulumi.Output<string | undefined>;
    /**
     * Action to be taken after a user disconnect during the peak period.
     */
    readonly peakActionOnDisconnect: pulumi.Output<string | undefined>;
    /**
     * Action to be taken after a logoff during the peak period.
     */
    readonly peakActionOnLogoff: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly peakMinutesToWaitOnDisconnect: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly peakMinutesToWaitOnLogoff: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly peakStartVMOnConnect: pulumi.Output<string | undefined>;
    /**
     * Action to be taken after a user disconnect during the ramp down period.
     */
    readonly rampDownActionOnDisconnect: pulumi.Output<string | undefined>;
    /**
     * Action to be taken after a logoff during the ramp down period.
     */
    readonly rampDownActionOnLogoff: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly rampDownMinutesToWaitOnDisconnect: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly rampDownMinutesToWaitOnLogoff: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly rampDownStartVMOnConnect: pulumi.Output<string | undefined>;
    /**
     * Action to be taken after a user disconnect during the ramp up period.
     */
    readonly rampUpActionOnDisconnect: pulumi.Output<string | undefined>;
    /**
     * Action to be taken after a logoff during the ramp up period.
     */
    readonly rampUpActionOnLogoff: pulumi.Output<string | undefined>;
    /**
     * The desired startup behavior during the ramp up period for personal vms in the hostpool.
     */
    readonly rampUpAutoStartHosts: pulumi.Output<string | undefined>;
    /**
     * The time in minutes to wait before performing the desired session handling action when a user disconnects during the ramp up period.
     */
    readonly rampUpMinutesToWaitOnDisconnect: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly rampUpMinutesToWaitOnLogoff: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly rampUpStartVMOnConnect: pulumi.Output<string | undefined>;
    /**
...
//# sourceMappingURL=scalingPlanPersonalSchedule.d.ts.map