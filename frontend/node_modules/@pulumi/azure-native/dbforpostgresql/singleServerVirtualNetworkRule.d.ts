 ...
 */
export declare class SingleServerVirtualNetworkRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SingleServerVirtualNetworkRule;
    /**
     ...
     */
    static isInstance(obj: any): obj is SingleServerVirtualNetworkRule;
    /**
...
//# sourceMappingURL=singleServerVirtualNetworkRule.d.ts.map