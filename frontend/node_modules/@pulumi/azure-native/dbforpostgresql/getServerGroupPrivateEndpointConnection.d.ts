 ...
 */
export declare function getServerGroupPrivateEndpointConnection(args: GetServerGroupPrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetServerGroupPrivateEndpointConnectionResult>;
 ...
 * Other available API versions: 2022-11-08. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native dbforpostgresql [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getServerGroupPrivateEndpointConnectionOutput(args: GetServerGroupPrivateEndpointConnectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServerGroupPrivateEndpointConnectionResult>;
...
//# sourceMappingURL=getServerGroupPrivateEndpointConnection.d.ts.map