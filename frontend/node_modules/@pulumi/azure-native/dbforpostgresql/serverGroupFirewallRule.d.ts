 ...
 */
export declare class ServerGroupFirewallRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerGroupFirewallRule;
    /**
     * Returns true if the given object is an instance of ServerGroupFirewallRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ServerGroupFirewallRule;
    /**
...
//# sourceMappingURL=serverGroupFirewallRule.d.ts.map