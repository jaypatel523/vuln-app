 ...
 */
export declare function getServerGroupCluster(args: GetServerGroupClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetServerGroupClusterResult>;
...
export interface GetServerGroupClusterResult {
     ...
     */
    readonly identity?: outputs.dbforpostgresql.IdentityPropertiesResponse;
    /**
 ...
 * Other available API versions: 2022-11-08. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native dbforpostgresql [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getServerGroupClusterOutput(args: GetServerGroupClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServerGroupClusterResult>;
...
//# sourceMappingURL=getServerGroupCluster.d.ts.map