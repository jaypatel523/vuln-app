 ...
 */
export declare class ServerGroupRole extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerGroupRole;
    /**
     * Returns true if the given object is an instance of ServerGroupRole.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ServerGroupRole;
    /**
...
//# sourceMappingURL=serverGroupRole.d.ts.map