 ...
 */
export declare function getServerGroupFirewallRule(args: GetServerGroupFirewallRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetServerGroupFirewallRuleResult>;
 ...
 * Other available API versions: 2022-11-08. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native dbforpostgresql [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getServerGroupFirewallRuleOutput(args: GetServerGroupFirewallRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServerGroupFirewallRuleResult>;
...
//# sourceMappingURL=getServerGroupFirewallRule.d.ts.map