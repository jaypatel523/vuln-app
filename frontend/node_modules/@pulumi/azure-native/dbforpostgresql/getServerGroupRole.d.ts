 ...
 */
export declare function getServerGroupRole(args: GetServerGroupRoleArgs, opts?: pulumi.InvokeOptions): Promise<GetServerGroupRoleResult>;
 ...
 * Other available API versions: 2022-11-08. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native dbforpostgresql [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getServerGroupRoleOutput(args: GetServerGroupRoleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServerGroupRoleResult>;
...
//# sourceMappingURL=getServerGroupRole.d.ts.map