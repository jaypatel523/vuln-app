 ...
 */
export declare class SapInstance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SapInstance;
    /**
     * Returns true if the given object is an instance of SapInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SapInstance;
    /**
     ...
     */
    readonly errors: pulumi.Output<outputs.workloads.SAPMigrateErrorResponseV1>;
    /**
     ...
     */
    readonly landscapeSid: pulumi.Output<string>;
    /**
     ...
     */
    readonly systemSid: pulumi.Output<string>;
    /**
     * Resource tags.
     */
...
//# sourceMappingURL=sapInstance.d.ts.map