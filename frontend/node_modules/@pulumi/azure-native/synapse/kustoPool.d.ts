...
export declare class KustoPool extends pulumi.CustomResource {
     ...
     */
    readonly languageExtensions: pulumi.Output<outputs.synapse.LanguageExtensionsListResponse>;
    /**
     ...
     */
    readonly optimizedAutoscale: pulumi.Output<outputs.synapse.OptimizedAutoscaleResponse | undefined>;
    /**
     ...
     */
    readonly sku: pulumi.Output<outputs.synapse.AzureSkuResponse>;
    /**
...
export interface KustoPoolArgs {
     ...
     * The SKU of the kusto pool.
     */
    sku: pulumi.Input<inputs.synapse.AzureSkuArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
...
//# sourceMappingURL=kustoPool.d.ts.map