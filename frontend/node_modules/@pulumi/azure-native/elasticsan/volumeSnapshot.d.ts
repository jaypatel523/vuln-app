...
export declare class VolumeSnapshot extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VolumeSnapshot;
    /**
     ...
     */
    readonly creationData: pulumi.Output<outputs.elasticsan.SnapshotCreationDataResponse>;
    /**
     ...
     */
    readonly sourceVolumeSizeGiB: pulumi.Output<number>;
    /**
