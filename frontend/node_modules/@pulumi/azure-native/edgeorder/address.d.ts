...
export declare class Address extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Address;
    /**
     ...
     */
    readonly addressClassification: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly contactDetails: pulumi.Output<outputs.edgeorder.ContactDetailsResponse | undefined>;
    /**
