...
export declare class DscNodeConfiguration extends pulumi.CustomResource {
     ...
     */
    readonly configuration: pulumi.Output<outputs.automation.DscConfigurationAssociationPropertyResponse | undefined>;
    /**
...
export interface DscNodeConfigurationArgs {
     ...
     * Gets or sets the configuration of the node.
     */
    configuration: pulumi.Input<inputs.automation.DscConfigurationAssociationPropertyArgs>;
    /**
     * If a new build version of NodeConfiguration is required.
     */
...
//# sourceMappingURL=dscNodeConfiguration.d.ts.map