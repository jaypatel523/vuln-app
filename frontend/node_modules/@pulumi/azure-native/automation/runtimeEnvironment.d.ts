 ...
 */
export declare class RuntimeEnvironment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RuntimeEnvironment;
    /**
     * Returns true if the given object is an instance of RuntimeEnvironment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RuntimeEnvironment;
    /**
     ...
     */
    readonly defaultPackages: pulumi.Output<{
        [key: string]: string;
    } | undefined>;
    /**
