 ...
 */
export declare class SaasSubscriptionLevel extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SaasSubscriptionLevel;
    /**
     * Returns true if the given object is an instance of SaasSubscriptionLevel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SaasSubscriptionLevel;
    /**
     ...
     * saas properties
     */
    readonly properties: pulumi.Output<outputs.saas.SaasResourceResponseProperties>;
    /**
     * the resource tags.
     */
...
//# sourceMappingURL=saasSubscriptionLevel.d.ts.map