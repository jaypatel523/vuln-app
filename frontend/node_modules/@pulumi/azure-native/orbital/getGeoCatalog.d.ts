 ...
 */
export declare function getGeoCatalog(args: GetGeoCatalogArgs, opts?: pulumi.InvokeOptions): Promise<GetGeoCatalogResult>;
 ...
 * Other available API versions: 2024-01-31-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native orbital [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getGeoCatalogOutput(args: GetGeoCatalogOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGeoCatalogResult>;
...
//# sourceMappingURL=getGeoCatalog.d.ts.map