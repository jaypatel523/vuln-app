 ...
 */
export declare class TenantConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TenantConfiguration;
    /**
     * Returns true if the given object is an instance of TenantConfiguration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TenantConfiguration;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.portal.ConfigurationPropertiesResponse>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.portal.SystemDataResponse>;
    /**
