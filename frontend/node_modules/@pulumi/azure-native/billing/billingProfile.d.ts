 ...
 */
export declare class BillingProfile extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BillingProfile;
    /**
     * Returns true if the given object is an instance of BillingProfile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BillingProfile;
    /**
     ...
     * A billing profile.
     */
    readonly properties: pulumi.Output<outputs.billing.BillingProfilePropertiesResponse>;
    /**
