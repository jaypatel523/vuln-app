...
export interface GetDnsResourceReferenceByTarResourcesArgs {
     ...
     */
    targetResources?: inputs.dns.SubResource[];
}
/**
...
export interface GetDnsResourceReferenceByTarResourcesResult {
     ...
     */
    readonly dnsResourceReferences?: outputs.dns.DnsResourceReferenceResponse[];
}
/**
 * Returns the DNS records specified by the referencing targetResourceIds.
 *
 ...
 * Other available API versions: 2018-05-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native dns [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getDnsResourceReferenceByTarResourcesOutput(args?: GetDnsResourceReferenceByTarResourcesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDnsResourceReferenceByTarResourcesResult>;
...
//# sourceMappingURL=getDnsResourceReferenceByTarResources.d.ts.map