...
export declare const ConnectionMonitorTest: typeof import("./connectionMonitorTest").ConnectionMonitorTest;
...
export declare const getConnectionMonitorTest: typeof import("./getConnectionMonitorTest").getConnectionMonitorTest;
export declare const getConnectionMonitorTestOutput: typeof import("./getConnectionMonitorTest").getConnectionMonitorTestOutput;
export { GetPeerAsnArgs, GetPeerAsnResult, GetPeerAsnOutputArgs } from "./getPeerAsn";
export declare const getPeerAsn: typeof import("./getPeerAsn").getPeerAsn;
export declare const getPeerAsnOutput: typeof import("./getPeerAsn").getPeerAsnOutput;
...
export declare const getPeeringService: typeof import("./getPeeringService").getPeeringService;
export declare const getPeeringServiceOutput: typeof import("./getPeeringService").getPeeringServiceOutput;
export { GetPrefixArgs, GetPrefixResult, GetPrefixOutputArgs } from "./getPrefix";
export declare const getPrefix: typeof import("./getPrefix").getPrefix;
export declare const getPrefixOutput: typeof import("./getPrefix").getPrefixOutput;
export { GetRegisteredAsnArgs, GetRegisteredAsnResult, GetRegisteredAsnOutputArgs } from "./getRegisteredAsn";
export declare const getRegisteredAsn: typeof import("./getRegisteredAsn").getRegisteredAsn;
export declare const getRegisteredAsnOutput: typeof import("./getRegisteredAsn").getRegisteredAsnOutput;
export { GetRegisteredPrefixArgs, GetRegisteredPrefixResult, GetRegisteredPrefixOutputArgs } from "./getRegisteredPrefix";
export declare const getRegisteredPrefix: typeof import("./getRegisteredPrefix").getRegisteredPrefix;
export declare const getRegisteredPrefixOutput: typeof import("./getRegisteredPrefix").getRegisteredPrefixOutput;
export { PeerAsnArgs } from "./peerAsn";
export type PeerAsn = import("./peerAsn").PeerAsn;
export declare const PeerAsn: typeof import("./peerAsn").PeerAsn;
...
export declare const PeeringService: typeof import("./peeringService").PeeringService;
export { PrefixArgs } from "./prefix";
export type Prefix = import("./prefix").Prefix;
export declare const Prefix: typeof import("./prefix").Prefix;
export { RegisteredAsnArgs } from "./registeredAsn";
export type RegisteredAsn = import("./registeredAsn").RegisteredAsn;
export declare const RegisteredAsn: typeof import("./registeredAsn").RegisteredAsn;
export { RegisteredPrefixArgs } from "./registeredPrefix";
export type RegisteredPrefix = import("./registeredPrefix").RegisteredPrefix;
export declare const RegisteredPrefix: typeof import("./registeredPrefix").RegisteredPrefix;
