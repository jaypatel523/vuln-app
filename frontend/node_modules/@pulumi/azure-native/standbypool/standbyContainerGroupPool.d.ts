...
export declare class StandbyContainerGroupPool extends pulumi.CustomResource {
     ...
     */
    readonly containerGroupProperties: pulumi.Output<outputs.standbypool.ContainerGroupPropertiesResponse>;
    /**
     * Specifies elasticity profile of standby container group pools.
     */
    readonly elasticityProfile: pulumi.Output<outputs.standbypool.StandbyContainerGroupPoolElasticityProfileResponse>;
    /**
...
export interface StandbyContainerGroupPoolArgs {
     ...
     * Specifies container group properties of standby container group pools.
     */
    containerGroupProperties: pulumi.Input<inputs.standbypool.ContainerGroupPropertiesArgs>;
    /**
     * Specifies elasticity profile of standby container group pools.
     */
    elasticityProfile: pulumi.Input<inputs.standbypool.StandbyContainerGroupPoolElasticityProfileArgs>;
    /**
     * The geo-location where the resource lives
     */
...
//# sourceMappingURL=standbyContainerGroupPool.d.ts.map