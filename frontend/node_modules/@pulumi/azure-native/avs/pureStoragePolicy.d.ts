 ...
 */
export declare class PureStoragePolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PureStoragePolicy;
    /**
     * Returns true if the given object is an instance of PureStoragePolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PureStoragePolicy;
    /**
     ...
     */
    readonly storagePolicyDefinition: pulumi.Output<string>;
    /**
     * Azure resource ID of the Pure Storage Pool associated with the storage policy
     */
    readonly storagePoolId: pulumi.Output<string>;
    /**
...
//# sourceMappingURL=pureStoragePolicy.d.ts.map