 ...
 */
export declare class WorkloadNetworkVMGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkloadNetworkVMGroup;
    /**
     * Returns true if the given object is an instance of WorkloadNetworkVMGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkloadNetworkVMGroup;
    /**
...
//# sourceMappingURL=workloadNetworkVMGroup.d.ts.map