...
export declare class KeyGroup extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KeyGroup;
    /**
     ...
     */
    readonly keyReferences: pulumi.Output<outputs.cdn.ResourceReferenceResponse[] | undefined>;
    /**
     * Resource name.
     */
