 ...
 */
export declare class AFDTargetGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AFDTargetGroup;
    /**
     * Returns true if the given object is an instance of AFDTargetGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AFDTargetGroup;
    /**
     ...
     */
    readonly targetEndpoints: pulumi.Output<outputs.cdn.TargetEndpointResponse[]>;
    /**
     * Resource type.
     */
...
//# sourceMappingURL=afdtargetGroup.d.ts.map