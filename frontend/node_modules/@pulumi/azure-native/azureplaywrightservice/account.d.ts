...
export declare class Account extends pulumi.CustomResource {
     ...
     */
    readonly dashboardUri: pulumi.Output<string>;
    /**
     * When enabled, this feature allows the workspace to use local auth (through service access token) for executing operations.
     */
    readonly localAuth: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly regionalAffinity: pulumi.Output<string | undefined>;
    /**
     * When enabled, this feature allows the workspace to upload and display test results, including artifacts like traces and screenshots, in the Playwright portal. This enables faster and more efficient troubleshooting.
     */
    readonly reporting: pulumi.Output<string | undefined>;
    /**
     * When enabled, Playwright client workers can connect to cloud-hosted browsers. This can increase the number of parallel workers for a test run, significantly minimizing test completion durations.
     */
    readonly scalableExecution: pulumi.Output<string | undefined>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.azureplaywrightservice.SystemDataResponse>;
    /**
     * Resource tags.
     */
