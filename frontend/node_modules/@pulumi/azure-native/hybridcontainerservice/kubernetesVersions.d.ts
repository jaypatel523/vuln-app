 ...
 */
export declare class KubernetesVersions extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KubernetesVersions;
    /**
     * Returns true if the given object is an instance of KubernetesVersions.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is KubernetesVersions;
    /**
     ...
     */
    readonly extendedLocation: pulumi.Output<outputs.hybridcontainerservice.ExtendedLocationResponse | undefined>;
    /**
     * The name of the resource
     */
    readonly name: pulumi.Output<string>;
    readonly properties: pulumi.Output<outputs.hybridcontainerservice.KubernetesVersionProfileResponseProperties>;
    /**
...
//# sourceMappingURL=kubernetesVersions.d.ts.map