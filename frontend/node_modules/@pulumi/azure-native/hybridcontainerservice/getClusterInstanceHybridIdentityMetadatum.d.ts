 ...
 */
export declare function getClusterInstanceHybridIdentityMetadatum(args: GetClusterInstanceHybridIdentityMetadatumArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterInstanceHybridIdentityMetadatumResult>;
 ...
 * Other available API versions: 2023-11-15-preview, 2025-02-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native hybridcontainerservice [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getClusterInstanceHybridIdentityMetadatumOutput(args: GetClusterInstanceHybridIdentityMetadatumOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetClusterInstanceHybridIdentityMetadatumResult>;
...
//# sourceMappingURL=getClusterInstanceHybridIdentityMetadatum.d.ts.map