...
export declare class Client extends pulumi.CustomResource {
     ...
     */
    readonly authenticationName: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly clientCertificateAuthentication: pulumi.Output<outputs.eventgrid.ClientCertificateAuthenticationResponse | undefined>;
    /**
