...
export declare const DnsResolverDomainList: typeof import("./dnsResolverDomainList").DnsResolverDomainList;
...
export declare const DnsResolverPolicy: typeof import("./dnsResolverPolicy").DnsResolverPolicy;
...
export declare const DnsSecurityRule: typeof import("./dnsSecurityRule").DnsSecurityRule;
...
export declare const getDnsResolverDomainList: typeof import("./getDnsResolverDomainList").getDnsResolverDomainList;
export declare const getDnsResolverDomainListOutput: typeof import("./getDnsResolverDomainList").getDnsResolverDomainListOutput;
export { GetDnsResolverPolicyArgs, GetDnsResolverPolicyResult, GetDnsResolverPolicyOutputArgs } from "./getDnsResolverPolicy";
export declare const getDnsResolverPolicy: typeof import("./getDnsResolverPolicy").getDnsResolverPolicy;
export declare const getDnsResolverPolicyOutput: typeof import("./getDnsResolverPolicy").getDnsResolverPolicyOutput;
...
export declare const getDnsResolverPolicyVirtualNetworkLink: typeof import("./getDnsResolverPolicyVirtualNetworkLink").getDnsResolverPolicyVirtualNetworkLink;
export declare const getDnsResolverPolicyVirtualNetworkLinkOutput: typeof import("./getDnsResolverPolicyVirtualNetworkLink").getDnsResolverPolicyVirtualNetworkLinkOutput;
export { GetDnsSecurityRuleArgs, GetDnsSecurityRuleResult, GetDnsSecurityRuleOutputArgs } from "./getDnsSecurityRule";
export declare const getDnsSecurityRule: typeof import("./getDnsSecurityRule").getDnsSecurityRule;
export declare const getDnsSecurityRuleOutput: typeof import("./getDnsSecurityRule").getDnsSecurityRuleOutput;
...
export declare const listDnsResolverPolicyByVirtualNetwork: typeof import("./listDnsResolverPolicyByVirtualNetwork").listDnsResolverPolicyByVirtualNetwork;
export declare const listDnsResolverPolicyByVirtualNetworkOutput: typeof import("./listDnsResolverPolicyByVirtualNetwork").listDnsResolverPolicyByVirtualNetworkOutput;
