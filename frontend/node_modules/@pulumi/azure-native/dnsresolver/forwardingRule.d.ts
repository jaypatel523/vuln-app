...
export declare class ForwardingRule extends pulumi.CustomResource {
     ...
     */
    readonly targetDnsServers: pulumi.Output<outputs.dnsresolver.TargetDnsServerResponse[]>;
    /**
...
export interface ForwardingRuleArgs {
     ...
     * DNS servers to forward the DNS query to.
     */
    targetDnsServers: pulumi.Input<pulumi.Input<inputs.dnsresolver.TargetDnsServerArgs>[]>;
}
