...
export declare class OutboundEndpoint extends pulumi.CustomResource {
     ...
     */
    readonly subnet: pulumi.Output<outputs.dnsresolver.SubResourceResponse>;
    /**
...
export interface OutboundEndpointArgs {
     ...
     * The reference to the subnet used for the outbound endpoint.
     */
    subnet: pulumi.Input<inputs.dnsresolver.SubResourceArgs>;
    /**
     * Resource tags.
     */
    tags?: pulumi.Input<{
...
//# sourceMappingURL=outboundEndpoint.d.ts.map