...
export interface GetDnsForwardingRulesetResult {
     ...
     */
    readonly dnsResolverOutboundEndpoints: outputs.dnsresolver.SubResourceResponse[];
    /**
 ...
 * Other available API versions: 2020-04-01-preview, 2022-07-01, 2025-05-01, 2025-10-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native dnsresolver [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getDnsForwardingRulesetOutput(args: GetDnsForwardingRulesetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDnsForwardingRulesetResult>;
...
//# sourceMappingURL=getDnsForwardingRuleset.d.ts.map