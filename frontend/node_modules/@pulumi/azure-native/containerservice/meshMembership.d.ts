 ...
 */
export declare class MeshMembership extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MeshMembership;
    /**
     * Returns true if the given object is an instance of MeshMembership.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MeshMembership;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.containerservice.MeshMembershipPropertiesResponse>;
    /**
     ...
     */
    constructor(name: string, args: MeshMembershipArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * The set of arguments for constructing a MeshMembership resource.
 */
export interface MeshMembershipArgs {
    /**
     * The fully qualified resource ID of the resource that manages this resource. Indicates if this resource is managed by another Azure resource. If this is present, complete mode deployment will not delete the resource if it is removed from the template since it is managed by another resource.
     */
...
//# sourceMappingURL=meshMembership.d.ts.map