...
export declare class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.containerservice.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.containerservice.PrivateLinkServiceConnectionStateResponse>;
    /**
...
export interface PrivateEndpointConnectionArgs {
     ...
     * The resource of private endpoint.
     */
    privateEndpoint?: pulumi.Input<inputs.containerservice.PrivateEndpointArgs>;
    /**
     * The name of the private endpoint connection.
     */
