...
export declare class IntegrationRuntime extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.datafactory.ManagedIntegrationRuntimeResponse | outputs.datafactory.SelfHostedIntegrationRuntimeResponse>;
    /**
     * The resource type.
     */
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    properties: pulumi.Input<inputs.datafactory.ManagedIntegrationRuntimeArgs | inputs.datafactory.SelfHostedIntegrationRuntimeArgs>;
    /**
     * The resource group name.
     */
    resourceGroupName: pulumi.Input<string>;
}
//# sourceMappingURL=integrationRuntime.d.ts.map