 ...
 */
export declare class GlobalParameter extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GlobalParameter;
    /**
     * Returns true if the given object is an instance of GlobalParameter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GlobalParameter;
    /**
...
//# sourceMappingURL=globalParameter.d.ts.map