...
export declare const ClusterJob: typeof import("./clusterJob").ClusterJob;
...
export declare const EdgeMachine: typeof import("./edgeMachine").EdgeMachine;
export { EdgeMachineJobArgs } from "./edgeMachineJob";
export type EdgeMachineJob = import("./edgeMachineJob").EdgeMachineJob;
export declare const EdgeMachineJob: typeof import("./edgeMachineJob").EdgeMachineJob;
...
export declare const getClusterJob: typeof import("./getClusterJob").getClusterJob;
export declare const getClusterJobOutput: typeof import("./getClusterJob").getClusterJobOutput;
...
export declare const getDevicePool: typeof import("./getDevicePool").getDevicePool;
export declare const getDevicePoolOutput: typeof import("./getDevicePool").getDevicePoolOutput;
export { GetEdgeMachineArgs, GetEdgeMachineResult, GetEdgeMachineOutputArgs } from "./getEdgeMachine";
export declare const getEdgeMachine: typeof import("./getEdgeMachine").getEdgeMachine;
export declare const getEdgeMachineOutput: typeof import("./getEdgeMachine").getEdgeMachineOutput;
export { GetEdgeMachineJobArgs, GetEdgeMachineJobResult, GetEdgeMachineJobOutputArgs } from "./getEdgeMachineJob";
export declare const getEdgeMachineJob: typeof import("./getEdgeMachineJob").getEdgeMachineJob;
export declare const getEdgeMachineJobOutput: typeof import("./getEdgeMachineJob").getEdgeMachineJobOutput;
...
export declare const getVirtualNetworkSubnet: typeof import("./getVirtualNetworkSubnet").getVirtualNetworkSubnet;
export declare const getVirtualNetworkSubnetOutput: typeof import("./getVirtualNetworkSubnet").getVirtualNetworkSubnetOutput;
...
export declare const VirtualNetworkSubnet: typeof import("./virtualNetworkSubnet").VirtualNetworkSubnet;
