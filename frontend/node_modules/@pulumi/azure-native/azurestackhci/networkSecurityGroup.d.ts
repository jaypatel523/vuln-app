...
export declare class NetworkSecurityGroup extends pulumi.CustomResource {
     ...
     */
    readonly networkInterfaces: pulumi.Output<outputs.azurestackhci.NetworkInterfaceArmReferenceResponse[]>;
    /**
     ...
     */
    readonly status: pulumi.Output<outputs.azurestackhci.NetworkSecurityGroupStatusResponse>;
    /**
     * A collection of references to logical networks that are currently using this NSG
     */
    readonly subnets: pulumi.Output<outputs.azurestackhci.LogicalNetworkArmReferenceResponse[]>;
    /**
