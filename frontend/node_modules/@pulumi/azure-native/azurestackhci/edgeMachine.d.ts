 ...
 */
export declare class EdgeMachine extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EdgeMachine;
    /**
     * Returns true if the given object is an instance of EdgeMachine.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EdgeMachine;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.azurestackhci.EdgeMachinePropertiesResponse>;
    /**
     ...
     */
    constructor(name: string, args: EdgeMachineArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * The set of arguments for constructing a EdgeMachine resource.
 */
export interface EdgeMachineArgs {
    /**
     * Name of Device
     */
...
//# sourceMappingURL=edgeMachine.d.ts.map