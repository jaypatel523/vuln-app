...
export declare class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    readonly privateEndpoint: pulumi.Output<outputs.fileshares.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: pulumi.Output<outputs.fileshares.PrivateLinkServiceConnectionStateResponse>;
    /**
     ...
     */
    readonly systemData: pulumi.Output<outputs.fileshares.SystemDataResponse>;
    /**
...
export interface PrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: pulumi.Input<inputs.fileshares.PrivateLinkServiceConnectionStateArgs>;
    /**
