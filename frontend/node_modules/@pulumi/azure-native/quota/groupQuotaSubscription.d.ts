 ...
 */
export declare class GroupQuotaSubscription extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GroupQuotaSubscription;
    /**
     * Returns true if the given object is an instance of GroupQuotaSubscription.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GroupQuotaSubscription;
    /**
    ...
    readonly properties: pulumi.Output<outputs.quota.GroupQuotaSubscriptionIdResponseProperties>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: pulumi.Output<outputs.quota.SystemDataResponse>;
    /**
...
//# sourceMappingURL=groupQuotaSubscription.d.ts.map