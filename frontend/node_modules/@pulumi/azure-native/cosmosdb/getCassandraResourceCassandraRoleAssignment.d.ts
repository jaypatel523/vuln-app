 ...
 */
export declare function getCassandraResourceCassandraRoleAssignment(args: GetCassandraResourceCassandraRoleAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraResourceCassandraRoleAssignmentResult>;
 ...
 * Other available API versions: 2025-11-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native cosmosdb [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getCassandraResourceCassandraRoleAssignmentOutput(args: GetCassandraResourceCassandraRoleAssignmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCassandraResourceCassandraRoleAssignmentResult>;
...
//# sourceMappingURL=getCassandraResourceCassandraRoleAssignment.d.ts.map