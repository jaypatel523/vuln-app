 ...
 */
export declare function getMongoCluster(args: GetMongoClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetMongoClusterResult>;
...
export interface GetMongoClusterResult {
     ...
     */
    readonly nodeGroupSpecs?: outputs.cosmosdb.NodeGroupSpecResponse[];
    /**
 ...
 * Other available API versions: 2023-03-01-preview, 2023-03-15-preview, 2023-09-15-preview, 2023-11-15-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native cosmosdb [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getMongoClusterOutput(args: GetMongoClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMongoClusterResult>;
...
//# sourceMappingURL=getMongoCluster.d.ts.map