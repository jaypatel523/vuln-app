 ...
 */
export declare class ThroughputPool extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ThroughputPool;
    /**
     * Returns true if the given object is an instance of ThroughputPool.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ThroughputPool;
    /**
...
//# sourceMappingURL=throughputPool.d.ts.map