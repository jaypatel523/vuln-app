 ...
 */
export declare class MongoClusterFirewallRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MongoClusterFirewallRule;
    /**
     * Returns true if the given object is an instance of MongoClusterFirewallRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MongoClusterFirewallRule;
    /**
...
//# sourceMappingURL=mongoClusterFirewallRule.d.ts.map