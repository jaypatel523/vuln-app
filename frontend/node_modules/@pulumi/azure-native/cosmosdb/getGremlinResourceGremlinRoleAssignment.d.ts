 ...
 */
export declare function getGremlinResourceGremlinRoleAssignment(args: GetGremlinResourceGremlinRoleAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetGremlinResourceGremlinRoleAssignmentResult>;
 ...
 * Other available API versions: 2025-11-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native cosmosdb [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getGremlinResourceGremlinRoleAssignmentOutput(args: GetGremlinResourceGremlinRoleAssignmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGremlinResourceGremlinRoleAssignmentResult>;
...
//# sourceMappingURL=getGremlinResourceGremlinRoleAssignment.d.ts.map