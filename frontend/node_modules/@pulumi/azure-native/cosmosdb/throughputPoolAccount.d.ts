 ...
 */
export declare class ThroughputPoolAccount extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ThroughputPoolAccount;
    /**
     * Returns true if the given object is an instance of ThroughputPoolAccount.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ThroughputPoolAccount;
    /**
     * The instance id of global database account in the throughputPool.
     */
    readonly accountInstanceId: pulumi.Output<string>;
    /**
     * The location of  global database account in the throughputPool.
     */
    readonly accountLocation: pulumi.Output<string | undefined>;
    /**
     * The resource identifier of global database account in the throughputPool.
     */
    readonly accountResourceIdentifier: pulumi.Output<string | undefined>;
    /**
...
//# sourceMappingURL=throughputPoolAccount.d.ts.map