 ...
 */
export declare function getGremlinResourceGremlinRoleDefinition(args: GetGremlinResourceGremlinRoleDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetGremlinResourceGremlinRoleDefinitionResult>;
 ...
 * Other available API versions: 2025-11-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native cosmosdb [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getGremlinResourceGremlinRoleDefinitionOutput(args: GetGremlinResourceGremlinRoleDefinitionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGremlinResourceGremlinRoleDefinitionResult>;
...
//# sourceMappingURL=getGremlinResourceGremlinRoleDefinition.d.ts.map