 ...
 */
export declare class ReplicationProtectionCluster extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ReplicationProtectionCluster;
    /**
     ...
     */
    static isInstance(obj: any): obj is ReplicationProtectionCluster;
    /**
     ...
     * The custom data.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.ReplicationProtectionClusterPropertiesResponse>;
    /**
...
//# sourceMappingURL=replicationProtectionCluster.d.ts.map