...
export declare class ReplicationRecoveryPlan extends pulumi.CustomResource {
     ...
     * The custom details.
     */
    readonly properties: pulumi.Output<outputs.recoveryservices.RecoveryPlanPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationRecoveryPlanArgs {
     ...
     */
    properties: pulumi.Input<inputs.recoveryservices.CreateRecoveryPlanInputPropertiesArgs>;
    /**
     * Recovery plan name.
     */
...
//# sourceMappingURL=replicationRecoveryPlan.d.ts.map