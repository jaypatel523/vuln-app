...
export declare class ContainerGroup extends pulumi.CustomResource {
     ...
     */
    readonly containers: pulumi.Output<outputs.containerinstance.ContainerResponseV1[]>;
    /**
     ...
     */
    readonly imageRegistryCredentials: pulumi.Output<outputs.containerinstance.ImageRegistryCredentialResponseV1[] | undefined>;
    /**
     ...
     */
    readonly volumes: pulumi.Output<outputs.containerinstance.VolumeResponseV1[] | undefined>;
    /**
