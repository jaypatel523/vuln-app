 ...
 */
export declare function getSolutionVersion(args: GetSolutionVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetSolutionVersionResult>;
 ...
 * Other available API versions: 2025-08-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native edge [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getSolutionVersionOutput(args: GetSolutionVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSolutionVersionResult>;
...
//# sourceMappingURL=getSolutionVersion.d.ts.map