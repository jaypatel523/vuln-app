 ...
 */
export declare class MasterSitesController extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MasterSitesController;
    /**
     * Returns true if the given object is an instance of MasterSitesController.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MasterSitesController;
    /**
     * Gets or sets a value indicating whether multiple sites per site type are
     * allowed.
     */
    readonly allowMultipleSites: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly nestedSites: pulumi.Output<string[]>;
    /**
     * Gets the private endpoint connections.
     */
    readonly privateEndpointConnections: pulumi.Output<outputs.offazure.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    readonly sites: pulumi.Output<string[] | undefined>;
    /**
...
//# sourceMappingURL=masterSitesController.d.ts.map