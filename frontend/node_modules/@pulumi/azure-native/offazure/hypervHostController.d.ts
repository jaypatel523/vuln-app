 ...
 */
export declare class HypervHostController extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HypervHostController;
    /**
     * Returns true if the given object is an instance of HypervHostController.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is HypervHostController;
    /**
...
//# sourceMappingURL=hypervHostController.d.ts.map