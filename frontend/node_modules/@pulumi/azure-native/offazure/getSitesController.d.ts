 ...
 */
export declare function getSitesController(args: GetSitesControllerArgs, opts?: pulumi.InvokeOptions): Promise<GetSitesControllerResult>;
 ...
 * Other available API versions: 2023-06-06, 2024-05-01-preview, 2024-07-01-preview, 2024-12-01-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native offazure [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getSitesControllerOutput(args: GetSitesControllerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSitesControllerResult>;
...
//# sourceMappingURL=getSitesController.d.ts.map