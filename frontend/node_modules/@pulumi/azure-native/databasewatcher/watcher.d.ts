...
export declare class Watcher extends pulumi.CustomResource {
     ...
     */
    readonly datastore: pulumi.Output<outputs.databasewatcher.DatastoreResponse | undefined>;
    /**
     * The resource ID of a user-assigned managed identity that will be assigned to a new alert rule.
     */
    readonly defaultAlertRuleIdentityResourceId: pulumi.Output<string | undefined>;
    /**
     * The managed service identities assigned to this resource.
     */
    readonly identity: pulumi.Output<outputs.databasewatcher.ManagedServiceIdentityResponse | undefined>;
    /**
