...
export declare const AlertRuleResource: typeof import("./alertRuleResource").AlertRuleResource;
export { GetAlertRuleResourceArgs, GetAlertRuleResourceResult, GetAlertRuleResourceOutputArgs } from "./getAlertRuleResource";
export declare const getAlertRuleResource: typeof import("./getAlertRuleResource").getAlertRuleResource;
export declare const getAlertRuleResourceOutput: typeof import("./getAlertRuleResource").getAlertRuleResourceOutput;
