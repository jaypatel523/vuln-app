...
export declare class Target extends pulumi.CustomResource {
     ...
     */
    readonly properties: pulumi.Output<outputs.databasewatcher.SqlDbElasticPoolTargetPropertiesResponse | outputs.databasewatcher.SqlDbSingleDatabaseTargetPropertiesResponse | outputs.databasewatcher.SqlMiTargetPropertiesResponse | outputs.databasewatcher.SqlVmTargetPropertiesResponse>;
    /**
