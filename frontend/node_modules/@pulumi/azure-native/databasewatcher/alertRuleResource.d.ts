 ...
 */
export declare class AlertRuleResource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AlertRuleResource;
    /**
     * Returns true if the given object is an instance of AlertRuleResource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AlertRuleResource;
    /**
     * The resource ID of the alert rule resource.
     */
    readonly alertRuleResourceId: pulumi.Output<string>;
    /**
     * The template ID associated with alert rule resource.
     */
    readonly alertRuleTemplateId: pulumi.Output<string>;
    /**
     * The alert rule template version.
     */
    readonly alertRuleTemplateVersion: pulumi.Output<string>;
    /**
     ...
     */
    readonly createdWithProperties: pulumi.Output<string>;
    /**
...
//# sourceMappingURL=alertRuleResource.d.ts.map