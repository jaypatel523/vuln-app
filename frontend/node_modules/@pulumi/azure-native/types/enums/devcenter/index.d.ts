export declare const CatalogItemSyncEnableStatus: {
...
export declare const CatalogItemType: {
    readonly EnvironmentDefinition: "EnvironmentDefinition";
};
/**
 * Indicates catalog item types.
 */
export type CatalogItemType = (typeof CatalogItemType)[keyof typeof CatalogItemType];
export declare const CatalogSyncType: {
...
export declare const DevboxDisksEncryptionEnableStatus: {
    readonly Enabled: "Enabled";
    readonly Disabled: "Disabled";
};
/**
...
export declare const PlanMemberType: {
    readonly User: "User";
...
export declare const SingleSignOnStatus: {
    readonly Disabled: "Disabled";
    readonly Enabled: "Enabled";
};
/**
