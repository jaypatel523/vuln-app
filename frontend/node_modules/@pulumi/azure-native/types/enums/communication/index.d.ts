export declare const DomainManagement: {
    readonly AzureManaged: "AzureManaged";
    readonly CustomerManaged: "CustomerManaged";
    readonly CustomerManagedInExchangeOnline: "CustomerManagedInExchangeOnline";
};
/**
...
export declare const UserEngagementTracking: {
