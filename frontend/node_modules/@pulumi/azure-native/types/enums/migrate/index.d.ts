...
export declare const MigrationSpecificPropertiesInstanceType: {
...
export declare const TaskScope: {
     ...
     */
    readonly MigrationEntity: "MigrationEntity";
    /**
     * Migration Entity Group task - typically related to a specific migration entity group
     */
    readonly MigrationEntityGroup: "MigrationEntityGroup";
};
/**
 * Task Scope
 */
