...
export declare const AzureConnectionType: {
    readonly None: "None";
    readonly VPN: "VPN";
};
/**
...
export declare const DedicatedGatewayType: {
    readonly IntegratedCache: "IntegratedCache";
    readonly DistributedQuery: "DistributedQuery";
};
/**
...
export declare const DistanceFunction: {
...
export declare const FleetspaceApiKind: {
...
export declare const MongoClusterCreateMode: {
    readonly Default: "Default";
...
export declare const ServerVersion: {
    ...
    readonly ServerVersion_5_0: "5.0";
    readonly ServerVersion_6_0: "6.0";
    readonly ServerVersion_7_0: "7.0";
};
/**
...
export declare const StorageLocationType: {
    readonly StorageAccount: "StorageAccount";
    readonly FabricLakehouse: "FabricLakehouse";
};
/**
...
export declare const VectorIndexType: {
    readonly Flat: "flat";
    readonly DiskANN: "diskANN";
    readonly QuantizedFlat: "quantizedFlat";
};
/**
