...
export declare const AuthType: {
    ...
    readonly EasyAuthMicrosoftEntraID: "easyAuthMicrosoftEntraID";
};
/**
...
export declare const ClientType: {
    ...
    readonly Jms_springBoot: "jms-springBoot";
    readonly Dapr: "dapr";
};
/**
...
export declare const DaprMetadataRequired: {
    readonly True: "true";
    readonly False: "false";
};
/**
