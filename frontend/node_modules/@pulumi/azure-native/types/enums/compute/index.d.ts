export declare const AccessControlRulesMode: {
...
export declare const GalleryScriptParameterType: {
    /**
...
export declare const StorageAccountStrategy: {
    /**
     ...
     */
    readonly PreferStandard_ZRS: "PreferStandard_ZRS";
    /**
     * Choose Standard_LRS storage unless overridden by specifying regional storageAccountType.
     */
    readonly DefaultStandard_LRS: "DefaultStandard_LRS";
};
/**
...
export declare const ZonalPlatformFaultDomainAlignMode: {
    readonly Aligned: "Aligned";
    readonly Unaligned: "Unaligned";
};
/**
...
export declare const ZonePlacementPolicyType: {
    readonly Any: "Any";
};
/**
