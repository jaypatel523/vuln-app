export declare const AllowedContentLevel: {
    readonly Low: "Low";
...
export declare const ConnectionAuthType: {
    ...
    readonly AAD: "AAD";
    readonly DelegatedSAS: "DelegatedSAS";
    readonly ProjectManagedIdentity: "ProjectManagedIdentity";
    readonly AccountManagedIdentity: "AccountManagedIdentity";
    readonly UserEntraToken: "UserEntraToken";
    readonly AgentUserImpersonation: "AgentUserImpersonation";
    readonly AgenticIdentityToken: "AgenticIdentityToken";
...
export declare const ConnectionCategory: {
    ...
    readonly AzureContainerAppEnvironment: "AzureContainerAppEnvironment";
    ...
    readonly RemoteTool: "RemoteTool";
    ...
    readonly AppInsights: "AppInsights";
    ...
    readonly GroundingWithBingSearch: "GroundingWithBingSearch";
    readonly GroundingWithCustomSearch: "GroundingWithCustomSearch";
    readonly Sharepoint: "Sharepoint";
    readonly MicrosoftFabric: "MicrosoftFabric";
    readonly PowerPlatformEnvironment: "PowerPlatformEnvironment";
    readonly RemoteA2A: "RemoteA2A";
};
/**
...
export declare const ManagedNetworkKind: {
    readonly V1: "V1";
    readonly V2: "V2";
};
/**
...
export declare const RaiPolicyType: {
...
export declare const SystemDatastoresAuthMode: {
    readonly AccessKey: "AccessKey";
    readonly Identity: "Identity";
    readonly UserDelegationSAS: "UserDelegationSAS";
};
/**
