...
export declare const CertificateStoreNameOption: {
    /**
...
export declare const EphemeralType: {
    /**
...
export declare const PredictionPreference: {
    /**
     ...
     */
    readonly MostCostEffective: "MostCostEffective";
    /**
     * Halfway through cost and balanced.
     */
    readonly MoreCostEffective: "MoreCostEffective";
    /**
     * Halfway through balanced and performance.
     */
    readonly MorePerformance: "MorePerformance";
    /**
     * Optimizes for performance over cost.
     */
    readonly BestPerformance: "BestPerformance";
};
/**
...
export declare const ResourcePredictionsProfileType: {
    /**
