export declare const AzureLargeInstanceHardwareTypeNamesEnum: {
    /**
...
export declare const AzureLargeInstancePowerStateEnum: {
    /**
...
export declare const AzureLargeInstanceSizeNamesEnum: {
    /**
