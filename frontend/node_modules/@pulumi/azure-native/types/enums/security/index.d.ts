...
export declare const CloudName: {
    ...
    readonly DockerHub: "DockerHub";
    readonly JFrog: "JFrog";
};
/**
...
export declare const EnvironmentType: {
    ...
    readonly DockerHubOrganization: "DockerHubOrganization";
...
export declare const OfferingType: {
    ...
    readonly CspmMonitorDockerHub: "CspmMonitorDockerHub";
    readonly DefenderForContainersDockerHub: "DefenderForContainersDockerHub";
    readonly DefenderCspmDockerHub: "DefenderCspmDockerHub";
    readonly CspmMonitorJFrog: "CspmMonitorJFrog";
    readonly DefenderForContainersJFrog: "DefenderForContainersJFrog";
    readonly DefenderCspmJFrog: "DefenderCspmJFrog";
};
/**
