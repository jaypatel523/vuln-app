...
export declare const AffinityStrength: {
    /**
     * is should
     */
...
export declare const AzureHybridBenefitType: {
    /**
     * is SqlHost
     */
    readonly SqlHost: "SqlHost";
    /**
     * is None
     */
    readonly None: "None";
...
export declare const LicenseKind: {
    readonly VmwareFirewall: "VmwareFirewall";
};
/**
 * License kind
 */
