...
export declare const ConfidentialVmIntent: {
    /**
...
export declare const EdgeMachineJobType: {
    /**
     ...
     */
    readonly ProvisionOs: "ProvisionOs";
    /**
     * Job to download OS packages on to the device
     */
    readonly DownloadOs: "DownloadOs";
};
/**
...
export declare const EdgeMachineKind: {
    /**
...
export declare const HciJobType: {
    /**
     * Job to CVM  intent for the cluster.
     */
    readonly ConfigureCVM: "ConfigureCVM";
    /**
     * Job to configure SDN (Software Defined Networking) integration for the cluster.
     */
    readonly ConfigureSdnIntegration: "ConfigureSdnIntegration";
};
/**
 * Job Type to support polymorphic resource.
 */
...
export declare const InboundNATRuleProtocol: {
    /**
...
export declare const IpAssignmentType: {
    /**
...
export declare const LoadBalancerProbeProtocol: {
    /**
...
export declare const LoadBalancerRuleSessionPersistenceType: {
    /**
...
export declare const LoadBalancerRuleTransportProtocol: {
    /**
     * TCP - load balance only tcp traffic
     */
    readonly TCP: "Tcp";
...
export declare const OSOperationType: {
    /**
...
export declare const OnboardingResourceType: {
    /**
     * Hybrid Compute Machine.
     */
    readonly HybridComputeMachine: "HybridComputeMachine";
};
/**
...
export declare const OwnerKeyType: {
    /**
...
export declare const ProvisioningOsType: {
    /**
     * AzureLinux OS.
     */
...
export declare const PublicIPAddressType: {
    /**
     * IPv4 IP Address
     */
    readonly IPv4: "IPv4";
...
export declare const SdnIntegrationIntent: {
    /**
