...
export declare const AfdCipherSuiteSetType: {
    ...
    readonly TLS10_2019: "TLS10_2019";
    readonly TLS12_2022: "TLS12_2022";
    readonly TLS12_2023: "TLS12_2023";
};
/**
 * cipher suite set type that will be used for Https
 */
export type AfdCipherSuiteSetType = (typeof AfdCipherSuiteSetType)[keyof typeof AfdCipherSuiteSetType];
export declare const AfdCustomizedCipherSuiteForTls12: {
    readonly ECDHE_RSA_AES128_GCM_SHA256: "ECDHE_RSA_AES128_GCM_SHA256";
    readonly ECDHE_RSA_AES256_GCM_SHA384: "ECDHE_RSA_AES256_GCM_SHA384";
    readonly DHE_RSA_AES256_GCM_SHA384: "DHE_RSA_AES256_GCM_SHA384";
    readonly DHE_RSA_AES128_GCM_SHA256: "DHE_RSA_AES128_GCM_SHA256";
    readonly ECDHE_RSA_AES128_SHA256: "ECDHE_RSA_AES128_SHA256";
    readonly ECDHE_RSA_AES256_SHA384: "ECDHE_RSA_AES256_SHA384";
};
...
export declare const AfdCustomizedCipherSuiteForTls13: {
...
export declare const AgentPathType: {
    readonly Chat: "Chat";
...
export declare const DeliveryRuleActionName: {
...
export declare const DeliveryRuleActionParametersType: {
    readonly DeliveryRuleUrlRedirectActionParameters: "DeliveryRuleUrlRedirectActionParameters";
    readonly DeliveryRuleUrlSigningActionParameters: "DeliveryRuleUrlSigningActionParameters";
    readonly DeliveryRuleOriginGroupOverrideActionParameters: "DeliveryRuleOriginGroupOverrideActionParameters";
    readonly DeliveryRuleUrlRewriteActionParameters: "DeliveryRuleUrlRewriteActionParameters";
    readonly DeliveryRuleHeaderActionParameters: "DeliveryRuleHeaderActionParameters";
    readonly DeliveryRuleCacheExpirationActionParameters: "DeliveryRuleCacheExpirationActionParameters";
    readonly DeliveryRuleCacheKeyQueryStringBehaviorActionParameters: "DeliveryRuleCacheKeyQueryStringBehaviorActionParameters";
    readonly DeliveryRuleRouteConfigurationOverrideActionParameters: "DeliveryRuleRouteConfigurationOverrideActionParameters";
};
...
export declare const DeliveryRuleConditionParametersType: {
    readonly DeliveryRuleRemoteAddressConditionParameters: "DeliveryRuleRemoteAddressConditionParameters";
    readonly DeliveryRuleRequestMethodConditionParameters: "DeliveryRuleRequestMethodConditionParameters";
    readonly DeliveryRuleQueryStringConditionParameters: "DeliveryRuleQueryStringConditionParameters";
    readonly DeliveryRulePostArgsConditionParameters: "DeliveryRulePostArgsConditionParameters";
    readonly DeliveryRuleRequestUriConditionParameters: "DeliveryRuleRequestUriConditionParameters";
    readonly DeliveryRuleRequestHeaderConditionParameters: "DeliveryRuleRequestHeaderConditionParameters";
    readonly DeliveryRuleRequestBodyConditionParameters: "DeliveryRuleRequestBodyConditionParameters";
    readonly DeliveryRuleRequestSchemeConditionParameters: "DeliveryRuleRequestSchemeConditionParameters";
    readonly DeliveryRuleUrlPathMatchConditionParameters: "DeliveryRuleUrlPathMatchConditionParameters";
    readonly DeliveryRuleUrlFileExtensionMatchConditionParameters: "DeliveryRuleUrlFileExtensionMatchConditionParameters";
    readonly DeliveryRuleUrlFilenameConditionParameters: "DeliveryRuleUrlFilenameConditionParameters";
    readonly DeliveryRuleHttpVersionConditionParameters: "DeliveryRuleHttpVersionConditionParameters";
    readonly DeliveryRuleCookiesConditionParameters: "DeliveryRuleCookiesConditionParameters";
    readonly DeliveryRuleIsDeviceConditionParameters: "DeliveryRuleIsDeviceConditionParameters";
    readonly DeliveryRuleSocketAddrConditionParameters: "DeliveryRuleSocketAddrConditionParameters";
    readonly DeliveryRuleClientPortConditionParameters: "DeliveryRuleClientPortConditionParameters";
    readonly DeliveryRuleServerPortConditionParameters: "DeliveryRuleServerPortConditionParameters";
    readonly DeliveryRuleHostNameConditionParameters: "DeliveryRuleHostNameConditionParameters";
    readonly DeliveryRuleSslProtocolConditionParameters: "DeliveryRuleSslProtocolConditionParameters";
};
...
export declare const EdgeActionIsDefaultVersion: {
    /**
...
export declare const EdgeActionVersionDeploymentType: {
    /**
     * ZIP file deployment
     */
    readonly Zip: "zip";
...
export declare const IsDeviceMatchValue: {
...
export declare const KeyVaultSigningKeyParametersType: {
    readonly KeyVaultSigningKeyParameters: "KeyVaultSigningKeyParameters";
};
...
export declare const KnowledgeSourceType: {
    readonly SchemaOrgMarkup: "SchemaOrgMarkup";
...
export declare const KnowledgeSourceUpdateFrequency: {
    readonly EverySixHours: "EverySixHours";
...
export declare const OriginAuthenticationType: {
...
export declare const ProfileScrubbingState: {
    readonly Enabled: "Enabled";
    readonly Disabled: "Disabled";
};
/**
...
export declare const RequestMethodMatchValue: {
    readonly GET: "GET";
    readonly HEAD: "HEAD";
    readonly POST: "POST";
    readonly PUT: "PUT";
...
export declare const RequestSchemeMatchConditionParametersOperator: {
    readonly Equal: "Equal";
};
/**
 * Describes operator to be matched
...
export declare const RequestSchemeMatchValue: {
    readonly HTTP: "HTTP";
    readonly HTTPS: "HTTPS";
};
...
export declare const TunnelType: {
    readonly HttpConnect: "HttpConnect";
};
/**
