...
export declare const HealthErrorCustomerResolvability: {
...
export declare const MultiVmGroupCreateOption: {
    readonly AutoCreated: "AutoCreated";
    readonly UserSpecified: "UserSpecified";
};
/**
