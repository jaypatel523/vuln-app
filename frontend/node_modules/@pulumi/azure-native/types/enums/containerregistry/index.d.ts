...
export declare const AzureADAuthenticationAsArmPolicyStatus: {
    readonly Enabled: "enabled";
    readonly Disabled: "disabled";
};
/**
...
export declare const CredentialName: {
    readonly Credential1: "Credential1";
};
/**
...
export declare const PackageSourceType: {
