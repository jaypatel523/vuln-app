export declare const EncryptionConfigType: {
...
export declare const EncryptionIdentityType: {
...
export declare const TierType: {
    ...
    readonly Commitment_1TB: "Commitment_1TB";
    readonly Commitment_10TB: "Commitment_10TB";
    readonly Commitment_100TB: "Commitment_100TB";
    readonly Commitment_500TB: "Commitment_500TB";
    readonly Commitment_1PB: "Commitment_1PB";
    readonly Commitment_5PB: "Commitment_5PB";
};
/**
 * The commitment tier to use for next month.
 */
export type TierType = (typeof TierType)[keyof typeof TierType];
export declare const TrustedIdProviderState: {
    readonly Enabled: "Enabled";
    readonly Disabled: "Disabled";
};
/**
