 ...
 */
export declare function getIspCacheNodesOperation(args: GetIspCacheNodesOperationArgs, opts?: pulumi.InvokeOptions): Promise<GetIspCacheNodesOperationResult>;
 ...
 * Other available API versions: 2024-11-30-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native connectedcache [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getIspCacheNodesOperationOutput(args: GetIspCacheNodesOperationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIspCacheNodesOperationResult>;
...
//# sourceMappingURL=getIspCacheNodesOperation.d.ts.map