 ...
 */
export declare function getIspCacheNodesOperationBgpCidrs(args: GetIspCacheNodesOperationBgpCidrsArgs, opts?: pulumi.InvokeOptions): Promise<GetIspCacheNodesOperationBgpCidrsResult>;
 ...
 * Other available API versions: 2024-11-30-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native connectedcache [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getIspCacheNodesOperationBgpCidrsOutput(args: GetIspCacheNodesOperationBgpCidrsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIspCacheNodesOperationBgpCidrsResult>;
...
//# sourceMappingURL=getIspCacheNodesOperationBgpCidrs.d.ts.map