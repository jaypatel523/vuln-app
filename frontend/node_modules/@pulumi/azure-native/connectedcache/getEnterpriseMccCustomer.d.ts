 ...
 */
export declare function getEnterpriseMccCustomer(args: GetEnterpriseMccCustomerArgs, opts?: pulumi.InvokeOptions): Promise<GetEnterpriseMccCustomerResult>;
 ...
 * Other available API versions: 2024-11-30-preview. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native connectedcache [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export declare function getEnterpriseMccCustomerOutput(args: GetEnterpriseMccCustomerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEnterpriseMccCustomerResult>;
...
//# sourceMappingURL=getEnterpriseMccCustomer.d.ts.map