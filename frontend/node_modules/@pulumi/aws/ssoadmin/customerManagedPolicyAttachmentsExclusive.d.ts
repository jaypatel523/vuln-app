 ...
 * ```
 */
export declare class CustomerManagedPolicyAttachmentsExclusive extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CustomerManagedPolicyAttachmentsExclusiveState, opts?: pulumi.CustomResourceOptions): CustomerManagedPolicyAttachmentsExclusive;
    /**
     ...
     */
    static isInstance(obj: any): obj is CustomerManagedPolicyAttachmentsExclusive;
    /**
     * Specifies the names and paths of the customer managed policies to attach. See Customer Managed Policy Reference below.
     */
    readonly customerManagedPolicyReferences: pulumi.Output<outputs.ssoadmin.CustomerManagedPolicyAttachmentsExclusiveCustomerManagedPolicyReference[] | undefined>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.ssoadmin.CustomerManagedPolicyAttachmentsExclusiveTimeouts | undefined>;
    /**
...
//# sourceMappingURL=customerManagedPolicyAttachmentsExclusive.d.ts.map