 ...
 * ```
 */
export declare class ManagedPolicyAttachmentsExclusive extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedPolicyAttachmentsExclusiveState, opts?: pulumi.CustomResourceOptions): ManagedPolicyAttachmentsExclusive;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagedPolicyAttachmentsExclusive;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.ssoadmin.ManagedPolicyAttachmentsExclusiveTimeouts | undefined>;
    /**
...
//# sourceMappingURL=managedPolicyAttachmentsExclusive.d.ts.map