...
class OrganizationConfiguration extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new OrganizationConfiguration(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:inspector2/organizationConfiguration:OrganizationConfiguration';
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["maxAccountLimitReached"] = state?.maxAccountLimitReached;
