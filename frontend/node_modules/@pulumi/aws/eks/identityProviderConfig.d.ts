...
export declare class IdentityProviderConfig extends pulumi.CustomResource {
    ...
    readonly identityProviderConfigName: pulumi.Output<string>;
    /**
...
export interface IdentityProviderConfigState {
     ...
     * Nested attribute containing [OpenID Connect](https://openid.net/connect/) identity provider information for the cluster. Detailed below.
     */
    oidc?: pulumi.Input<inputs.eks.IdentityProviderConfigOidc | undefined>;
    /**
     * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
     */
...
//# sourceMappingURL=identityProviderConfig.d.ts.map