...
export interface GetInfrastructureConfigurationsOutputArgs {
     ...
     * Configuration block(s) for filtering. Detailed below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.imagebuilder.GetInfrastructureConfigurationsFilterArgs>[] | undefined>;
    /**
     * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
     */
    region?: pulumi.Input<string | undefined>;
}
//# sourceMappingURL=getInfrastructureConfigurations.d.ts.map