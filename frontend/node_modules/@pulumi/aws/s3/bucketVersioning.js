...
exports.BucketVersioning = void 0;
 ...
 * ```
 */
class BucketVersioning extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BucketVersioning(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:s3/bucketVersioning:BucketVersioning';
    /**
...
//# sourceMappingURL=bucketVersioning.js.map