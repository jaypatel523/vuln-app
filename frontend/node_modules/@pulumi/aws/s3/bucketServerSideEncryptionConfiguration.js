...
exports.BucketServerSideEncryptionConfiguration = void 0;
 ...
 * ```
 */
class BucketServerSideEncryptionConfiguration extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BucketServerSideEncryptionConfiguration(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:s3/bucketServerSideEncryptionConfiguration:BucketServerSideEncryptionConfiguration';
    /**
...
exports.BucketServerSideEncryptionConfiguration = BucketServerSideEncryptionConfiguration;
//# sourceMappingURL=bucketServerSideEncryptionConfiguration.js.map