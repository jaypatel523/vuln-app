    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws:s3/bucketAbac:BucketAbac":
                return new exports.BucketAbac(name, undefined, { urn });
            ...
            case "aws:s3/filesAccessPoint:FilesAccessPoint":
                return new exports.FilesAccessPoint(name, undefined, { urn });
            case "aws:s3/filesFileSystem:FilesFileSystem":
                return new exports.FilesFileSystem(name, undefined, { urn });
            case "aws:s3/filesFileSystemPolicy:FilesFileSystemPolicy":
                return new exports.FilesFileSystemPolicy(name, undefined, { urn });
            case "aws:s3/filesMountTarget:FilesMountTarget":
                return new exports.FilesMountTarget(name, undefined, { urn });
            case "aws:s3/filesSynchronizationConfiguration:FilesSynchronizationConfiguration":
                return new exports.FilesSynchronizationConfiguration(name, undefined, { urn });
            ...
            case "aws:s3/vectorsIndex:VectorsIndex":
                return new exports.VectorsIndex(name, undefined, { urn });
            case "aws:s3/vectorsVectorBucket:VectorsVectorBucket":
                return new exports.VectorsVectorBucket(name, undefined, { urn });
            case "aws:s3/vectorsVectorBucketPolicy:VectorsVectorBucketPolicy":
                return new exports.VectorsVectorBucketPolicy(name, undefined, { urn });
            default:
