...
export declare const BucketAbac: typeof import("./bucketAbac").BucketAbac;
...
export declare const FilesAccessPoint: typeof import("./filesAccessPoint").FilesAccessPoint;
...
export declare const FilesFileSystem: typeof import("./filesFileSystem").FilesFileSystem;
...
export declare const FilesFileSystemPolicy: typeof import("./filesFileSystemPolicy").FilesFileSystemPolicy;
...
export declare const FilesMountTarget: typeof import("./filesMountTarget").FilesMountTarget;
...
export declare const FilesSynchronizationConfiguration: typeof import("./filesSynchronizationConfiguration").FilesSynchronizationConfiguration;
...
export declare const getFilesAccessPoint: typeof import("./getFilesAccessPoint").getFilesAccessPoint;
export declare const getFilesAccessPointOutput: typeof import("./getFilesAccessPoint").getFilesAccessPointOutput;
export { GetFilesFileSystemArgs, GetFilesFileSystemResult, GetFilesFileSystemOutputArgs } from "./getFilesFileSystem";
export declare const getFilesFileSystem: typeof import("./getFilesFileSystem").getFilesFileSystem;
export declare const getFilesFileSystemOutput: typeof import("./getFilesFileSystem").getFilesFileSystemOutput;
export { GetFilesFileSystemsArgs, GetFilesFileSystemsResult, GetFilesFileSystemsOutputArgs } from "./getFilesFileSystems";
export declare const getFilesFileSystems: typeof import("./getFilesFileSystems").getFilesFileSystems;
export declare const getFilesFileSystemsOutput: typeof import("./getFilesFileSystems").getFilesFileSystemsOutput;
export { GetFilesMountTargetArgs, GetFilesMountTargetResult, GetFilesMountTargetOutputArgs } from "./getFilesMountTarget";
export declare const getFilesMountTarget: typeof import("./getFilesMountTarget").getFilesMountTarget;
export declare const getFilesMountTargetOutput: typeof import("./getFilesMountTarget").getFilesMountTargetOutput;
...
export declare const VectorsIndex: typeof import("./vectorsIndex").VectorsIndex;
...
export declare const VectorsVectorBucket: typeof import("./vectorsVectorBucket").VectorsVectorBucket;
...
export declare const VectorsVectorBucketPolicy: typeof import("./vectorsVectorBucketPolicy").VectorsVectorBucketPolicy;
