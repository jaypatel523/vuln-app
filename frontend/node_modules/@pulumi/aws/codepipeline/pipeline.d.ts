...
export declare class Pipeline extends pulumi.CustomResource {
     ...
     */
    readonly triggerAlls: pulumi.Output<outputs.codepipeline.PipelineTriggerAll[]>;
    /**
     * A trigger block. Valid only when `pipelineType` is `V2`. Triggers are documented below.
     */
    readonly triggers: pulumi.Output<outputs.codepipeline.PipelineTrigger[] | undefined>;
    /**
