...
export interface HsmClientCertificateState {
     ...
     * The identifier of the HSM client certificate.
     */
    hsmClientCertificateIdentifier?: pulumi.Input<string | undefined>;
    /**
     * The public key that the Amazon Redshift cluster will use to connect to the HSM. You must register the public key in the HSM.
     */
    hsmClientCertificatePublicKey?: pulumi.Input<string | undefined>;
    /**
     * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
     */
...
//# sourceMappingURL=hsmClientCertificate.d.ts.map