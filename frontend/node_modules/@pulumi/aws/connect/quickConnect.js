...
class QuickConnect extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new QuickConnect(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:connect/quickConnect:QuickConnect';
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["quickConnectConfig"] = state?.quickConnectConfig;
            resourceInputs["quickConnectId"] = state?.quickConnectId;
