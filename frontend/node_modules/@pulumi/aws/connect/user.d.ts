...
export interface UserState {
     ...
     * A block that contains information about the identity of the user. Documented below.
     */
    identityInfo?: pulumi.Input<inputs.connect.UserIdentityInfo | undefined>;
    /**
     * Specifies the identifier of the hosting Amazon Connect Instance.
     */
     ...
     * A block that contains information about the phone settings for the user. Documented below.
     */
    phoneConfig?: pulumi.Input<inputs.connect.UserPhoneConfig | undefined>;
    /**
     * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
     */
     ...
     * A list of identifiers for the security profiles for the user. Specify a minimum of 1 and maximum of 10 security profile ids. For more information, see [Best Practices for Security Profiles](https://docs.aws.amazon.com/connect/latest/adminguide/security-profile-best-practices.html) in the Amazon Connect Administrator Guide.
     */
    securityProfileIds?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * Tags to apply to the user. If configured with a provider
     * `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
     */
