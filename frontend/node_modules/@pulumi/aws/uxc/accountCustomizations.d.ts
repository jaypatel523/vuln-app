 ...
 * ```
 */
export declare class AccountCustomizations extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccountCustomizationsState, opts?: pulumi.CustomResourceOptions): AccountCustomizations;
    /**
     * Returns true if the given object is an instance of AccountCustomizations.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AccountCustomizations;
    /**
...
//# sourceMappingURL=accountCustomizations.d.ts.map