 ...
 * ```
 */
export declare class VolumeCopy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VolumeCopyState, opts?: pulumi.CustomResourceOptions): VolumeCopy;
    /**
     * Returns true if the given object is an instance of VolumeCopy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VolumeCopy;
    /**
     ...
     */
    readonly sourceVolumeId: pulumi.Output<string>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.ebs.VolumeCopyTimeouts | undefined>;
    /**
...
//# sourceMappingURL=volumeCopy.d.ts.map