 ...
 * ```
 */
export declare class TargetAccountConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TargetAccountConfigurationState, opts?: pulumi.CustomResourceOptions): TargetAccountConfiguration;
    /**
     ...
     */
    static isInstance(obj: any): obj is TargetAccountConfiguration;
    /**
     ...
     */
    readonly experimentTemplateId: pulumi.Output<string>;
    /**
...
export interface TargetAccountConfigurationState {
     ...
     * The following arguments are optional:
     */
    experimentTemplateId?: pulumi.Input<string | undefined>;
    /**
     * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
     */
