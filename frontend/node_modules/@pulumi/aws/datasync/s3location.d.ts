 ...
 * ```
 */
export declare class S3Location extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: S3LocationState, opts?: pulumi.CustomResourceOptions): S3Location;
    /**
     * Returns true if the given object is an instance of S3Location.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is S3Location;
    /**
     ...
     */
    readonly s3Config: pulumi.Output<outputs.datasync.S3LocationS3Config>;
    /**
     ...
     */
    readonly s3StorageClass: pulumi.Output<string>;
    /**
...
export interface S3LocationState {
     ...
     * Configuration block containing information for connecting to S3.
     */
    s3Config?: pulumi.Input<inputs.datasync.S3LocationS3Config | undefined>;
    /**
     * Amazon S3 storage class that you want to store your files in when this location is used as a task destination. [Valid values](https://docs.aws.amazon.com/datasync/latest/userguide/create-s3-location.html#using-storage-classes)
     */
    s3StorageClass?: pulumi.Input<string | undefined>;
    /**
     * Prefix to perform actions as source or destination.
     */
...
//# sourceMappingURL=s3location.d.ts.map