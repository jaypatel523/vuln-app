 ...
 * ```
 */
export declare class AwsServiceAccess extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AwsServiceAccessState, opts?: pulumi.CustomResourceOptions): AwsServiceAccess;
    /**
     * Returns true if the given object is an instance of AwsServiceAccess.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AwsServiceAccess;
    /**
     * Date and time that the service was enabled, in RFC 3339 format.
     */
    readonly dateEnabled: pulumi.Output<string>;
    /**
...
//# sourceMappingURL=awsServiceAccess.d.ts.map