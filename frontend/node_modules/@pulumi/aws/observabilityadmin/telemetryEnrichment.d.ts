 ...
 * ```
 */
export declare class TelemetryEnrichment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TelemetryEnrichmentState, opts?: pulumi.CustomResourceOptions): TelemetryEnrichment;
    /**
     * Returns true if the given object is an instance of TelemetryEnrichment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TelemetryEnrichment;
    /**
     * ARN of the AWS Resource Explorer managed view created for the telemetry enrichment feature.
     */
    readonly awsResourceExplorerManagedViewArn: pulumi.Output<string>;
    /**
     * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
     */
    readonly region: pulumi.Output<string>;
    readonly timeouts: pulumi.Output<outputs.observabilityadmin.TelemetryEnrichmentTimeouts | undefined>;
    /**
...
//# sourceMappingURL=telemetryEnrichment.d.ts.map