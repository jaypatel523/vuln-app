 ...
 * ```
 */
export declare class TelemetryEvaluation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TelemetryEvaluationState, opts?: pulumi.CustomResourceOptions): TelemetryEvaluation;
    /**
     * Returns true if the given object is an instance of TelemetryEvaluation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TelemetryEvaluation;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.observabilityadmin.TelemetryEvaluationTimeouts | undefined>;
    /**
     ...
     */
    constructor(name: string, args?: TelemetryEvaluationArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering TelemetryEvaluation resources.
 */
export interface TelemetryEvaluationState {
    /**
     * Reason for the failure status. Only populated if `status` is `FAILED_START` or `FAILED_STOP`.
     */
    ...
    timeouts?: pulumi.Input<inputs.observabilityadmin.TelemetryEvaluationTimeouts | undefined>;
}
/**
 * The set of arguments for constructing a TelemetryEvaluation resource.
 */
export interface TelemetryEvaluationArgs {
    /**
     * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
     */
    region?: pulumi.Input<string | undefined>;
...
//# sourceMappingURL=telemetryEvaluation.d.ts.map