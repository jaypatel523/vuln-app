...
export declare const Activation: typeof import("./activation").Activation;
...
export declare const ContactsRotation: typeof import("./contactsRotation").ContactsRotation;
...
export declare const DefaultPatchBaseline: typeof import("./defaultPatchBaseline").DefaultPatchBaseline;
...
export declare const getContactsRotation: typeof import("./getContactsRotation").getContactsRotation;
export declare const getContactsRotationOutput: typeof import("./getContactsRotation").getContactsRotationOutput;
...
export declare const getMaintenanceWindows: typeof import("./getMaintenanceWindows").getMaintenanceWindows;
export declare const getMaintenanceWindowsOutput: typeof import("./getMaintenanceWindows").getMaintenanceWindowsOutput;
...
export declare const getParametersByPath: typeof import("./getParametersByPath").getParametersByPath;
export declare const getParametersByPathOutput: typeof import("./getParametersByPath").getParametersByPathOutput;
export { GetPatchBaselineArgs, GetPatchBaselineResult, GetPatchBaselineOutputArgs } from "./getPatchBaseline";
export declare const getPatchBaseline: typeof import("./getPatchBaseline").getPatchBaseline;
export declare const getPatchBaselineOutput: typeof import("./getPatchBaseline").getPatchBaselineOutput;
export { GetPatchBaselinesArgs, GetPatchBaselinesResult, GetPatchBaselinesOutputArgs } from "./getPatchBaselines";
export declare const getPatchBaselines: typeof import("./getPatchBaselines").getPatchBaselines;
export declare const getPatchBaselinesOutput: typeof import("./getPatchBaselines").getPatchBaselinesOutput;
...
export declare const PatchGroup: typeof import("./patchGroup").PatchGroup;
...
export declare const QuicksetupConfigurationManager: typeof import("./quicksetupConfigurationManager").QuicksetupConfigurationManager;
...
export declare const ResourceDataSync: typeof import("./resourceDataSync").ResourceDataSync;
