...
class ApplicationLayerAutomaticResponse extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ApplicationLayerAutomaticResponse(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:shield/applicationLayerAutomaticResponse:ApplicationLayerAutomaticResponse';
    /**
