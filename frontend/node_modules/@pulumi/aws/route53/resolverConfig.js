...
class ResolverConfig extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ResolverConfig(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:route53/resolverConfig:ResolverConfig';
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["autodefinedReverseFlag"] = state?.autodefinedReverseFlag;
