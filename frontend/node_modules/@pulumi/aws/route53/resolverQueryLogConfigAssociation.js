...
class ResolverQueryLogConfigAssociation extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ResolverQueryLogConfigAssociation(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:route53/resolverQueryLogConfigAssociation:ResolverQueryLogConfigAssociation';
    /**
