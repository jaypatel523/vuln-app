    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws:route53/recordsExclusive:RecordsExclusive":
                return new exports.RecordsExclusive(name, undefined, { urn });
