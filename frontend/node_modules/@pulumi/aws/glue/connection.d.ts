...
export declare class Connection extends pulumi.CustomResource {
     ...
     */
    readonly athenaProperties: pulumi.Output<{
        [key: string]: string;
    } | undefined>;
    /**
     * Configuration block for authentication options. See `authenticationConfiguration` below.
     */
    readonly authenticationConfiguration: pulumi.Output<outputs.glue.ConnectionAuthenticationConfiguration | undefined>;
    /**
