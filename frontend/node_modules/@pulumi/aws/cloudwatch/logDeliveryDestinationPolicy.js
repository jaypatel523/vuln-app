...
class LogDeliveryDestinationPolicy extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new LogDeliveryDestinationPolicy(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:cloudwatch/logDeliveryDestinationPolicy:LogDeliveryDestinationPolicy';
    /**
