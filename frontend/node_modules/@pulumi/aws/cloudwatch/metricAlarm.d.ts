...
export declare class MetricAlarm extends pulumi.CustomResource {
     ...
     */
    readonly evaluationCriteria: pulumi.Output<outputs.cloudwatch.MetricAlarmEvaluationCriteria | undefined>;
    /**
     ...
     */
    readonly evaluationInterval: pulumi.Output<number | undefined>;
    /**
     * The number of periods over which data is compared to the specified threshold. Required for traditional metric alarms.
     */
    readonly evaluationPeriods: pulumi.Output<number | undefined>;
    /**
...
//# sourceMappingURL=metricAlarm.d.ts.map