 ...
 * ```
 */
export declare class GcmChannel extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GcmChannelState, opts?: pulumi.CustomResourceOptions): GcmChannel;
    /**
     * Returns true if the given object is an instance of GcmChannel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GcmChannel;
    /**
    ...
    readonly serviceJson: pulumi.Output<string | undefined>;
    /**
...
//# sourceMappingURL=gcmChannel.d.ts.map