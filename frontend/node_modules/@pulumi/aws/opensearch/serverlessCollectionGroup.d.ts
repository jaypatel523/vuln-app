 ...
 * ```
 */
export declare class ServerlessCollectionGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServerlessCollectionGroupState, opts?: pulumi.CustomResourceOptions): ServerlessCollectionGroup;
    /**
     ...
     */
    static isInstance(obj: any): obj is ServerlessCollectionGroup;
    /**
     ...
     */
    readonly capacityLimits: pulumi.Output<outputs.opensearch.ServerlessCollectionGroupCapacityLimit[]>;
    /**
...
//# sourceMappingURL=serverlessCollectionGroup.d.ts.map