 ...
 * ## Import
 *
 * Using `pulumi import`, import OpenSearch Authorize Vpc Endpoint Access using the `domainName` and `account` separated by a comma (,). For example:
 *
 * ```sh
...
//# sourceMappingURL=authorizeVpcEndpointAccess.d.ts.map