...
exports.EncryptionControl = null;
...
exports.getServiceLinkVirtualInterface = null;
exports.getServiceLinkVirtualInterfaceOutput = null;
...
exports.getServiceLinkVirtualInterfaces = null;
exports.getServiceLinkVirtualInterfacesOutput = null;
...
exports.VpcEncryptionControl = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws:ec2/encryptionControl:EncryptionControl":
                return new exports.EncryptionControl(name, undefined, { urn });
            ...
            case "aws:ec2/secondaryNetwork:SecondaryNetwork":
                return new exports.SecondaryNetwork(name, undefined, { urn });
            case "aws:ec2/secondarySubnet:SecondarySubnet":
                return new exports.SecondarySubnet(name, undefined, { urn });
            ...
            case "aws:ec2/vpcEncryptionControl:VpcEncryptionControl":
                return new exports.VpcEncryptionControl(name, undefined, { urn });
            ...
            case "aws:ec2/vpcSecurityGroupRulesExclusive:VpcSecurityGroupRulesExclusive":
                return new exports.VpcSecurityGroupRulesExclusive(name, undefined, { urn });
            case "aws:ec2/vpnConcentrator:VpnConcentrator":
                return new exports.VpnConcentrator(name, undefined, { urn });
