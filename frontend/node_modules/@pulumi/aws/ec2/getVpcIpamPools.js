...
exports.getVpcIpamPoolsOutput = exports.getVpcIpamPools = void 0;
 ...
 * ```
 */
function getVpcIpamPools(args, opts) {
    args = args || {};
...
exports.getVpcIpamPools = getVpcIpamPools;
/**
 * `aws.ec2.getVpcIpamPools` provides details about IPAM pools.
 *
 * This resource can prove useful when IPAM pools are created in another root
 ...
 * ```
 */
function getVpcIpamPoolsOutput(args, opts) {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getVpcIpamPoolsOutput = getVpcIpamPoolsOutput;
//# sourceMappingURL=getVpcIpamPools.js.map