 ...
 * ```
 */
export declare class ManagedPrefixListEntry extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedPrefixListEntryState, opts?: pulumi.CustomResourceOptions): ManagedPrefixListEntry;
    /**
     * Returns true if the given object is an instance of ManagedPrefixListEntry.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ManagedPrefixListEntry;
    /**
...
//# sourceMappingURL=managedPrefixListEntry.d.ts.map