...
export declare class VpcEncryptionControl extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcEncryptionControlState, opts?: pulumi.CustomResourceOptions): VpcEncryptionControl;
    /**
     ...
     */
    readonly egressOnlyInternetGatewayExclusion: pulumi.Output<string>;
    /**
     ...
     * Only valid when `mode` is `enforce`.
     */
    readonly elasticFileSystemExclusion: pulumi.Output<string>;
    /**
     ...
     * Only valid when `mode` is `enforce`.
     */
    readonly internetGatewayExclusion: pulumi.Output<string>;
    /**
     ...
     * Only valid when `mode` is `enforce`.
     */
    readonly lambdaExclusion: pulumi.Output<string>;
    /**
     ...
     * Only valid when `mode` is `enforce`.
     */
    readonly natGatewayExclusion: pulumi.Output<string>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.ec2.VpcEncryptionControlTimeouts | undefined>;
    /**
     ...
     * Only valid when `mode` is `enforce`.
     */
    readonly virtualPrivateGatewayExclusion: pulumi.Output<string>;
    /**
     ...
     * Only valid when `mode` is `enforce`.
     */
    readonly vpcLatticeExclusion: pulumi.Output<string>;
    /**
     ...
     * Only valid when `mode` is `enforce`.
     */
    readonly vpcPeeringExclusion: pulumi.Output<string>;
    /**
...
//# sourceMappingURL=vpcEncryptionControl.d.ts.map