 ...
 * ```
 */
export declare class SecondarySubnet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecondarySubnetState, opts?: pulumi.CustomResourceOptions): SecondarySubnet;
    /**
     * Returns true if the given object is an instance of SecondarySubnet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SecondarySubnet;
    /**
     ...
     */
    readonly ipv4CidrBlock: pulumi.Output<string>;
    /**
     * A list of IPv4 CIDR block associations for the secondary network.
     */
    readonly ipv4CidrBlockAssociations: pulumi.Output<outputs.ec2.SecondarySubnetIpv4CidrBlockAssociation[]>;
    /**
     ...
     */
    readonly secondaryNetworkId: pulumi.Output<string>;
    /**
     * Type of the secondary network (e.g., `rdma`).
     */
    readonly secondaryNetworkType: pulumi.Output<string>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.ec2.SecondarySubnetTimeouts | undefined>;
    /**
...
//# sourceMappingURL=secondarySubnet.d.ts.map