...
class VpcEndpointRouteTableAssociation extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new VpcEndpointRouteTableAssociation(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:ec2/vpcEndpointRouteTableAssociation:VpcEndpointRouteTableAssociation';
    /**
