 ...
 * ```
 */
export declare class AllowedImagesSettings extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AllowedImagesSettingsState, opts?: pulumi.CustomResourceOptions): AllowedImagesSettings;
    /**
     * Returns true if the given object is an instance of AllowedImagesSettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AllowedImagesSettings;
    /**
     * List of image criteria. Maximum of 10 criterion blocks allowed. See `imageCriterion` below.
     */
    readonly imageCriterions: pulumi.Output<outputs.ec2.AllowedImagesSettingsImageCriterion[] | undefined>;
    /**
...
//# sourceMappingURL=allowedImagesSettings.d.ts.map