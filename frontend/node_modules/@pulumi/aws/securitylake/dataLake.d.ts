...
export declare class DataLake extends pulumi.CustomResource {
     ...
     */
    readonly configuration: pulumi.Output<outputs.securitylake.DataLakeConfiguration>;
    /**
...
export interface DataLakeState {
     ...
     * Specify the Region or Regions that will contribute data to the rollup region.
     */
    configuration?: pulumi.Input<inputs.securitylake.DataLakeConfiguration | undefined>;
    /**
     * The Amazon Resource Name (ARN) used to create and update the AWS Glue table. This table contains partitions generated by the ingestion and normalization of AWS log sources and custom sources.
     */
    metaStoreManagerRoleArn?: pulumi.Input<string | undefined>;
    /**
     * The AWS Regions where Security Lake is automatically enabled.
     */
    ...
    timeouts?: pulumi.Input<inputs.securitylake.DataLakeTimeouts | undefined>;
}
/**
