...
class HostedTransitVirtualInterfaceAcceptor extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new HostedTransitVirtualInterfaceAcceptor(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:directconnect/hostedTransitVirtualInterfaceAcceptor:HostedTransitVirtualInterfaceAcceptor';
    /**
