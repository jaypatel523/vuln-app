...
class HostedPublicVirtualInterfaceAccepter extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new HostedPublicVirtualInterfaceAccepter(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:directconnect/hostedPublicVirtualInterfaceAccepter:HostedPublicVirtualInterfaceAccepter';
    /**
