...
export declare class Domain extends pulumi.CustomResource {
     ...
     */
    readonly dkimVerificationStatus: pulumi.Output<string>;
    /**
     ...
     */
    readonly isTestDomain: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly ownershipVerificationStatus: pulumi.Output<string>;
    /**
     * List of DNS records required for domain verification. See `records` below.
     */
    readonly records: pulumi.Output<outputs.workmail.DomainRecord[]>;
    /**
