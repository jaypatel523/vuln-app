 ...
 * ```
 */
export declare class WebAclRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebAclRuleState, opts?: pulumi.CustomResourceOptions): WebAclRule;
    /**
     * Returns true if the given object is an instance of WebAclRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WebAclRule;
    /**
     * Action to take when the rule matches. See Action below. Conflicts with `overrideAction`.
     */
    readonly action: pulumi.Output<outputs.wafv2.WebAclRuleAction | undefined>;
    /**
     * CAPTCHA configuration that overrides the web ACL level setting. See Captcha Config below.
     */
    readonly captchaConfig: pulumi.Output<outputs.wafv2.WebAclRuleCaptchaConfig | undefined>;
    /**
     * Challenge configuration that overrides the web ACL level setting. See Challenge Config below.
     */
    readonly challengeConfig: pulumi.Output<outputs.wafv2.WebAclRuleChallengeConfig | undefined>;
    /**
     ...
     */
    readonly overrideAction: pulumi.Output<outputs.wafv2.WebAclRuleOverrideAction | undefined>;
    /**
     ...
     */
    readonly ruleLabels: pulumi.Output<outputs.wafv2.WebAclRuleRuleLabel[] | undefined>;
    /**
     * Rule statement. See Statement below.
     */
    readonly statement: pulumi.Output<outputs.wafv2.WebAclRuleStatement | undefined>;
    readonly timeouts: pulumi.Output<outputs.wafv2.WebAclRuleTimeouts | undefined>;
    /**
     * CloudWatch metrics configuration. See Visibility Config below.
     */
    readonly visibilityConfig: pulumi.Output<outputs.wafv2.WebAclRuleVisibilityConfig | undefined>;
    /**
...
//# sourceMappingURL=webAclRule.d.ts.map