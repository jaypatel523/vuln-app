...
class OrganizationAdminAccountRegistration extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new OrganizationAdminAccountRegistration(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:auditmanager/organizationAdminAccountRegistration:OrganizationAdminAccountRegistration';
    /**
