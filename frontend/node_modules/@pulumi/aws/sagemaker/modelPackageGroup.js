...
class ModelPackageGroup extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ModelPackageGroup(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:sagemaker/modelPackageGroup:ModelPackageGroup';
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["modelPackageGroupDescription"] = state?.modelPackageGroupDescription;
