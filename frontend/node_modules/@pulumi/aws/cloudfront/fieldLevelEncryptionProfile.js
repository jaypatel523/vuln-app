...
class FieldLevelEncryptionProfile extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new FieldLevelEncryptionProfile(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:cloudfront/fieldLevelEncryptionProfile:FieldLevelEncryptionProfile';
    /**
