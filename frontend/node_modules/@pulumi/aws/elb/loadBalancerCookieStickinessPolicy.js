...
class LoadBalancerCookieStickinessPolicy extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new LoadBalancerCookieStickinessPolicy(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:elb/loadBalancerCookieStickinessPolicy:LoadBalancerCookieStickinessPolicy';
    /**
