...
exports.Trust = exports.SharedDirectoryAccepter = exports.SharedDirectory = exports.ServiceRegion = exports.RadiusSettings = exports.LogSubscription = exports.getDirectoryOutput = exports.getDirectory = exports.Directory = exports.ConditionalForwarder = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("../utilities"));
exports.ConditionalForwarder = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "aws:directoryservice/conditionalForwarder:ConditionalForwarder":
                return new exports.ConditionalForwarder(name, undefined, { urn });
            ...
            case "aws:directoryservice/logSubscription:LogSubscription":
                return new exports.LogSubscription(name, undefined, { urn });
