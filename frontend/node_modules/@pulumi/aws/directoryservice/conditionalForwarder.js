...
exports.ConditionalForwarder = void 0;
...
class ConditionalForwarder extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ConditionalForwarder(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:directoryservice/conditionalForwarder:ConditionalForwarder';
    /**
