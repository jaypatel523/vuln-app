...
class HttpNamespace extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new HttpNamespace(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:servicediscovery/httpNamespace:HttpNamespace';
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["httpName"] = state?.httpName;
