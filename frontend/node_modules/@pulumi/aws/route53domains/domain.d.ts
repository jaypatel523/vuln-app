...
export declare class Domain extends pulumi.CustomResource {
     ...
     */
    readonly adminContact: pulumi.Output<outputs.route53domains.DomainAdminContact>;
    /**
     * Whether domain administrative contact information is concealed from WHOIS queries. Default: `true`.
     */
    readonly adminPrivacy: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly billingContacts: pulumi.Output<outputs.route53domains.DomainBillingContact[]>;
    /**
     * Whether domain billing contact information is concealed from WHOIS queries. Default: `true`.
     */
    readonly billingPrivacy: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly durationInYears: pulumi.Output<number>;
    /**
     ...
     */
    readonly nameServers: pulumi.Output<outputs.route53domains.DomainNameServer[]>;
    /**
     * Details about the domain registrant. See Contact Blocks for more details.
     */
    readonly registrantContact: pulumi.Output<outputs.route53domains.DomainRegistrantContact>;
    /**
     * Whether domain registrant contact information is concealed from WHOIS queries. Default: `true`.
     */
    readonly registrantPrivacy: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly techContact: pulumi.Output<outputs.route53domains.DomainTechContact>;
    /**
     * Whether domain technical contact information is concealed from WHOIS queries. Default: `true`.
     */
    readonly techPrivacy: pulumi.Output<boolean>;
    readonly timeouts: pulumi.Output<outputs.route53domains.DomainTimeouts | undefined>;
    /**
     * Whether the domain is locked for transfer. Default: `true`.
     *
     * > **NOTE:** You must specify the same privacy setting for `adminPrivacy`, `registrantPrivacy` and `techPrivacy`.
     */
    readonly transferLock: pulumi.Output<boolean>;
    /**
...
export interface DomainState {
     ...
     * Details about the domain administrative contact. See Contact Blocks for more details.
     */
    adminContact?: pulumi.Input<inputs.route53domains.DomainAdminContact | undefined>;
    /**
     * Whether domain administrative contact information is concealed from WHOIS queries. Default: `true`.
     */
     ...
     * Details about the domain billing contact. See Contact Blocks for more details.
     */
    billingContacts?: pulumi.Input<pulumi.Input<inputs.route53domains.DomainBillingContact>[] | undefined>;
    /**
     * Whether domain billing contact information is concealed from WHOIS queries. Default: `true`.
     */
     ...
     * The list of nameservers for the domain. See `nameServer` Blocks for more details.
     */
    nameServers?: pulumi.Input<pulumi.Input<inputs.route53domains.DomainNameServer>[] | undefined>;
    /**
     * Details about the domain registrant. See Contact Blocks for more details.
     */
    registrantContact?: pulumi.Input<inputs.route53domains.DomainRegistrantContact | undefined>;
    /**
     * Whether domain registrant contact information is concealed from WHOIS queries. Default: `true`.
     */
     ...
     * Details about the domain technical contact. See Contact Blocks for more details.
     */
    techContact?: pulumi.Input<inputs.route53domains.DomainTechContact | undefined>;
    /**
     * Whether domain technical contact information is concealed from WHOIS queries. Default: `true`.
     */
    techPrivacy?: pulumi.Input<boolean | undefined>;
    timeouts?: pulumi.Input<inputs.route53domains.DomainTimeouts | undefined>;
    /**
     * Whether the domain is locked for transfer. Default: `true`.
     *
     * > **NOTE:** You must specify the same privacy setting for `adminPrivacy`, `registrantPrivacy` and `techPrivacy`.
