...
export interface GlobalClusterState {
     ...
     * Set of objects containing Global Cluster members.
     */
    globalClusterMembers?: pulumi.Input<pulumi.Input<inputs.neptune.GlobalClusterGlobalClusterMember>[] | undefined>;
    /**
     * AWS Region-unique, immutable identifier for the global database cluster. This identifier is found in AWS CloudTrail log entries whenever the AWS KMS key for the DB cluster is accessed.
     */
    globalClusterResourceId?: pulumi.Input<string | undefined>;
    /**
     * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
     */
...
//# sourceMappingURL=globalCluster.d.ts.map