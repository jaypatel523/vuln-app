...
class ApprovalRuleTemplateAssociation extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ApprovalRuleTemplateAssociation(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:codecommit/approvalRuleTemplateAssociation:ApprovalRuleTemplateAssociation';
    /**
