...
export { accessanalyzer, account, acm, acmpca, alb, amp, amplify, apigateway, apigatewayv2, appautoscaling, appconfig, appfabric, appflow, appintegrations, applicationinsights, applicationloadbalancing, appmesh, apprunner, appstream, appsync, arcregionswitch, arczonalshift, athena, auditmanager, autoscaling, autoscalingplans, backup, batch, bcmdata, bedrock, bedrockfoundation, bedrockmodel, billing, budgets, cfg, chatbot, chime, chimesdkmediapipelines, cleanrooms, cloud9, cloudcontrol, cloudformation, cloudfront, cloudhsmv2, cloudsearch, cloudtrail, cloudwatch, codeartifact, codebuild, codecatalyst, codecommit, codeconnections, codedeploy, codeguruprofiler, codegurureviewer, codepipeline, codestarconnections, codestarnotifications, cognito, comprehend, computeoptimizer, config, connect, controltower, costexplorer, costoptimizationhub, cur, customerprofiles, dataexchange, datapipeline, datasync, datazone, dax, detective, devicefarm, devopsguru, directconnect, directoryservice, dlm, dms, docdb, drs, dsql, dynamodb, ebs, ec2, ec2clientvpn, ec2transitgateway, ecr, ecrpublic, ecs, efs, eks, elasticache, elasticbeanstalk, elasticsearch, elastictranscoder, elb, emr, emrcontainers, emrserverless, evidently, finspace, fis, fms, fsx, gamelift, glacier, globalaccelerator, glue, grafana, guardduty, iam, identitystore, imagebuilder, inspector, inspector2, invoicing, iot, ivs, ivschat, kendra, keyspaces, kinesis, kinesisanalyticsv2, kms, lakeformation, lambda, lb, lex, licensemanager, lightsail, location, m2, macie, macie2, mediaconvert, medialive, mediapackage, mediapackagev2, mediastore, memorydb, mq, msk, mskconnect, mwaa, neptune, neptunegraph, networkfirewall, networkflowmonitor, networkmanager, networkmonitor, notifications, oam, observabilityadmin, odb, opensearch, opensearchingest, organizations, outposts, paymentcryptography, pinpoint, pipes, polly, pricing, qbusiness, qldb, quicksight, ram, rbin, rds, redshift, redshiftdata, redshiftserverless, rekognition, resiliencehub, resourceexplorer, resourcegroups, resourcegroupstaggingapi, rolesanywhere, route53, route53domains, route53recoverycontrol, route53recoveryreadiness, rum, s3, s3control, s3outposts, s3tables, sagemaker, savingsplans, scheduler, schemas, secretsmanager, securityhub, securitylake, serverlessrepository, servicecatalog, servicediscovery, servicequotas, ses, sesv2, sfn, shield, signer, sns, sqs, ssm, ssmcontacts, ssmincidents, ssoadmin, storagegateway, swf, synthetics, timestreaminfluxdb, timestreamquery, timestreamwrite, transcribe, transfer, types, uxc, verifiedaccess, verifiedpermissions, vpc, vpclattice, vpn, waf, wafregional, wafv2, workmail, workspaces, workspacesweb, xray, };
