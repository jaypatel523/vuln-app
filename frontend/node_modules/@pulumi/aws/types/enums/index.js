...
// Export sub-modules:
const alb = __importStar(require("./alb"));
exports.alb = alb;
const applicationloadbalancing = __importStar(require("./applicationloadbalancing"));
...
exports.rds = rds;
const route53 = __importStar(require("./route53"));
