...
class ContainerServiceDeploymentVersion extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ContainerServiceDeploymentVersion(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:lightsail/containerServiceDeploymentVersion:ContainerServiceDeploymentVersion';
    /**
