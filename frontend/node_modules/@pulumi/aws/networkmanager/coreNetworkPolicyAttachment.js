...
class CoreNetworkPolicyAttachment extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new CoreNetworkPolicyAttachment(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:networkmanager/coreNetworkPolicyAttachment:CoreNetworkPolicyAttachment';
    /**
