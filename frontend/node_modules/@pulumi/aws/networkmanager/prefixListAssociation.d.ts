 ...
 * ```
 */
export declare class PrefixListAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrefixListAssociationState, opts?: pulumi.CustomResourceOptions): PrefixListAssociation;
    /**
     * Returns true if the given object is an instance of PrefixListAssociation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PrefixListAssociation;
    /**
     ...
     */
    readonly prefixListAlias: pulumi.Output<string>;
    /**
     * The ARN of the EC2 managed prefix list to associate with the core network.
     */
    readonly prefixListArn: pulumi.Output<string>;
    /**
...
//# sourceMappingURL=prefixListAssociation.d.ts.map