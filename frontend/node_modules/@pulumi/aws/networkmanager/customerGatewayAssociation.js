...
class CustomerGatewayAssociation extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new CustomerGatewayAssociation(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:networkmanager/customerGatewayAssociation:CustomerGatewayAssociation';
    /**
