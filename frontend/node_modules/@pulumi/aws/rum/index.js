...
exports.MetricsDestination = exports.AppMonitor = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("../utilities"));
exports.AppMonitor = null;
utilities.lazyLoad(exports, ["AppMonitor"], () => require("./appMonitor"));
exports.MetricsDestination = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "aws:rum/appMonitor:AppMonitor":
                return new exports.AppMonitor(name, undefined, { urn });
            case "aws:rum/metricsDestination:MetricsDestination":
                return new exports.MetricsDestination(name, undefined, { urn });
            default:
