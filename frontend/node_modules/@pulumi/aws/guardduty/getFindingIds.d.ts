 ...
 * ```
 */
export declare function getFindingIds(args: GetFindingIdsArgs, opts?: pulumi.InvokeOptions): Promise<GetFindingIdsResult>;
/**
 ...
 * ```
 */
export declare function getFindingIdsOutput(args: GetFindingIdsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFindingIdsResult>;
/**
 * A collection of arguments for invoking getFindingIds.
 */
...
//# sourceMappingURL=getFindingIds.d.ts.map