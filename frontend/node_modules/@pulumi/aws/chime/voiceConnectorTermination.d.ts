 ...
 * ## Import
 *
 * Using `pulumi import`, import Chime Voice Connector Termination using the `voiceConnectorId`. For example:
 *
 * ```sh
...
//# sourceMappingURL=voiceConnectorTermination.d.ts.map