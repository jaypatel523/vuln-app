 ...
 * ```
 */
export declare class VoiceConnectorOrigination extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VoiceConnectorOriginationState, opts?: pulumi.CustomResourceOptions): VoiceConnectorOrigination;
    /**
     ...
     */
    static isInstance(obj: any): obj is VoiceConnectorOrigination;
    /**
     ...
     */
    readonly routes: pulumi.Output<outputs.chime.VoiceConnectorOriginationRoute[]>;
    /**
...
//# sourceMappingURL=voiceConnectorOrigination.d.ts.map