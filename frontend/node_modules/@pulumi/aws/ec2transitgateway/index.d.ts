...
export declare const MeteringPolicy: typeof import("./meteringPolicy").MeteringPolicy;
...
export declare const MeteringPolicyEntry: typeof import("./meteringPolicyEntry").MeteringPolicyEntry;
