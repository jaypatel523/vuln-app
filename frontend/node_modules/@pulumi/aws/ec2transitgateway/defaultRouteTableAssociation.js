...
class DefaultRouteTableAssociation extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new DefaultRouteTableAssociation(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:ec2transitgateway/defaultRouteTableAssociation:DefaultRouteTableAssociation';
    /**
