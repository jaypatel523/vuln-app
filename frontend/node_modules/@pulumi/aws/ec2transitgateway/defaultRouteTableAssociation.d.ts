 ...
 * ```
 */
export declare class DefaultRouteTableAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultRouteTableAssociationState, opts?: pulumi.CustomResourceOptions): DefaultRouteTableAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is DefaultRouteTableAssociation;
    readonly originalDefaultRouteTableId: pulumi.Output<string>;
    /**
     * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
     */
    readonly region: pulumi.Output<string>;
    readonly timeouts: pulumi.Output<outputs.ec2transitgateway.DefaultRouteTableAssociationTimeouts | undefined>;
    /**
...
export interface DefaultRouteTableAssociationState {
    ...
    timeouts?: pulumi.Input<inputs.ec2transitgateway.DefaultRouteTableAssociationTimeouts | undefined>;
    /**
     * ID of the Transit Gateway to change the default association route table on.
     */
...
//# sourceMappingURL=defaultRouteTableAssociation.d.ts.map