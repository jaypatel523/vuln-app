...
export declare class LoadBalancer extends pulumi.CustomResource {
     ...
     */
    readonly healthCheckLogs: pulumi.Output<outputs.lb.LoadBalancerHealthCheckLogs | undefined>;
    /**
     ...
     */
    readonly ipamPools: pulumi.Output<outputs.lb.LoadBalancerIpamPools | undefined>;
    /**
     ...
     */
    readonly minimumLoadBalancerCapacity: pulumi.Output<outputs.lb.LoadBalancerMinimumLoadBalancerCapacity | undefined>;
    /**
...
export interface LoadBalancerState {
     ...
     * Access Logs block. See below.
     */
    accessLogs?: pulumi.Input<inputs.lb.LoadBalancerAccessLogs | undefined>;
    /**
     * ARN of the load balancer.
     */
     ...
     * ARN suffix for use with CloudWatch Metrics.
     */
    arnSuffix?: pulumi.Input<string | undefined>;
    /**
     * Client keep alive value in seconds. The valid range is 60-604800 seconds. The default is 3600 seconds.
     */
    clientKeepAlive?: pulumi.Input<number | undefined>;
    /**
     * Connection Logs block. See below. Only valid for Load Balancers of type `application`.
     */
    connectionLogs?: pulumi.Input<inputs.lb.LoadBalancerConnectionLogs | undefined>;
    /**
     * ID of the customer owned ipv4 pool to use for this load balancer.
     */
     ...
     * How the load balancer handles requests that might pose a security risk to an application due to HTTP desync. Valid values are `monitor`, `defensive` (default), `strictest`.
     */
    desyncMitigationMode?: pulumi.Input<string | undefined>;
    /**
     * DNS name of the load balancer.
     * * `subnet_mapping.*.outpost_id` - ID of the Outpost containing the load balancer.
     */
     ...
     * How traffic is distributed among the load balancer Availability Zones. Possible values are `anyAvailabilityZone` (default), `availabilityZoneAffinity`, or `partialAvailabilityZoneAffinity`. See   [Availability Zone DNS affinity](https://docs.aws.amazon.com/elasticloadbalancing/latest/network/network-load-balancers.html#zonal-dns-affinity) for additional details. Only valid for `network` type load balancers.
     */
    dnsRecordClientRoutingPolicy?: pulumi.Input<string | undefined>;
    /**
     * Whether HTTP headers with header fields that are not valid are removed by the load balancer (true) or routed to targets (false). The default is false. Elastic Load Balancing requires that message header names contain only alphanumeric characters and hyphens. Only valid for Load Balancers of type `application`.
     */
    dropInvalidHeaderFields?: pulumi.Input<boolean | undefined>;
    /**
     * If true, cross-zone load balancing of the load balancer will be enabled. For `network` and `gateway` type load balancers, this feature is disabled by default (`false`). For `application` load balancer this feature is always enabled (`true`) and cannot be disabled. Defaults to `false`.
     */
    enableCrossZoneLoadBalancing?: pulumi.Input<boolean | undefined>;
    /**
     * If true, deletion of the load balancer will be disabled via the AWS API. This will prevent this provider from deleting the load balancer. Defaults to `false`.
     */
     ...
     * Whether the two headers (`x-amzn-tls-version` and `x-amzn-tls-cipher-suite`), which contain information about the negotiated TLS version and cipher suite, are added to the client request before sending it to the target. Only valid for Load Balancers of type `application`. Defaults to `false`
     */
    enableTlsVersionAndCipherSuiteHeaders?: pulumi.Input<boolean | undefined>;
    /**
     * Whether to allow a WAF-enabled load balancer to route requests to targets if it is unable to forward the request to AWS WAF. Defaults to `false`.
     */
    enableWafFailOpen?: pulumi.Input<boolean | undefined>;
    /**
     * Whether the X-Forwarded-For header should preserve the source port that the client used to connect to the load balancer in `application` load balancers. Defaults to `false`.
     */
    enableXffClientPort?: pulumi.Input<boolean | undefined>;
    /**
     * Whether zonal shift is enabled. Defaults to `false`.
     */
    enableZonalShift?: pulumi.Input<boolean | undefined>;
    /**
     * Whether inbound security group rules are enforced for traffic originating from a PrivateLink. Only valid for Load Balancers of type `network`. The possible values are `on` and `off`.
     */
    enforceSecurityGroupInboundRulesOnPrivateLinkTraffic?: pulumi.Input<string | undefined>;
    /**
     * Health Check Logs block. See below. Only valid for Load Balancers of type `application`.
     */
    healthCheckLogs?: pulumi.Input<inputs.lb.LoadBalancerHealthCheckLogs | undefined>;
    /**
     * Time in seconds that the connection is allowed to be idle. Only valid for Load Balancers of type `application`. Default: 60.
     */
     ...
     * . The IPAM pools to use with the load balancer.  Only valid for Load Balancers of type `application`. See ipamPools for more information.
     */
    ipamPools?: pulumi.Input<inputs.lb.LoadBalancerIpamPools | undefined>;
    /**
     * Type of load balancer to create. Possible values are `application`, `gateway`, or `network`. The default value is `application`.
     */
     ...
     * Minimum capacity for a load balancer. Only valid for Load Balancers of type `application` or `network`.
     */
    minimumLoadBalancerCapacity?: pulumi.Input<inputs.lb.LoadBalancerMinimumLoadBalancerCapacity | undefined>;
    /**
     * Name of the LB. This name must be unique within your AWS account, can have a maximum of 32 characters, must contain only alphanumeric characters or hyphens, and must not begin or end with a hyphen. If not specified, this provider will autogenerate a name beginning with `tf-lb`.
     */
     ...
     * Whether the Application Load Balancer should preserve the Host header in the HTTP request and send it to the target without any change. Defaults to `false`.
     */
    preserveHostHeader?: pulumi.Input<boolean | undefined>;
    /**
     * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
     */
     ...
     * The number of secondary IP addresses to configure for your load balancer nodes. Only valid for Load Balancers of type `network`. The valid range is 0-7. When decreased, this will force a recreation of the resource. Default: `0`.
     */
    secondaryIpsAutoAssignedPerSubnet?: pulumi.Input<number | undefined>;
    /**
     * List of security group IDs to assign to the LB. Only valid for Load Balancers of type `application` or `network`. For load balancers of type `network` security groups cannot be added if none are currently present, and cannot all be removed once added. If either of these conditions are met, this will force a recreation of the resource.
     */
     ...
     * Subnet mapping block. See below. For Load Balancers of type `network` subnet mappings can only be added.
     */
    subnetMappings?: pulumi.Input<pulumi.Input<inputs.lb.LoadBalancerSubnetMapping>[] | undefined>;
    /**
     * List of subnet IDs to attach to the LB. For Load Balancers of type `network` subnets can only be added (see [Availability Zones](https://docs.aws.amazon.com/elasticloadbalancing/latest/network/network-load-balancers.html#availability-zones)), deleting a subnet for load balancers of type `network` will force a recreation of the resource.
     */
     ...
     * > **NOTE:** Please note that one of either `subnets` or `subnetMapping` is required.
     */
    xffHeaderProcessingMode?: pulumi.Input<string | undefined>;
    /**
     * Canonical hosted zone ID of the load balancer (to be used in a Route 53 Alias record).
     */
