...
exports.getCustomModelOutput = exports.getCustomModel = void 0;
 ...
 * ```
 */
function getCustomModel(args, opts) {
 ...
 * ```
 */
function getCustomModelOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getCustomModelOutput = getCustomModelOutput;
//# sourceMappingURL=getCustomModel.js.map