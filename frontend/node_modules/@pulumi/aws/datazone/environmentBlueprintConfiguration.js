...
class EnvironmentBlueprintConfiguration extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new EnvironmentBlueprintConfiguration(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'aws:datazone/environmentBlueprintConfiguration:EnvironmentBlueprintConfiguration';
    /**
