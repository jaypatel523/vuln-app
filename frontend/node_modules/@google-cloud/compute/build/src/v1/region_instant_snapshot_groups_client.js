...
exports.RegionInstantSnapshotGroupsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/region_instant_snapshot_groups_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./region_instant_snapshot_groups_client_config.json");
...
class RegionInstantSnapshotGroupsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.RegionInstantSnapshotGroups', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.regionInstantSnapshotGroupsStub) {
            return this.regionInstantSnapshotGroupsStub;
        }
        // Put together the "service stub" for
        // google.cloud.compute.v1.RegionInstantSnapshotGroups.
        this.regionInstantSnapshotGroupsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.RegionInstantSnapshotGroups') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.RegionInstantSnapshotGroups, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionInstantSnapshotGroupsStubMethods = ['delete', 'get', 'getIamPolicy', 'insert', 'list', 'setIamPolicy', 'testIamPermissions'];
        for (const methodName of regionInstantSnapshotGroupsStubMethods) {
            const callPromise = this.regionInstantSnapshotGroupsStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    close() {
        if (this.regionInstantSnapshotGroupsStub && !this._terminated) {
            return this.regionInstantSnapshotGroupsStub.then(stub => {
...
//# sourceMappingURL=region_instant_snapshot_groups_client.js.map