...
export declare class DisksClient {
     ...
     * @param {google.cloud.compute.v1.DiskUpdateKmsKeyRequest} request.diskUpdateKmsKeyRequestResource
     *   The body resource for this request
     * @param {string} request.project
     *   Project ID for this request.
     * @param {string} request.requestId
     ...
     *   and might get backwards-incompatible changes at any time.
     *   `.promise()` is not supported yet.
     * @example <caption>include:samples/generated/v1/disks.update_kms_key.js</caption>
     * region_tag:compute_v1_generated_Disks_UpdateKmsKey_async
     */
    updateKmsKey(request?: protos.google.cloud.compute.v1.IUpdateKmsKeyDiskRequest, options?: CallOptions): Promise<[
        LROperation<protos.google.cloud.compute.v1.IOperation, null>,
        protos.google.cloud.compute.v1.IOperation | undefined,
        {} | undefined
    ]>;
    updateKmsKey(request: protos.google.cloud.compute.v1.IUpdateKmsKeyDiskRequest, options: CallOptions, callback: Callback<protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.IUpdateKmsKeyDiskRequest | null | undefined, {} | null | undefined>): void;
    updateKmsKey(request: protos.google.cloud.compute.v1.IUpdateKmsKeyDiskRequest, callback: Callback<protos.google.cloud.compute.v1.IOperation, protos.google.cloud.compute.v1.IUpdateKmsKeyDiskRequest | null | undefined, {} | null | undefined>): void;
    /**
