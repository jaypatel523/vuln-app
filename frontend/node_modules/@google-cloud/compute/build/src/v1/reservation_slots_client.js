...
exports.ReservationSlotsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/reservation_slots_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./reservation_slots_client_config.json");
...
class ReservationSlotsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.ReservationSlots', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.reservationSlotsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.ReservationSlots') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.ReservationSlots, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of reservationSlotsStubMethods) {
            const callPromise = this.reservationSlotsStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=reservation_slots_client.js.map