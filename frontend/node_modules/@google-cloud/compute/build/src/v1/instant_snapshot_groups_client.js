...
exports.InstantSnapshotGroupsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/instant_snapshot_groups_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./instant_snapshot_groups_client_config.json");
...
class InstantSnapshotGroupsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1.InstantSnapshotGroups', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        // google.cloud.compute.v1.InstantSnapshotGroups.
        this.instantSnapshotGroupsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1.InstantSnapshotGroups') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1.InstantSnapshotGroups, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const instantSnapshotGroupsStubMethods = ['delete', 'get', 'getIamPolicy', 'insert', 'list', 'setIamPolicy', 'testIamPermissions'];
        for (const methodName of instantSnapshotGroupsStubMethods) {
            const callPromise = this.instantSnapshotGroupsStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=instant_snapshot_groups_client.js.map