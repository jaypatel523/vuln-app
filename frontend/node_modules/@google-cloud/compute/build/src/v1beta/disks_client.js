...
class DisksClient {
    ...
    initialize() {
        ...
        const disksStubMethods = ['addResourcePolicies', 'aggregatedList', 'bulkInsert', 'bulkSetLabels', 'createSnapshot', 'delete', 'get', 'getIamPolicy', 'insert', 'list', 'removeResourcePolicies', 'resize', 'setIamPolicy', 'setLabels', 'startAsyncReplication', 'stopAsyncReplication', 'stopGroupAsyncReplication', 'testIamPermissions', 'update', 'updateKmsKey'];
